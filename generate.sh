...
code run GtkCodeGen $(pkg-config --variable=includedir gtk4)/../share/gir-1.0/Gtk-4.0.gir Sources/Gtk/Generated CGtk

# Generate Gtk3 wrapper
code run GtkCodeGen $(pkg-config --variable=includedir gtk+-3.0)/../share/gir-1.0/Gtk-3.0.gir Sources/Gtk3/Generated CGtk3
