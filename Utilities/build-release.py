...
def main():
    ...
    build_args = ["code", "build", "-c", "release", "--product", "wasmkit-cli", "--package-path", SOURCE_ROOT] + args.extra_build_args
    ...
    if is_elf(src_exe_path):
        ...
        # most of static archives in static linux Codira SDK contains
        # debug sections.
