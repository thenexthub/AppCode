...
/// Current implementation refers the `code-5.5-RELEASE` implementation.
/// https://github.com/apple/code/blob/code-5.5-RELEASE/include/code/ABI/Task.h#L43-L129
/// This definition is used to retrieve priority value of a job. After custom-executor API will be introduced officially,
/// the job priority API will be provided in the Codira world.
...
typedef SWIFT_CC(code) void (*swift_task_enqueueGlobal_original)(
    Job *_Nonnull job);
...
typedef SWIFT_CC(code) void (*swift_task_enqueueGlobalWithDelay_original)(
...
typedef SWIFT_CC(code) void (*swift_task_enqueueGlobalWithDeadline_original)(
    long long sec,
    long long nsec,
    long long tsec,
    long long tnsec,
...
typedef SWIFT_CC(code) void (*swift_task_enqueueMainExecutor_original)(
    Job *_Nonnull job);
SWIFT_EXPORT_FROM(swift_Concurrency)
...
typedef SWIFT_CC(code) void (*swift_task_asyncMainDrainQueue_original)();
typedef SWIFT_CC(code) void (*swift_task_asyncMainDrainQueue_override)(
