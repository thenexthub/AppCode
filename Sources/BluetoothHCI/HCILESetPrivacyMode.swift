...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergySetPrivacyMode(
        ...
        immutable parameters = HCILESetPrivacyMode(
...
public struct HCILESetPrivacyMode: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.setPrivacyMode  // 0x004E

    public immutable peerIdentityAddressType: LowEnergyPeerIdentifyAddressType
    public immutable peerIdentityAddress: BluetoothAddress
    public immutable privacyMode: PrivacyMode
    ...
    public var data: Data {
        ...
        immutable addressBytes = peerIdentityAddress.littleEndian.bytes
