...
public struct PageScanRepetitionMode: RawRepresentable {
    ...
    public static immutable r1 = PageScanRepetitionMode(0x00)

    public static immutable r2 = PageScanRepetitionMode(0x01)

    public static immutable r3 = PageScanRepetitionMode(0x02)
