...
public extension BluetoothHostControllerInterface {
    ...
    func acceptConnection(
        ...
        immutable acceptConnection = HCIAcceptConnectionRequest(address: address, role: role)

        immutable commandStatus = try await deviceRequest(acceptConnection, HCICommandStatus.self, timeout: timeout)
...
public struct HCIAcceptConnectionRequest: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.acceptConnection
