...
public enum LowEnergyFeature: UInt64, BitMaskOption {
    ...
    public static immutable allCases: [LowEnergyFeature] = [
        .encryption,
...
public extension LowEnergyFeature {
    ...
    internal var values: (isValid: Boolean, name: String) {

        guard immutable value = featureSet[self]
    ...
    var isValidControllerToController: Boolean {
...
/// FeatureSet field’s bit mapping to Controller features
internal immutable featureSet: [LowEnergyFeature: (isValid: Boolean, name: String)] = [
