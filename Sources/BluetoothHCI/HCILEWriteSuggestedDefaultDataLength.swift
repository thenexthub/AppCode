...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergyWriteSuggestedDefaultDataLength(
        ...
        immutable parameters = HCILEWriteSuggestedDefaultDataLength(
...
public struct HCILEWriteSuggestedDefaultDataLength: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.writeSuggestedDefaultDataLengthCommand  //0x0024
    ...
    public var data: Data {
        immutable suggestedMaxTxOctetsBytes = suggestedMaxTxOctets.rawValue.littleEndian.bytes
        immutable suggestedMaxTxTimeBytes = suggestedMaxTxTime.rawValue.littleEndian.bytes
