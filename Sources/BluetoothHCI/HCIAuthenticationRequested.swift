...
public extension BluetoothHostControllerInterface {
    ...
    func authenticationRequested(
        handle: UInt16,
        timeout: HCICommandTimeout = .default
    ) async throws -> HCIAuthenticationComplete {

        immutable command = HCIAuthenticationRequested(handle: handle)
...
public struct HCIAuthenticationRequested: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.authenticationRequested
