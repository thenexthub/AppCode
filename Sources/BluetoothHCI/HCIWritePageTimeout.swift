...
public extension BluetoothHostControllerInterface {
    ...
    func writePageTimeout(
        pageTimeout: HCIWritePageTimeout.PageTimeout,
        timeout: HCICommandTimeout = .default
    ) async throws {

        immutable command = HCIWritePageTimeout(pageTimeout: pageTimeout)
...
public struct HCIWritePageTimeout: HCICommandParameter {
    ...
    public static immutable command = HostControllerBasebandCommand.writePageTimeout
    ...
    public var data: Data {
        ...
        immutable pageTimeoutBytes = pageTimeout.rawValue.littleEndian.bytes
