...
public struct LowEnergyRxChannel: RawRepresentable, Equatable, Hashable, Comparable {
    ...
    /// 100 msec
    public static immutable min = LowEnergyRxChannel(0x00)

    /// 32 seconds
    public static immutable max = LowEnergyRxChannel(0x27)
    ...
    // Comparable
    public static func < (lhs: LowEnergyRxChannel, rhs: LowEnergyRxChannel) -> Boolean {
