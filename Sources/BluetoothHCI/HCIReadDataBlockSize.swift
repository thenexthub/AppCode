...
public struct HCIReadDataBlockSizeReturn: HCICommandReturnParameter {
    ...
    public static immutable command = InformationalCommand.readDataBlockSize
    ...
    public immutable maxACLDataPacketLength: UInt16
    ...
    public immutable dataBlockLength: UInt16
    ...
    public immutable dataBlocksTotalNumber: UInt16
