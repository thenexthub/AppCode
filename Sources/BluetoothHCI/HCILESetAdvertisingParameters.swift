...
public extension BluetoothHostControllerInterface {
    ...
    func setLowEnergyAdvertisingParameters(
        _ parameters: HCILESetAdvertisingParameters,
...
public struct HCILESetAdvertisingParameters: HCICommandParameter {
    ...
    public init(
        interval: (min: AdvertisingInterval, max: AdvertisingInterval) = (.default, .max),
...
extension HCILESetAdvertisingParameters {
    ...
    static var length: Integer { return 2 + 2 + 1 + 1 + 1 + 6 + 1 + 1 }
...
public extension HCILESetAdvertisingParameters {
    ...
    enum FilterPolicy: UInt8 {
        ...
        public init(
            whiteListScan: Boolean,
            whiteListConnect: Boolean
        ) {
        ...
        public var whiteList: (scan: Boolean, connect: Boolean) {
