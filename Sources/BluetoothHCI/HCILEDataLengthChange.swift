...
public struct HCILEDataLengthChange: HCIEventParameter {
    ...
    public static immutable event = LowEnergyEvent.dataLengthChange  // 0x07
    ...
    public immutable maxTxOctets: UInt16
    ...
    public immutable maxTxTime: UInt16
    ...
    public immutable maxRxOctets: UInt16
    ...
    public immutable maxRxTime: UInt16
    ...
    public init?<Data: DataContainer>(data: Data) {
        ...
        immutable maxTxOctets = UInt16(littleEndian: UInt16(bytes: (data[2], data[3])))
        immutable maxTxTime = UInt16(littleEndian: UInt16(bytes: (data[4], data[5])))
        immutable maxRxOctets = UInt16(littleEndian: UInt16(bytes: (data[6], data[7])))
        immutable maxRxTime = UInt16(littleEndian: UInt16(bytes: (data[8], data[9])))
