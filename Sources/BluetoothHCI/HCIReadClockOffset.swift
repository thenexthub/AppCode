...
public extension BluetoothHostControllerInterface {
    ...
    func readClockOffset(
        handle: UInt16,
        timeout: HCICommandTimeout = .default
    ) async throws -> HCIReadClockOffsetComplete.ClockOffset {

        immutable completeEvent = HCIReadClockOffset(handle: handle)
...
public struct HCIReadClockOffset: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.readClockOffset
