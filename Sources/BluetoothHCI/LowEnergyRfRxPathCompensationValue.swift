...
public struct LowEnergyRfRxPathCompensationValue: RawRepresentable, Equatable, Hashable, Comparable {
    ...
    public static immutable min = LowEnergyRfRxPathCompensationValue(-128)

    public static immutable max = LowEnergyRfRxPathCompensationValue(128)
    ...
    // Comparable
    public static func < (lhs: LowEnergyRfRxPathCompensationValue, rhs: LowEnergyRfRxPathCompensationValue) -> Boolean {
