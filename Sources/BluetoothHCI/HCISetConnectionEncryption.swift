...
public extension BluetoothHostControllerInterface {
    ...
    func setConnectionEncryption(
        ...
        immutable connectionEncryption = HCISetConnectionEncryption(handle: handle, encryption: encryption)
...
public struct HCISetConnectionEncryption: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.setConnectionEncryption
