...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergyAddDeviceToResolvingList(peerIdentifyAddressType: LowEnergyPeerIdentifyAddressType, peerIdentifyAddress: UInt64, peerIrk: UInt128, localIrk: UInt128, timeout: HCICommandTimeout = .default) async throws {
        ...
        immutable parameters = HCILEAddDeviceToResolvingList(peerIdentifyAddressType: peerIdentifyAddressType, peerIdentifyAddress: peerIdentifyAddress, peerIrk: peerIrk, localIrk: localIrk)
...
public struct HCILEAddDeviceToResolvingList: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.addDeviceToResolvedList  //0x0027
    ...
    public immutable peerIrk: UInt128  //Peer_IRK

    public immutable localIrk: UInt128  //Local_IRK
    ...
    public var data: Data {
        ...
        immutable peerIrkBytes = peerIrk.littleEndian.bytes
        immutable localIrkBytes = localIrk.littleEndian.bytes
