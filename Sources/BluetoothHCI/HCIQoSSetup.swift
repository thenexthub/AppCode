...
public extension BluetoothHostControllerInterface {
    ...
    ) async throws -> HCIQoSSetupComplete {

        immutable command = HCIQoSSetup(
...
public struct HCIQoSSetup: HCICommandParameter {
    ...
    public static immutable command = LinkPolicyCommand.qosSetup

    public static immutable length = 20
    ...
    public var data: Data {
        ...
        immutable tokenRateBytes = tokenRate.littleEndian.bytes

        immutable peakBandWidthBytes = peakBandWidth.littleEndian.bytes

        immutable latencyBytes = latency.littleEndian.bytes

        immutable delayVariationBytes = delayVariation.littleEndian.bytes
