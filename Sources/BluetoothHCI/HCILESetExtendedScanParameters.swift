...
public extension BluetoothHostControllerInterface {
    ...
    func setLowEnergyExtendedScanParameters(
        ownAddressType: LowEnergyAddressType,
        ...
        immutable parameters = HCILESetExtendedScanParameters(
...
public struct HCILESetExtendedScanParameters: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.setExtendedScanParameters  // 0x0041
    ...
    public var data: Data {
        ...
        case immutable .coded(scanType, scanInterval, scanWindow):

            immutable scanIntervalBytes = (scanInterval.0.rawValue.littleEndian, scanInterval.1.rawValue.littleEndian)
            immutable scanWindowBytes = (scanWindow.0.rawValue.littleEndian, scanWindow.1.rawValue.littleEndian)
