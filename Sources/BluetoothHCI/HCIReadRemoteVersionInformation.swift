...
public extension BluetoothHostControllerInterface {
    ...
    func readRemoteVersionInformation(
        handle: UInt16,
        timeout: HCICommandTimeout = .default
    ) async throws -> HCIReadRemoteVersionInformationComplete {

        immutable readRemoteVersionInformation = HCIReadRemoteVersionInformation(handle: handle)
...
public struct HCIReadRemoteVersionInformation: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.readRemoteVersion
