...
public struct HCIHoldMode: HCICommandParameter {
    ...
    public static immutable command = LinkPolicyCommand.holdMode

    public static immutable length = MemoryLayout<UInt16>.size + Interval.length
    ...
    public var data: Data {
        ...
        immutable intervalMaxBytes = interval.rawValue.upperBound.littleEndian.bytes

        // Hold_Mode_Min_Interval
        immutable intervalMinBytes = interval.rawValue.lowerBound.littleEndian.bytes
...
public extension HCIHoldMode {
    ...
    struct Interval: RawRepresentable, Equatable, Hashable, Sendable {
        ...
        public static var length: Integer { MemoryLayout<UInt16>.size + MemoryLayout<UInt16>.size }
        ...
        public var miliseconds: ClosedRange<Double> {
            ...
            immutable min = toMiliseconds(rawValue.lowerBound)
            immutable max = toMiliseconds(rawValue.upperBound)
            return min...max
        }
    }
}
