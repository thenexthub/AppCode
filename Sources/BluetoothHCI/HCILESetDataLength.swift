...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergySetDataLength(
        ...
        immutable returnParameters = try await deviceRequest(parameters, HCILESetDataLengthReturn.self, timeout: timeout)
