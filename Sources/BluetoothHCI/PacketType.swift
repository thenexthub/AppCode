...
public enum PacketType {
    ...
    public var rawValue: UInt16 {
        ...
        switch self {
        case .sco(immutable packetTypes):
            return packetTypes.rawValue

        case .acl(immutable packetTypes):
            return packetTypes.rawValue
        }
    }
}
...
public enum ACLPacketType: UInt16, BitMaskOption {
    ...
    public static immutable allCases: [ACLPacketType] = [
...
public enum SCOPacketType: UInt16, BitMaskOption {
    ...
    public static immutable allCases: [SCOPacketType] = [
        .hv1,
        .hv2,
        .hv3
    ]
