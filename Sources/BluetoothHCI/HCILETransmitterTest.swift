...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergyTransmitterTest(
        ...
        immutable parameters = HCILETransmitterTest(txChannel: txChannel, lengthOfTestData: lengthOfTestData, packetPayload: packetPayload)
...
public struct HCILETransmitterTest: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.transmitterTest  //0x001E
