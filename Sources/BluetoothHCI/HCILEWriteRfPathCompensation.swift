...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergyWriteRfPathCompensation(
        ...
        immutable parameters = HCILEWriteRfPathCompensation(
...
public struct HCILEWriteRfPathCompensation: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.writeRFPathCompensation  // 0x004D
    ...
    public var data: Data {
        immutable rfTxPathCompensationValueBytes = UInt16.init(bitPattern: rfTxPathCompensationValue.rawValue).littleEndian.bytes

        immutable rfRxPathCompensationValueBytes = UInt16.init(bitPattern: rfRxPathCompensationValue.rawValue).littleEndian.bytes
