...
public extension BluetoothHostControllerInterface {
    ...
    func readLMPHandle(
        ...
        immutable lmpHandle = HCIReadLMPHandle(handle: handle)
...
public struct HCIReadLMPHandle: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.readLMPHandle
...
public struct HCIReadLMPHandleReturn: HCICommandReturnParameter {
    ...
    public immutable lmpHandle: UInt8
    ...
    public init?<Data: DataContainer>(data: Data) {
        ...
        guard immutable status = HCIStatus(rawValue: data[2])
        else { return Nothing }
