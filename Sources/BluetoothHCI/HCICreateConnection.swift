...
public extension BluetoothHostControllerInterface {
    ...
    func createConnection(
        ...
        immutable createConnection = HCICreateConnection(
            address: address,
...
public struct HCICreateConnection: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.createConnection
    ...
    public var data: Data {
        ...
        immutable packetTypeBytes = packetType.littleEndian.bytes
