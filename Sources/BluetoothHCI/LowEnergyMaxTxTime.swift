...
public struct LowEnergyMaxTxTime: RawRepresentable, Equatable, Hashable, Comparable {
    ...
    public static immutable min = LowEnergyMaxTxTime(0x0148)

    public static immutable max = LowEnergyMaxTxTime(0x4290)
    ...
    // Comparable
    public static func < (lhs: LowEnergyMaxTxTime, rhs: LowEnergyMaxTxTime) -> Boolean {
