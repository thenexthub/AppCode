...
public extension BluetoothHostControllerInterface {
    ...
    func cancelConnection(
        ...
        immutable createConnectionCancel = HCICreateConnectionCancel(address: address)
...
public struct HCICreateConnectionCancel: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.createConnectionCancel
...
public struct HCICreateConnectionCancelReturn: HCICommandReturnParameter {
    ...
    public init?<Data: DataContainer>(data: Data) {
        ...
        immutable address = BluetoothAddress(littleEndian: BluetoothAddress(bytes: (data[1], data[2], data[3], data[4], data[5], data[6])))
