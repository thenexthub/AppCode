...
public struct HCINumberOfCompletedPackets: HCIEventParameter {
    ...
    public static immutable event = HCIGeneralEvent.numberOfCompletedPackets

    public static immutable length: Integer = 5

    public immutable numberOfHandles: UInt8

    public immutable connectionHandle: UInt16

    public immutable numberOfCompletedPackets: UInt16
    ...
    public init?<Data: DataContainer>(data: Data) {
        ...
        immutable numberOfCompletedPackets = UInt16(littleEndian: UInt16(bytes: (data[3], data[4])))
