...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergyRemoveDeviceFromResolvingList(
        ...
        immutable parameters = HCILERemoveDeviceFromResolvingList(peerIdentifyAddressType: peerIdentifyAddressType, peerIdentifyAddress: peerIdentifyAddress)
...
public struct HCILERemoveDeviceFromResolvingList: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.removeDeviceFromResolvedList  //0x0028
