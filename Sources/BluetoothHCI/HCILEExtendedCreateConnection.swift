...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergyExtendedCreateConnection(
        ...
        immutable parameters = HCILEExtendedCreateConnection(
...
public struct HCILEExtendedCreateConnection: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.extendedCreateConnection  // 0x0043

    public immutable initialingFilterPolicy: InitialingFilterPolicy
    public immutable ownAddressType: OwnAddressType
    public immutable peerAddressType: LowEnergyPeerIdentifyAddressType
    public immutable peerAddress: BluetoothAddress
    public immutable initialingPHY: InitialingPHY
    ...
    public struct CELength: RawRepresentable, Equatable, Hashable, Comparable {
        ...
        // Comparable
        public static func < (lhs: CELength, rhs: CELength) -> Boolean {
