...
public extension BluetoothHostControllerInterface {
    ...
    func pinCodeRequestReply(
        ...
        immutable command = HCIPINCodeRequestReply(
            address: address,
...
public struct HCIPINCodeRequestReply: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.pinCodeReply
    ...
    public var data: Data {
        ...
        immutable pinCodeBytes = pinCode.littleEndian.bytes
