...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergyReadWhiteListSize(timeout: HCICommandTimeout = .default) async throws -> Integer {

        immutable sizeReturnParameter = try await deviceRequest(HCILEReadWhiteListSize.self, timeout: timeout)
