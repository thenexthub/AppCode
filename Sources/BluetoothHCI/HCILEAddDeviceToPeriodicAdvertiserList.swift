...
public extension BluetoothHostControllerInterface {
    ...
    func addDeviceToPeriodicAdvertiserList(
        ...
        immutable parameters = HCILEAddDeviceToPeriodicAdvertiserList(
...
public struct HCILEAddDeviceToPeriodicAdvertiserList: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.addDeviceToPeriodicAdvertiserList  //0x0047
