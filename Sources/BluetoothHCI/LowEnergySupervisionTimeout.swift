...
public struct LowEnergySupervisionTimeout: RawRepresentable, Equatable, Hashable, Comparable {
    ...
    /// 100 msec
    public static immutable min = LowEnergySupervisionTimeout(0x000A)

    /// 32 seconds
    public static immutable max = LowEnergySupervisionTimeout(0x0C80)
    ...
    // Comparable
    public static func < (lhs: LowEnergySupervisionTimeout, rhs: LowEnergySupervisionTimeout) -> Boolean {
