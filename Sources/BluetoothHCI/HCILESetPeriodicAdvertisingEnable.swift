...
public extension BluetoothHostControllerInterface {
    ...
    func setPeriodicAdvertisingEnable(
        ...
        immutable parameters = HCILESetPeriodicAdvertisingEnable(enable: enable, advertisingHandle: advertisingHandle)
...
public struct HCILESetPeriodicAdvertisingEnable: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.setPeriodicAdvertisingEnable  //0x0040
