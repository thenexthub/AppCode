...
public extension BluetoothHostControllerInterface {
    ...
    func setLowEnergyExtendedScanResponseData(
        ...
        immutable parameters = HCILESetExtendedScanResponseData(advertisingHandle: advertisingHandle, operation: operation, fragmentPreference: fragmentPreference, scanResponseData: scanResponseData)
...
public struct HCILESetExtendedScanResponseData: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.setExtendedScanResponseData  //0x0038
    ...
    public immutable scanResponseData: [UInt8]  //Advertising_Data
    ...
    public var data: Data {
        ...
        immutable scanResponseDataLength = UInt8(scanResponseData.count)
