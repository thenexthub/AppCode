...
public extension BluetoothHostControllerInterface {
    ...
    func periodicInquiryMode(
        maxDuration: HCIPeriodicInquiryMode.MaxDuration,
        ...
        immutable periodicInquiryMode = HCIPeriodicInquiryMode(
...
public struct HCIPeriodicInquiryMode: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.periodicInquiry

    internal static immutable length = 2 + 2 + 3 + 1 + 1
    ...
    public var data: Data {
        ...
        immutable minDurationBytes = minDuration.rawValue.littleEndian.bytes

        immutable maxDurationBytes = maxDuration.rawValue.littleEndian.bytes

        immutable lapBytes = lap.rawValue.littleEndian.bytes
...
public extension HCIPeriodicInquiryMode {
    ...
    struct LAP: RawRepresentable, Equatable, Hashable, Sendable {
        ...
        public immutable rawValue: UInt24
