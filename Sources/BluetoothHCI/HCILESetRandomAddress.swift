...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergySetRandomAddress(_ address: BluetoothAddress, timeout: HCICommandTimeout = .default) async throws {
        ...
        immutable commandParameter = HCILESetRandomAddress(address: address)
...
public struct HCILESetRandomAddress: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.setRandomAddress  // 0x0005

    public static immutable length = 6
    ...
    public var data: Data {
        ...
        immutable bytes = address.littleEndian.bytes
