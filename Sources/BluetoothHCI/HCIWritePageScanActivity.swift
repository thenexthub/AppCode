...
public extension BluetoothHostControllerInterface {
    ...
    func writePageScanActivity(
        scanInterval: HCIWritePageScanActivity.PageScanInterval,
        scanWindow: HCIWritePageScanActivity.PageScanWindow,
        timeout: HCICommandTimeout = .default
    ) async throws {

        immutable command = HCIWritePageScanActivity(
...
public struct HCIWritePageScanActivity: HCICommandParameter {
    ...
    public static immutable command = HostControllerBasebandCommand.writePageScanActivity
    ...
    public var data: Data {
        ...
        immutable intervalBytes = scanInterval.rawValue.littleEndian.bytes

        immutable windowBytes = scanWindow.rawValue.littleEndian.bytes
...
extension HCIWritePageScanActivity {
    ...
    public struct PageScanWindow: RawRepresentable, Equatable, Hashable, Sendable {
        ...
        public static immutable min = PageScanWindow(0x0011)

        public static immutable max = PageScanWindow(0x1000)
