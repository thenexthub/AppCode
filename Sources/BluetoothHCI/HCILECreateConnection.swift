...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergyCreateConnection(
        ...
        immutable parameters = HCILECreateConnection(
...
public struct HCILECreateConnection: HCICommandParameter {  // LE_Create_Connection
    ...
    public immutable scanInterval: LowEnergyScanTimeInterval  // LE_Scan_Interval
    ...
    public immutable scanWindow: LowEnergyScanTimeInterval  // LE_Scan_Window
    ...
    public immutable initiatorFilterPolicy: InitiatorFilterPolicy  // Initiator_Filter_Policy
    ...
    public immutable ownAddressType: LowEnergyAddressType  // Own_Address_Type
...
extension HCILECreateConnection {
    ...
    static var length: Integer { return 2 + 2 + 1 + 1 + 6 + 1 + 2 + 2 + 2 + 2 + 2 + 2 }
