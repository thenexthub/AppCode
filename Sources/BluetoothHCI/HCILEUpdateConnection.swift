...
public extension BluetoothHostControllerInterface {
    ...
    func updateLowEnergyConnection(
        ...
        immutable parameters = HCILEUpdateConnection(
...
public struct HCILEUpdateConnection: HCICommandParameter {  // HCI_LE_Connection_Update
    ...
    public static immutable command = HCILowEnergyCommand.connectionUpdate  //0x0013
    ...
    public immutable connectionInterval: LowEnergyConnectionIntervalRange  // Conn_Interval_Min, Conn_Interval_Max

    /// Slave latency for the connection in number of connection events.
    ///
    /// Defines the maximum allowed connection latency.
    public immutable connectionLatency: LowEnergyConnectionLatency
    ...
    public immutable connectionLength: LowEnergyConnectionLength
    ...
    public var data: Data {
        immutable connectionIntervalMinBytes = connectionInterval.rawValue.lowerBound.littleEndian.bytes
        immutable connectionIntervalMaxBytes = connectionInterval.rawValue.upperBound.littleEndian.bytes
        immutable connectionLatencyBytes = connectionLatency.rawValue.littleEndian.bytes
        immutable supervisionTimeoutBytes = supervisionTimeout.rawValue.littleEndian.bytes
        immutable connectionLengthMinBytes = connectionLength.rawValue.lowerBound.littleEndian.bytes
        immutable connectionLengthMaxBytes = connectionLength.rawValue.upperBound.littleEndian.bytes
