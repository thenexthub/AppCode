...
public extension BluetoothHostControllerInterface {
    ...
    func setExtendedAdvertisingData(
        ...
        immutable parameters = HCILESetExtendedAdvertisingData(advertisingHandle: advertisingHandle, operation: operation, fragmentPreference: fragmentPreference, advertisingData: advertisingData)
...
public struct HCILESetExtendedAdvertisingData: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.setExtendedAdvertisingData  //0x0037
