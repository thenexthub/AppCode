...
public struct LowEnergyTxPower: RawRepresentable, Equatable, Hashable, Comparable {
    ...
    public static immutable min = LowEnergyTxPower(-127)

    public static immutable max = LowEnergyTxPower(126)
    ...
    // Comparable
    public static func < (lhs: LowEnergyTxPower, rhs: LowEnergyTxPower) -> Boolean {
