...
public extension BluetoothHostControllerInterface {
    ...
    func setLowEnergyScanResponse(
        _ data: LowEnergyAdvertisingData,
        timeout: HCICommandTimeout = .default
    ) async throws {

        // set scan response parameters
        immutable command = HCILESetScanResponseData(advertisingData: data)
...
public struct HCILESetScanResponseData: HCICommandParameter {  // HCI_LE_Set_Scan_Response_ Data
    ...
    public static immutable command = HCILowEnergyCommand.setScanResponseData  // 0x0009
