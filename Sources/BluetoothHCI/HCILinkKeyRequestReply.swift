...
public extension BluetoothHostControllerInterface {
    ...
    func linkKeyRequestReply(
        address: BluetoothAddress,
        linkKey: UInt128,
        timeout: HCICommandTimeout = .default
    ) async throws {

        immutable linkKeyRequestReply = HCILinkKeyRequestReply(address: address, linkKey: linkKey)
...
public struct HCILinkKeyRequestReply: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.linkKeyReply
    ...
    public var data: Data {
        ...
        immutable linkKeyBytes = linkKey.littleEndian.bytes
