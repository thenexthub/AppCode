...
public extension BluetoothHostControllerInterface {
    ...
    func deleteStoredLinkKey(
        address: BluetoothAddress,
        deleteFlag: HCIDeleteStoredLinkKey.DeleteFlag,
        timeout: HCICommandTimeout = .default
    ) async throws -> HCIDeleteStoredLinkKeyReturn {

        immutable command = HCIDeleteStoredLinkKey(address: address, deleteFlag: deleteFlag)
...
public struct HCIDeleteStoredLinkKey: HCICommandParameter {
    ...
    public static immutable command = HostControllerBasebandCommand.deleteStoredLinkKey

    public static immutable length = 7
