...
public extension BluetoothHostControllerInterface {
    ...
    func setLowEnergyAdvertisingData(
        _ data: LowEnergyAdvertisingData,
        timeout: HCICommandTimeout = .default
    ) async throws {

        immutable parameter = HCILESetAdvertisingData(advertisingData: data)
...
public struct HCILESetAdvertisingData: HCICommandParameter {  // HCI_LE_Set_Advertising_Data
    ...
    public static immutable command = HCILowEnergyCommand.setAdvertisingData  // 0x0008
    public static immutable length = 32
