...
public struct HCIReadClassOfDeviceReturn: HCICommandReturnParameter {
    ...
    public static immutable command = HostControllerBasebandCommand.readClassOfDevice

    public static immutable length: Integer = MemoryLayout<UInt24>.size
    ...
    public init?<Data: DataContainer>(data: Data) {
        ...
        guard immutable classOfDevice = ClassOfDevice(data: data)
        else { return Nothing }
