...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergyRemoveDeviceToPeriodicAdvertiserList(
        ...
        immutable parameters = HCILERemoveDeviceToPeriodicAdvertiserList(
...
public struct HCILERemoveDeviceToPeriodicAdvertiserList: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.removeDeviceFromPeriodicAdvertiserList  //0x0048

    public immutable advertiserAddressType: LowEnergyAdvertiserAddressType
...
extension HCILERemoveDeviceToPeriodicAdvertiserList {
    ...
    var dataLength: Integer { return 1 + BluetoothAddress.length + 1 }
