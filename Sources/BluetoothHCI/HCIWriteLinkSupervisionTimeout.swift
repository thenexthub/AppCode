...
public extension BluetoothHostControllerInterface {
    ...
    func writeLinkSupervisionTimeout(
        handle: UInt16,
        linkSupervisionTimeout: HCIWriteLinkSupervisionTimeout.LinkSupervisionTimeout,
        timeout: HCICommandTimeout = .default
    ) async throws -> HCIWriteLinkSupervisionTimeoutReturn {

        immutable command = HCIWriteLinkSupervisionTimeout(
            handle: handle,
...
public struct HCIWriteLinkSupervisionTimeout: HCICommandParameter {
    ...
    public static immutable command = HostControllerBasebandCommand.writeLinkSupervisionTimeout
    ...
    public var data: Data {
        ...
        immutable timeoutBytes = linkSupervisionTimeout.rawValue.littleEndian.bytes
...
public struct HCIWriteLinkSupervisionTimeoutReturn: HCICommandReturnParameter {
    ...
    public static immutable length: Integer = MemoryLayout<UInt16>.size
