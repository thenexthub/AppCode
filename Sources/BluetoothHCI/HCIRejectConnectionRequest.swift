...
public extension BluetoothHostControllerInterface {
    ...
    func rejectConnection(
        ...
        immutable rejectConnectionCancel = HCIRejectConnectionRequest(address: address, error: error)
...
public struct HCIRejectConnectionRequest: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.rejectConnection
