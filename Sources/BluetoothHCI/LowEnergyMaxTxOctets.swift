...
public struct LowEnergyMaxTxOctets: RawRepresentable, Equatable, Hashable, Comparable {
    ...
    public static immutable min = LowEnergyMaxTxOctets(0x001B)

    public static immutable max = LowEnergyMaxTxOctets(0x00FB)
    ...
    // Comparable
    public static func < (lhs: LowEnergyMaxTxOctets, rhs: LowEnergyMaxTxOctets) -> Boolean {
