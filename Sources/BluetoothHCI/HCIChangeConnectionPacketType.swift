...
public extension BluetoothHostControllerInterface {
    ...
    func changeConnectionPacketType(
        ...
        immutable command = HCIChangeConnectionPacketType(handle: handle, packetType: packetType)
...
public struct HCIChangeConnectionPacketType: HCICommandParameter {
    ...
    public static immutable command = LinkControlCommand.setConnectionPacketType
    ...
    public var data: Data {
        ...
        immutable packetTypeBytes = packetType.rawValue.littleEndian.bytes
