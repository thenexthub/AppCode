...
public extension BluetoothHostControllerInterface {
    ...
    func setLowEnergyEventMask(
        ...
        immutable parameter = HCILESetEventMask(eventMask: eventMask)
...
public struct HCILESetEventMask: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.setEventMask  // 0x0001
    ...
    public var data: Data {
        ...
        immutable eventMaskBytes = eventMask.rawValue.littleEndian.bytes
