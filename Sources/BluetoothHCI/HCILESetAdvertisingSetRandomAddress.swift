...
public extension BluetoothHostControllerInterface {
    ...
    func setAdvertisingSetRandomAddress(
        ...
        immutable parameters = HCILESetAdvertisingSetRandomAddress(advertisingHandle: advertisingHandle, advertisingRandomAddress: advertisingRandomAddress)
...
public struct HCILESetAdvertisingSetRandomAddress: HCICommandParameter {  //HCI_LE_Set_Advertising_Set_Ran- dom_Address
    ...
    public static immutable command = HCILowEnergyCommand.setAdvertisingSetRandomAddress  //0x0035

    /// Used to identify an advertising set
    public immutable advertisingHandle: UInt8

    /// Random Device Address
    public immutable advertisingRandomAddress: BluetoothAddress
    ...
    public var data: Data {
        ...
        immutable advertisingRandomAddressBytes = advertisingRandomAddress.littleEndian.bytes
