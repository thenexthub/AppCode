...
public extension BluetoothHostControllerInterface {
    ...
    /// reference packets.
    func lowEnergyEnhancedReceiverTest(rxChannel: LowEnergyRxChannel, phy: HCILEEnhancedReceiverTest.Phy, modulationIndex: HCILEEnhancedReceiverTest.ModulationIndex, timeout: HCICommandTimeout = .default) async throws {

        immutable parameters = HCILEEnhancedReceiverTest(rxChannel: rxChannel, phy: phy, modulationIndex: modulationIndex)
...
public struct HCILEEnhancedReceiverTest: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.enhancedReceiverTest  //0x0033

    public immutable rxChannel: LowEnergyRxChannel
    public immutable phy: Phy
    public immutable modulationIndex: ModulationIndex
