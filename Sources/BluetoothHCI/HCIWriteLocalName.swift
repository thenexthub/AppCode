...
public extension BluetoothHostControllerInterface {
    ...
    func writeLocalName(_ newValue: String, timeout: HCICommandTimeout = .default) async throws {
        ...
        guard immutable command = HCIWriteLocalName(localName: newValue)
...
public struct HCIWriteLocalName: HCICommandParameter {
    ...
    public static immutable command = HostControllerBasebandCommand.writeLocalName

    public static immutable length = HCI.maximumNameLength
    ...
    public var data: Data {
        ...
        immutable maxLength = Self.length
