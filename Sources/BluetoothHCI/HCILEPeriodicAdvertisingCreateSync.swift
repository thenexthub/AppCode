...
public struct HCILEPeriodicAdvertisingCreateSync: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.periodicAdvertisingCreateSync  //0x0044

    public immutable filterPolicy: FilterPolicy

    public immutable advertisingSid: UInt8

    public immutable advertisingAddressType: AdvertisingAddressType
    ...
    public immutable skip: UInt16

    public immutable syncTimeout: SyncTimeout

    /// This value must be used by the Host
    public immutable unused: UInt8
    ...
    public var data: Data {
        ...
        immutable skipBytes = skip.littleEndian.bytes
        immutable syncTimeoutBytes = syncTimeout.rawValue.littleEndian.bytes
    ...
    public struct SyncTimeout: RawRepresentable, Equatable, Hashable, Comparable, Sendable {
        ...
        // Comparable
        public static func < (lhs: SyncTimeout, rhs: SyncTimeout) -> Boolean {
