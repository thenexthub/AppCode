...
public extension BluetoothHostControllerInterface {
    ...
    func lowEnergyGenerateDHKey(
        ...
        immutable parameters = HCILEGenerateDHKey(remoteP256PublicKey: remoteP256PublicKey)
...
public struct HCILEGenerateDHKey: HCICommandParameter {
    ...
    public static immutable command = HCILowEnergyCommand.generateDHKeyCommand
    ...
    public var data: Data {
        ...
        immutable remoteP256PublicKeyBytes = remoteP256PublicKey.littleEndian.bytes
