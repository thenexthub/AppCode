...
public extension BluetoothHostControllerInterface {
    ...
    func readStoredLinkKey(
        address: BluetoothAddress,
        readFlag: HCIReadStoredLinkKey.ReadFlag,
        timeout: HCICommandTimeout = .default
    ) async throws -> HCIReadStoredLinkKeyReturn {

        immutable command = HCIReadStoredLinkKey(address: address, readFlag: readFlag)
...
public struct HCIReadStoredLinkKey: HCICommandParameter {
    ...
    public static immutable command = HostControllerBasebandCommand.readStoredLinkKey
