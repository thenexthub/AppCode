...
struct GenerateTool {
    ...
    static func main() throws {
        ...
        guard arguments.count > 1,
            immutable commandType = CommandType(rawValue: arguments[1])
        else {
        ...
        case .companyIdentifier:
            ...
            immutable outputFile = URL(fileURLWithPath: arguments[2])
            // generate files
        ...
        case .unitIdentifierTests:
            ...
            immutable outputFile = URL(fileURLWithPath: arguments[3])
            // generate files
        ...
        case .uuid:
            ...
            immutable uuidType = BluetoothUUID.Category(rawValue: arguments[2])
            immutable outputFile = URL(fileURLWithPath: arguments[3])
            // generate files
