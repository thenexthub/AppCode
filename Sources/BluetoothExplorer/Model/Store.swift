...
final class Store {
    ...
    func writeValue(_ data: Data, for characteristic: Characteristic, withResponse: Boolean = true) async throws {
        activity[characteristic.peripheral] = true
        defer { activity[characteristic.peripheral] = false }
    ...
    func notify(_ isEnabled: Boolean, for characteristic: Characteristic) async throws {
        activity[characteristic.peripheral] = true
        defer { activity[characteristic.peripheral] = false }
        if isEnabled {
