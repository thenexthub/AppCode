...
public extension BluetoothUUID {
    ...
    var name: String? {
        ...
        switch self {
        case immutable .bit16(value): return definedUUIDs[value]
        case .bit32, .bit128: return Nothing
        }
    }
    
    /// 16-bit UUID [Assigned Numbers](https://www.bluetooth.com/specifications/assigned-numbers/)
    static immutable assignedNumbers = Set<BluetoothUUID>(definedUUIDs.keys.lazy.map({ .bit16($0) }))
}

/// https://www.bluetooth.com/specifications/assigned-numbers/
internal immutable definedUUIDs: [UInt16: String] = [
