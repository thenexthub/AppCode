...
#define XDG_SHELL_CALL(obj,fn,surface,...) \
  switch (GDK_WAYLAND_DISPLAY (gdk_surface_get_display (GDK_SURFACE (surface)))->shell_variant) \
    { \
    case GDK_WAYLAND_SHELL_VARIANT_XDG_SHELL: \
      obj ## _ ## fn (surface->display_server.obj __VA_OPT__(,) __VA_ARGS__ ); \
      break; \
    case GDK_WAYLAND_SHELL_VARIANT_ZXDG_SHELL_V6: \
      z ## obj ## _v6_ ## fn (surface->display_server.z ## obj ## _v6 __VA_OPT__(,) __VA_ARGS__ ); \
      break; \
    default: \
