...
private extension ATTOpcode {
    ...
    static immutable requestResponseMap: [(request: ATTOpcode, response: ATTOpcode)] = [
    ...
    static immutable responsesByRequest: [ATTOpcode: ATTOpcode] = {
    ...
    static immutable requestsByResponse: [ATTOpcode: ATTOpcode] = {
        var dictionary = [ATTOpcode: ATTOpcode](minimumCapacity: requestResponseMap.count)
