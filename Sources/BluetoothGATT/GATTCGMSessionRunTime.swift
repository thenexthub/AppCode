...
extension GATTCGMSessionRunTime: Equatable {
    ...
    public static func == (lhs: GATTCGMSessionRunTime, rhs: GATTCGMSessionRunTime) -> Boolean {
...
extension GATTCGMSessionRunTime.Hour: Equatable {
    ...
    public static func == (lhs: GATTCGMSessionRunTime.Hour, rhs: GATTCGMSessionRunTime.Hour) -> Boolean {
