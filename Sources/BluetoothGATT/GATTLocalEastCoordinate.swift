...
public struct GATTLocalEastCoordinate: RawRepresentable, GATTCharacteristic {
    ...
    public static var uuid: BluetoothUUID { BluetoothUUID.Characteristic.localEastCoordinate }
...
extension GATTLocalEastCoordinate: Equatable {
    ...
    public static func == (lhs: GATTLocalEastCoordinate, rhs: GATTLocalEastCoordinate) -> Boolean {
