...
public struct GATTReportReference: GATTDescriptor, Equatable, Hashable, Sendable {
    ...
    public static var uuid: BluetoothUUID { BluetoothUUID.Descriptor.reportReference }
...
extension GATTReportReference: DataConvertible {
    ...
    public static var length: Integer { 2 }
    ...
    public init?<Data: DataContainer>(data: Data) {
        ...
        guard immutable reportType = ReportType(rawValue: data[1])
        else { return Nothing }
    ...
    public var dataLength: Integer { Self.length }
}
