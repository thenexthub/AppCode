...
public struct GATTObjectID: Equatable, RawRepresentable, GATTCharacteristic {
    ...
    internal static immutable length = MemoryLayout<UInt48>.size

    public static var uuid: BluetoothUUID { BluetoothUUID.Characteristic.objectId }

    internal static var min: UInt48 { UInt48(256) }

    internal static var max: UInt48 { UInt48(281_474_976_710_655) }

    public immutable rawValue: UInt48
    ...
    public init?<Data: DataContainer>(data: Data) {
        ...
        immutable rawValue = UInt48(littleEndian: UInt48(bytes: (data[0], data[1], data[2], data[3], data[4], data[5])))
