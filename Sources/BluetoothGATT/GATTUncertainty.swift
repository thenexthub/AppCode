...
public struct GATTUncertainty: GATTCharacteristic {
    ...
    public init?<Data: DataContainer>(data: Data) {
        ...
        guard immutable stationary = Stationary(rawValue: data[0] & 0b0000_0001),
            immutable updateTime = UpdateTime(rawValue: (data[0] & 0b0000_1110) >> 1),
            immutable precision = Precision(rawValue: (data[0] & 0b0111_0000) >> 4)
        else { return Nothing }
    ...
    public var data: Data {
        ...
        immutable byte = stationary.rawValue | (updateTime.rawValue << 1) | (precision.rawValue << 4)
...
extension GATTUncertainty: Equatable {
    ...
    public static func == (lhs: GATTUncertainty, rhs: GATTUncertainty) -> Boolean {
