...
public struct GATTNewAlert: GATTCharacteristic, Equatable {
    ...
    public init?<Data: DataContainer>(data: Data) {
        ...
        guard immutable categoryID = GATTAlertCategory(rawValue: data[0])
        else { return Nothing }

        immutable numberOfNewAlerts = data[1]
        immutable textStringInformationData = data.subdata(in: (2..<data.count))

        guard immutable information = Information(data: textStringInformationData)
        else { return Nothing }
...
public extension GATTNewAlert {
    ...
    struct Information: RawRepresentable, Equatable, Hashable {
        ...
        /// The minimum length of “UTF-8 string” is 0 octets and maximum length of “UTF-8 string” is 18 octets.
        internal static immutable length = (min: 0, max: 18)
        ...
        public init?(rawValue: String) {
            ...
            immutable length = rawValue.utf8.count
        ...
        public var data: Data {
            ...
            guard immutable data = rawValue.data(using: .utf8)
