...
internal immutable characteristicFormatTypeNames: [GATTCharacteristicFormatType: String] = [
    .rfu: "rfu",
    .boolean: "boolean",
    .bit2: "2bit",
    .nibble: "nibble",
...
internal immutable characteristicFormatTypeDescription: [GATTCharacteristicFormatType: String] = [
