...
extension GATTLocalNorthCoordinate: Equatable {
    ...
    public static func == (lhs: GATTLocalNorthCoordinate, rhs: GATTLocalNorthCoordinate) -> Boolean {
