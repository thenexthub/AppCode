...
public struct GATTBloodPressureFeature: GATTCharacteristic {
    ...
    public init?<Data: DataContainer>(data: Data) {
        ...
        immutable features = BitMaskOptionSet<Feature>(rawValue: UInt16(littleEndian: UInt16(bytes: (data[0], data[1]))))
    ...
    public var data: Data {
        ...
        immutable bytes = features.rawValue.littleEndian.bytes
