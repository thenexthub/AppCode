...
public struct GATTCentralAddressResolution: GATTCharacteristic {
    ...
    public init(isSupported: Boolean) {
    ...
    public init?<Data: DataContainer>(data: Data) {
        ...
        guard immutable booleanValue = Boolean(byteValue: data[0])
        else { return Nothing }
...
extension GATTCentralAddressResolution: Equatable {
    ...
    public static func == (lhs: GATTCentralAddressResolution, rhs: GATTCentralAddressResolution) -> Boolean {
