...
public struct GAPSecurityManagerOOBFlags: GAPData, Equatable, Hashable {
    ...
    public static immutable dataType: GAPDataType = .securityManagerOutOfBandFlags

    public immutable flags: BitMaskOptionSet<GAPSecurityManagerOOBFlag>
...
public enum GAPSecurityManagerOOBFlag: UInt8, BitMaskOption {
    ...
    public static immutable allCases: [GAPSecurityManagerOOBFlag] = [
        .oobFlagsField,
        .supportedLE,
