...
public struct GAPSlaveConnectionIntervalRange: GAPData {
    ...
    public static immutable dataType: GAPDataType = .slaveConnectionIntervalRange

    public immutable range: (min: UInt16, max: UInt16)

    public init?(range: (min: UInt16, max: UInt16)) {

        immutable intervalRange = range
...
public extension GAPSlaveConnectionIntervalRange {
    ...
    static immutable min: UInt16 = 0x0006

    static immutable max: UInt16 = 0x0C80

    static immutable undefined: UInt16 = 0xFFFF
}
...
extension GAPSlaveConnectionIntervalRange: Equatable {
    ...
    public static func == (lhs: GAPSlaveConnectionIntervalRange, rhs: GAPSlaveConnectionIntervalRange) -> Boolean {
