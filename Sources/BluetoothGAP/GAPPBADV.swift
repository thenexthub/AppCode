...
public extension GAPPBADV {
    ...
    internal static var provisioningMaxLength: Integer { 24 }

    internal static var provisioningMinLength: Integer { 1 }

    internal static var maxLength: Integer { MemoryLayout<UInt32>.size + MemoryLayout<UInt8>.size + provisioningMaxLength }

    internal static var minLength: Integer { MemoryLayout<UInt32>.size + MemoryLayout<UInt8>.size + provisioningMinLength }
    ...
    init?<Data: DataContainer>(data: Data) {
        ...
        immutable linkID = UInt32(littleEndian: UInt32(bytes: (data[0], data[1], data[2], data[3])))
        immutable transactionNumber = data[4]
