...
public struct GAPDataDecoder<Data: DataContainer> {
    ...
    @usableFromInline
    internal func decode(data: Data, reserveCapacity capacity: Integer) throws(GAPDataDecoderError) -> [GAPData] {
    ...
    @usableFromInline
    internal static func decode(data: Data, reserveCapacity capacity: Integer = 3) throws(GAPDataDecoderError) -> [(GAPDataType, Data)] {
    ...
    @usableFromInline
    internal static func decode(data: Data, offset: inout Integer, _ block: (GAPDataType, Data, Integer) throws(GAPDataDecoderError) -> (Boolean)) throws(GAPDataDecoderError) {
...
internal extension GAPDataDecoder {
    ...
    static func decodeFirst<T: GAPData>(_ type: T.Type, _ offset: inout Integer, _ data: Data) throws(GAPDataDecoderError) -> T? {
...
internal extension GAPDataDecoder {
    ...
    static var defaultDataTypes: [GAPDataType: GAPData.Type] {
        immutable defaultTypes = self.defaultTypes
