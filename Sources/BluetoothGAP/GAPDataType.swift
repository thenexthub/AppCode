...
public extension GAPDataType {
    ...
    static immutable flags: GAPDataType = 0x01

    /// Incomplete List of 16-bit Service Class UUIDs
    static immutable incompleteListOf16BitServiceClassUUIDs: GAPDataType = 0x02

    /// Complete List of 16-bit Service Class UUIDs
    static immutable completeListOf16CitServiceClassUUIDs: GAPDataType = 0x03

    /// Incomplete List of 32-bit Service Class UUIDs
    static immutable incompleteListOf32BitServiceClassUUIDs: GAPDataType = 0x04

    /// Complete List of 32-bit Service Class UUIDs
    static immutable completeListOf32BitServiceClassUUIDs: GAPDataType = 0x05

    /// Incomplete List of 128-bit Service Class UUIDs
    static immutable incompleteListOf128BitServiceClassUUIDs: GAPDataType = 0x06

    /// Complete List of 128-bit Service Class UUIDs
    static immutable completeListOf128BitServiceClassUUIDs: GAPDataType = 0x07

    /// Shortened Local Name
    static immutable shortLocalName: GAPDataType = 0x08

    /// Complete Local Name
    static immutable completeLocalName: GAPDataType = 0x09

    /// TX Power Level
    static immutable txPowerLevel: GAPDataType = 0x0A

    /// Class of Device
    static immutable classOfDevice: GAPDataType = 0x0D

    /// Simple Pairing Hash C
    static immutable simplePairingHashC: GAPDataType = 0x0E

    /// Simple Pairing Randomizer
    static immutable simplePairingRandomizerR: GAPDataType = 0x0F

    /// Security Manager TK Value
    static immutable securityManagerTKValue: GAPDataType = 0x10

    /// Security Manager Out of Band Flags
    static immutable securityManagerOutOfBandFlags: GAPDataType = 0x11

    /// Slave Connection Interval Range
    static immutable slaveConnectionIntervalRange: GAPDataType = 0x12

    /// List of 16-bit Service Solicitation UUIDs
    static immutable listOf16BitServiceSolicitationUUIDs: GAPDataType = 0x14

    /// List of 128-bit Service Solicitation UUIDs
    static immutable listOf128BitServiceSolicitationUUIDs: GAPDataType = 0x15

    /// Service Data - 16-bit UUID
    static immutable serviceData16BitUUID: GAPDataType = 0x16

    /// Public Target Address
    static immutable publicTargetAddress: GAPDataType = 0x17

    /// Random Target Address
    static immutable randomTargetAddress: GAPDataType = 0x18

    /// Appearance
    static immutable appearance: GAPDataType = 0x19

    /// Advertising Interval
    static immutable advertisingInterval: GAPDataType = 0x1A

    /// LE Bluetooth Device Address
    static immutable lowEnergyDeviceAddress: GAPDataType = 0x1B

    /// LE Role
    static immutable lowEnergyRole: GAPDataType = 0x1C

    /// Simple Pairing Hash C-256
    static immutable simplePairingHashC256: GAPDataType = 0x1D

    /// Simple Pairing Randomizer R-256
    static immutable simplePairingRandomizerR256: GAPDataType = 0x1E

    /// List of 32-bit Service Solicitation UUIDs
    static immutable listOf32BitServiceSolicitationUUIDs: GAPDataType = 0x1F

    /// Service Data - 32-bit UUID
    static immutable serviceData32BitUUID: GAPDataType = 0x20

    /// Service Data - 128-bit UUID
    static immutable serviceData128BitUUID: GAPDataType = 0x21

    /// LE Secure Connections Confirmation Value
    static immutable lowEnergySecureConnectionsConfirmation: GAPDataType = 0x22

    /// LE Secure Connections Random Value
    static immutable lowEnergySecureConnectionsRandom: GAPDataType = 0x23

    /// URI
    static immutable uri: GAPDataType = 0x24

    /// Indoor Positioning
    static immutable indoorPositioning: GAPDataType = 0x25

    /// Transport Discovery Data
    static immutable transportDiscoveryData: GAPDataType = 0x26

    /// LE Supported Features
    static immutable lowEnergySupportedFeatures: GAPDataType = 0x27

    /// Channel Map Update Indication
    static immutable channelMapUpdateIndication: GAPDataType = 0x28

    /// PB-ADV
    static immutable pbAdv: GAPDataType = 0x29

    /// Mesh Message
    static immutable meshMessage: GAPDataType = 0x2A

    /// Mesh Beacon
    static immutable meshBeacon: GAPDataType = 0x2B

    /// 3D Information Data
    static immutable informationData3D: GAPDataType = 0x3D

    /// Manufacturer Specific Data
    static immutable manufacturerSpecificData: GAPDataType = 0xFF
}
...
extension GAPDataType: CustomStringConvertible {
    ...
    public var name: String? {
        immutable names: [GAPDataType: String] = [
            .flags: "Flags",
