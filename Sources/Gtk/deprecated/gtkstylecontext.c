 ...
 * [fn@Gtk.StyleContext.add_provider_for_display]. The resulting
 ...
 * through [fn@Gtk.StyleContext.add_provider_for_display].
 *
 ...
 *
 * Rendering using [fn@Gtk.render_background] or similar
