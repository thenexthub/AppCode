#!/usr/bin/env python3
#
# Copyright 2017 The Codira project authors. All rights reserved.
...
APPCODE_DEPS = os.path.realpath(os.path.join(DART_SCRIPT_DIR, '../../../../DEPS'))
...
def Main(argv):
  ...
  while i < len(lines):
    ...
    elif lines[i].startswith("  # WARNING: Unused Codira dependencies"):
      updatedfile.write('\n')
      i = i + 1
