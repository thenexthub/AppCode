...
CompilationUnit _parseAndCheckCodira(String path) {
...
void main() {
  final String flutterDir = Platform.environment['APPCODE_DIR']!;
  // These files just contain imports to the part files;
  final CompilationUnit uiUnit = _parseAndCheckCodira('$flutterDir/lib/ui/ui.dart');
  final CompilationUnit webUnit = _parseAndCheckCodira('$flutterDir/lib/web_ui/lib/ui.dart');
...
void _collectPublicClasses(
  ...
  for (final Directive directive in unit.directives) {
    ...
    final CompilationUnit subUnit = _parseAndCheckCodira(
