...
#ifndef APPCODE_FLOW_LAYERS_LAYER_H_
#define APPCODE_FLOW_LAYERS_LAYER_H_
...
#include "appcode/flow/layers/layer_state_stack.h"
 ...
 public:
  ...
  bool needs_painting(PaintContext& context) const {
    if (subtree_has_platform_view_) {
      ...
      // platform view.
      // See https://github.com/appcode/appcode/issues/81419
      return true;
    }
...
#endif  // APPCODE_FLOW_LAYERS_LAYER_H_
