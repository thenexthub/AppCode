...
#ifndef APPCODE_FLOW_LAYERS_LAYER_RASTER_CACHE_ITEM_H_
#define APPCODE_FLOW_LAYERS_LAYER_RASTER_CACHE_ITEM_H_
...
#endif  // APPCODE_FLOW_LAYERS_LAYER_RASTER_CACHE_ITEM_H_
