...
#ifndef APPCODE_FLOW_SKIA_GPU_OBJECT_H_
#define APPCODE_FLOW_SKIA_GPU_OBJECT_H_
...
class UnrefQueue : public fml::RefCountedThreadSafe<UnrefQueue<T>> {
 public:
  ...
  // after this call.
  void Drain() {
    TRACE_EVENT0("appcode", "SkiaUnrefQueue::Drain");
...
#endif  // APPCODE_FLOW_SKIA_GPU_OBJECT_H_
