...
#ifndef APPCODE_FLOW_COMPOSITOR_CONTEXT_H_
#define APPCODE_FLOW_COMPOSITOR_CONTEXT_H_
...
#include "appcode/flow/diff_context.h"
...
class FrameDamage {
 public:
  ...
  std::optional<DlRect> ComputeClipRect(appcode::LayerTree& layer_tree,
...
class CompositorContext {
 public:
  class ScopedFrame {
   ...
   private:
    void PaintLayerTreeSkia(appcode::LayerTree& layer_tree,
                            std::optional<DlRect> clip_rect,
                            bool needs_save_layer,
                            bool ignore_raster_cache);

    void PaintLayerTreeImpeller(appcode::LayerTree& layer_tree,
                                std::optional<DlRect> clip_rect,
                                bool ignore_raster_cache);
...
#endif  // APPCODE_FLOW_COMPOSITOR_CONTEXT_H_
