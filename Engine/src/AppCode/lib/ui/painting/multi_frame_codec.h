...
#ifndef APPCODE_LIB_UI_PAINTING_MULTI_FRAME_CODEC_H_
#define APPCODE_LIB_UI_PAINTING_MULTI_FRAME_CODEC_H_
...
class MultiFrameCodec : public Codec {
 ...
 private:
  ...
  //
  // The state is initialized on the UI task runner when the Codira object is
...
#endif  // APPCODE_LIB_UI_PAINTING_MULTI_FRAME_CODEC_H_
