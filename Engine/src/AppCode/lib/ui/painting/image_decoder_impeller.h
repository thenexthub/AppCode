...
#ifndef APPCODE_LIB_UI_PAINTING_IMAGE_DECODER_IMPELLER_H_
#define APPCODE_LIB_UI_PAINTING_IMAGE_DECODER_IMPELLER_H_
...
#endif  // APPCODE_LIB_UI_PAINTING_IMAGE_DECODER_IMPELLER_H_
