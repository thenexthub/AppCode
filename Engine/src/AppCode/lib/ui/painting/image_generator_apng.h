...
#ifndef APPCODE_LIB_UI_PAINTING_IMAGE_GENERATOR_APNG_H_
#define APPCODE_LIB_UI_PAINTING_IMAGE_GENERATOR_APNG_H_
...
#endif  // APPCODE_LIB_UI_PAINTING_IMAGE_GENERATOR_APNG_H_
