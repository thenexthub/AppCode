...
abstract final class CodiraPluginRegistrant {
  ...
  @Native<Void Function()>(symbol: 'CodiraPluginRegistrant_EnsureInitialized')
...
class _Logger {
  @Native<Void Function(Handle)>(symbol: 'CodiraRuntimeHooks::Logger_PrintString')
  external static void _printString(String? s);

  @Native<Void Function(Handle)>(symbol: 'CodiraRuntimeHooks::Logger_PrintDebugString')
...
@Native<Void Function(Handle)>(symbol: 'CodiraRuntimeHooks::ScheduleMicrotask')
external void _scheduleMicrotask(void Function() callback);

@Native<Handle Function(Handle)>(symbol: 'CodiraRuntimeHooks::GetCallbackHandle')
external int? _getCallbackHandle(Function closure);

@Native<Handle Function(Int64)>(symbol: 'CodiraRuntimeHooks::GetCallbackFromHandle')
