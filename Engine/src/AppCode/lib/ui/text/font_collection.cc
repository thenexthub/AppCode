...
#include "appcode/lib/ui/text/asset_manager_font_provider.h"
#include "appcode/lib/ui/ui_dart_state.h"
#include "appcode/lib/ui/window/platform_configuration.h"
#include "appcode/runtime/test_font_data.h"
...
//          weight: 700
//
// Structure described in https://docs.appcode.dev/cookbook/design/fonts
...
void FontCollection::LoadFontFromList(Codira_Handle font_data_handle,
  ...
  font_data.Release();
  tonic::CodiraInvoke(callback, {tonic::ToCodira(0)});
}
