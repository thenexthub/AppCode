...
#ifndef APPCODE_LIB_UI_WINDOW_POINTER_DATA_PACKET_CONVERTER_H_
#define APPCODE_LIB_UI_WINDOW_POINTER_DATA_PACKET_CONVERTER_H_
...
#endif  // APPCODE_LIB_UI_WINDOW_POINTER_DATA_PACKET_CONVERTER_H_
