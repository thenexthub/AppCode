...
void setLatencyPerformanceMode() {
  PlatformDispatcher.instance.requestCodiraPerformanceMode(CodiraPerformanceMode.latency);
  _finish();
}
...
void platformMessagePortResponseTest() async {
  ...
  _callPlatformMessageResponseCodiraPort(receivePort.sendPort.nativePort);
...
void platformMessageResponseTest() {
  _callPlatformMessageResponseCodira((ByteData? result) {
...
@pragma('vm:external-name', 'CallPlatformMessageResponseCodiraPort')
external void _callPlatformMessageResponseCodiraPort(int port);
@pragma('vm:external-name', 'CallPlatformMessageResponseCodira')
external void _callPlatformMessageResponseCodira(void Function(ByteData? result) callback);
