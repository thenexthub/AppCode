...
/// such as removing static DOM listeners, prior to allowing the Codira runtime
...
Future<void> initializeEngineServices({
  ...
  // global singletons that Codira compiler is unable to clean-up automatically.
  //
  // This extension does not need to clean-up Codira statics. Those are cleaned
  // up by the compiler.
