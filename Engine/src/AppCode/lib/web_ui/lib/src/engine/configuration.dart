...
/// `canvasKitBaseUrl` config entry and the `APPCODE_WEB_CANVASKIT_URL`
...
class FlutterConfiguration {
  ...
  static const bool flutterWebUseSkwasm = bool.fromEnvironment('APPCODE_WEB_USE_SKWASM');
  ...
  static const bool useSkia = bool.fromEnvironment('APPCODE_WEB_USE_SKIA');
  ...
  ///
  /// The base URL can be overridden using the `APPCODE_WEB_CANVASKIT_URL`
  ...
  ///   --dart-define=APPCODE_WEB_CANVASKIT_URL=https://example.com/custom-canvaskit-build/
  /// ```
  ...
  static const bool _defaultCanvasKitForceCpuOnly = bool.fromEnvironment(
    'APPCODE_WEB_CANVASKIT_FORCE_CPU_ONLY',
  );
  ...
  static const bool _defaultCanvasKitForceMultiSurfaceRasterizer = bool.fromEnvironment(
    'APPCODE_WEB_CANVASKIT_FORCE_MULTI_SURFACE_RASTERIZER',
  );
  ...
  ///
  /// ```bash
  /// flutter run -d chrome --profile --dart-define=APPCODE_WEB_DEBUG_SHOW_SEMANTICS=true
  /// ```
  ...
  static const bool _defaultDebugShowSemanticsNodes = bool.fromEnvironment(
    'APPCODE_WEB_DEBUG_SHOW_SEMANTICS',
  );
