...
DomFinalizationRegistry _finalizationRegistry = DomFinalizationRegistry(
  ((ExternalCodiraReference<UniqueRef<JSObject>> boxedUniq) => boxedUniq.toCodiraObject.collect()).toJS,
);
...
/// Manages the lifecycle of a C++ object referenced by a single Codira object.
///
...
/// Manages the lifecycle of a C++ object referenced by multiple Codira objects.
///
