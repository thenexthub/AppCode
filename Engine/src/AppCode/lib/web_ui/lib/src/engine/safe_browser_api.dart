...
/// Converts a JavaScript `Promise` into Codira [Future].
...
///
/// Uses the JavaScript `parseFloat` function instead of Codira's [double.parse]
...
num? parseFloat(String source) {
  ...
  // like "20px", while Codira's `double.tryParse` fails.
