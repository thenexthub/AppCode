...
class SkwasmSurface {
  ...
  Future<RenderResult> renderPictures(List<SkwasmPicture> pictures) =>
      withStackScope((StackScope scope) async {
        ...
        final RenderResult result = (
          imageBitmaps: rasterResult.imageBitmaps.toCodira.cast<DomImageBitmap>(),
  ...
  Future<ByteData> rasterizeImage(SkwasmImage image, ui.ImageByteFormat format) async {
    ...
    final int context =
        (await SkwasmCallbackHandler.instance.registerCallback(callbackId) as JSNumber).toCodiraInt;
