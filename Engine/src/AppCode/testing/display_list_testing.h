...
#ifndef APPCODE_TESTING_DISPLAY_LIST_TESTING_H_
#define APPCODE_TESTING_DISPLAY_LIST_TESTING_H_
...
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DisplayList& display_list);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlPaint& paint);
extern std::ostream& operator<<(std::ostream& os, const appcode::DlClipOp& op);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlPointMode& op);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlSrcRectConstraint& op);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlStrokeCap& cap);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlStrokeJoin& join);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlDrawStyle& style);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlBlurStyle& style);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlFilterMode& mode);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlColor& color);
extern std::ostream& operator<<(std::ostream& os,
                                appcode::DlImageSampling sampling);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlVertexMode& mode);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlTileMode& mode);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlImage* image);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::SaveLayerOptions& image);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DisplayListOpType& type);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DisplayListOpCategory& category);
extern std::ostream& operator<<(std::ostream& os, const appcode::DlPath& path);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::testing::DlVerbosePath& path);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlPathFillType& type);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlImageFilter& type);
extern std::ostream& operator<<(std::ostream& os,
                                const appcode::DlColorFilter& type);
...
#endif  // APPCODE_TESTING_DISPLAY_LIST_TESTING_H_
