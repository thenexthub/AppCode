    ...
    ArgParser()
      ...
      ..addOption(
        ...
        help:
            ...
            'Defaults to the environment variable APPCODE_TEST_OUTPUTS_DIR, '
            'otherwise to a randomly generated temporary directory.',
        defaultsTo: io.Platform.environment['APPCODE_TEST_OUTPUTS_DIR'],
      );
...
Future<io.Process> _runTests({
  ...
  return io.Process.start('xcodebuild', [
    ...
    'clean',
    'test',
    'APPCODE_ENGINE=$iosEngineVariant',
    ...xcodeBuildExtraArgs,
