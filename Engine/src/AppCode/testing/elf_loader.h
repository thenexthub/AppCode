...
#ifndef APPCODE_TESTING_ELF_LOADER_H_
#define APPCODE_TESTING_ELF_LOADER_H_
...
struct LoadedELFDeleter {
  void operator()(Codira_LoadedElf* elf) { ::Codira_UnloadELF(elf); }
};
...
#endif  // APPCODE_TESTING_ELF_LOADER_H_
