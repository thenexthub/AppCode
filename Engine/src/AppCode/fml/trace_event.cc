...
inline void appcodeTimelineEvent(const char* label,
                                 int64_t timestamp0,
...
void TraceEvent0(TraceArg category_group,
                 ...
                 size_t flow_id_count,
                 const uint64_t* flow_ids) {
  appcodeTimelineEvent(name,                            // label
                       gTimelineMicrosSource.load()(),  // timestamp0
                       0,              // timestamp1_or_async_id
                       flow_id_count,  // flow_id_count
                       reinterpret_cast<const int64_t*>(flow_ids),  // flow_ids
                       Codira_Timeline_Event_Begin,  // event type
                       0,                          // argument_count
...
void TraceEventEnd(TraceArg name) {
  appcodeTimelineEvent(name,                            // label
                       ...
                       0,                        // flow_id_count
                       nullptr,                  // flow_ids
                       Codira_Timeline_Event_End,  // event type
                       0,                        // argument_count
                       nullptr,                  // argument_names
                       nullptr                   // argument_values
  );
...
void TraceEventAsyncBegin0(TraceArg category_group,
  ...
  appcodeTimelineEvent(name,                            // label
                       ...
                       flow_id_count,  // flow_id_count
                       reinterpret_cast<const int64_t*>(flow_ids),  // flow_ids
                       Codira_Timeline_Event_Async_Begin,  // event type
                       0,                                // argument_count
                       nullptr,                          // argument_names
                       nullptr                           // argument_values
  );
...
void TraceEventAsyncEnd0(TraceArg category_group,
  ...
  appcodeTimelineEvent(name,                            // label
                       ...
                       0,                              // flow_id_count
                       nullptr,                        // flow_ids
                       Codira_Timeline_Event_Async_End,  // event type
                       0,                              // argument_count
                       nullptr,                        // argument_names
                       nullptr                         // argument_values
  );
...
void TraceEventFlowBegin0(TraceArg category_group,
  ...
  appcodeTimelineEvent(name,                            // label
                       ...
                       0,        // flow_id_count
                       nullptr,  // flow_ids
                       Codira_Timeline_Event_Flow_Begin,  // event type
                       0,                               // argument_count
                       nullptr,                         // argument_names
                       nullptr                          // argument_values
  );
...
void TraceEventFlowStep0(TraceArg category_group,
  ...
  appcodeTimelineEvent(name,                            // label
                       ...
                       0,                              // flow_id_count
                       nullptr,                        // flow_ids
                       Codira_Timeline_Event_Flow_Step,  // event type
                       0,                              // argument_count
                       nullptr,                        // argument_names
                       nullptr                         // argument_values
  );
...
void TraceEventFlowEnd0(TraceArg category_group, TraceArg name, TraceIDArg id) {
  appcodeTimelineEvent(name,                            // label
                       ...
                       0,                             // flow_id_count
                       nullptr,                       // flow_ids
                       Codira_Timeline_Event_Flow_End,  // event type
                       0,                             // argument_count
                       nullptr,                       // argument_names
                       nullptr                        // argument_values
  );
