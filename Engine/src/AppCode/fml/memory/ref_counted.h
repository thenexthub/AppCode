...
#ifndef APPCODE_FML_MEMORY_REF_COUNTED_H_
#define APPCODE_FML_MEMORY_REF_COUNTED_H_

#include "appcode/fml/macros.h"
#include "appcode/fml/memory/ref_counted_internal.h"
...
#endif  // APPCODE_FML_MEMORY_REF_COUNTED_H_
