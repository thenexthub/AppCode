...
#ifndef APPCODE_FML_BUILD_CONFIG_H_
#define APPCODE_FML_BUILD_CONFIG_H_
...
#define FML_OS_QNX 1
#else
#error Please add support for your platform in appcode/fml/build_config.h
#endif
...
#define FML_ARCH_CPU_LITTLE_ENDIAN 1
#else
#error Please add support for your architecture in appcode/fml/build_config.h
#endif

#endif  // APPCODE_FML_BUILD_CONFIG_H_
