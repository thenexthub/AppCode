...
#ifndef APPCODE_FML_TASK_RUNNER_H_
#define APPCODE_FML_TASK_RUNNER_H_
...
class TaskRunner : public fml::RefCountedThreadSafe<TaskRunner>,
 ...
 public:
  ...
  ///
  /// This is used to ensure that messages posted to Codira from the platform
  /// thread always flush the Codira event loop.
...
#endif  // APPCODE_FML_TASK_RUNNER_H_
