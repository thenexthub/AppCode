...
#ifndef APPCODE_FML_SYNCHRONIZATION_ATOMIC_OBJECT_H_
#define APPCODE_FML_SYNCHRONIZATION_ATOMIC_OBJECT_H_
...
#endif  // APPCODE_FML_SYNCHRONIZATION_ATOMIC_OBJECT_H_
