...
#ifndef APPCODE_FML_SYNCHRONIZATION_WAITABLE_EVENT_H_
#define APPCODE_FML_SYNCHRONIZATION_WAITABLE_EVENT_H_
...
#endif  // APPCODE_FML_SYNCHRONIZATION_WAITABLE_EVENT_H_
