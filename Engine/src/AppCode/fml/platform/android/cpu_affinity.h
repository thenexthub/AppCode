...
#ifndef APPCODE_FML_PLATFORM_ANDROID_CPU_AFFINITY_H_
#define APPCODE_FML_PLATFORM_ANDROID_CPU_AFFINITY_H_
...
#endif  // APPCODE_FML_PLATFORM_ANDROID_CPU_AFFINITY_H_
