...
#ifndef APPCODE_FML_PLATFORM_ANDROID_SCOPED_JAVA_REF_H_
#define APPCODE_FML_PLATFORM_ANDROID_SCOPED_JAVA_REF_H_
...
#endif  // APPCODE_FML_PLATFORM_ANDROID_SCOPED_JAVA_REF_H_
