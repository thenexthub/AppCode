...
#ifndef APPCODE_TXT_SRC_TXT_PARAGRAPH_H_
#define APPCODE_TXT_SRC_TXT_PARAGRAPH_H_
...
class Paragraph {
 public:
  ...
  virtual bool Paint(appcode::DisplayListBuilder* builder,
                     double x,
                     double y) = 0;
...
#endif  // APPCODE_TXT_SRC_TXT_PARAGRAPH_H_
