...
#ifndef APPCODE_IMPELLER_TYPOGRAPHER_TEXT_FRAME_H_
#define APPCODE_IMPELLER_TYPOGRAPHER_TEXT_FRAME_H_
...
using PathCreator = std::function<fml::StatusOr<appcode::DlPath>()>;
...
class TextFrame {
 public:
  ...
  fml::StatusOr<appcode::DlPath> GetPath() const;
...
#endif  // APPCODE_IMPELLER_TYPOGRAPHER_TEXT_FRAME_H_
