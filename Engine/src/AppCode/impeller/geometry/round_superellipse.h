...
#ifndef APPCODE_IMPELLER_GEOMETRY_ROUND_SUPERELLIPSE_H_
#define APPCODE_IMPELLER_GEOMETRY_ROUND_SUPERELLIPSE_H_
...
#endif  // APPCODE_IMPELLER_GEOMETRY_ROUND_SUPERELLIPSE_H_
