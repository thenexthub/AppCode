...
#ifndef APPCODE_IMPELLER_GEOMETRY_GEOMETRY_ASSERTS_H_
#define APPCODE_IMPELLER_GEOMETRY_GEOMETRY_ASSERTS_H_
...
#endif  // APPCODE_IMPELLER_GEOMETRY_GEOMETRY_ASSERTS_H_
