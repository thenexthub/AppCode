...
#ifndef APPCODE_IMPELLER_GEOMETRY_ROUND_SUPERELLIPSE_PARAM_H_
#define APPCODE_IMPELLER_GEOMETRY_ROUND_SUPERELLIPSE_PARAM_H_
...
#endif  // APPCODE_IMPELLER_GEOMETRY_ROUND_SUPERELLIPSE_PARAM_H_
