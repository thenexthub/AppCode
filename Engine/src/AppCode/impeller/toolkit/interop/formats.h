...
#ifndef APPCODE_IMPELLER_TOOLKIT_INTEROP_FORMATS_H_
#define APPCODE_IMPELLER_TOOLKIT_INTEROP_FORMATS_H_

#include <vector>

#include "appcode/display_list/dl_builder.h"
#include "appcode/display_list/dl_color.h"
#include "appcode/txt/src/txt/font_style.h"
#include "appcode/txt/src/txt/font_weight.h"
...
#include "appcode/third_party/skia/include/core/SkRRect.h"
...
constexpr appcode::DlColor ToDisplayListType(Color color) {
  return appcode::DlColor::RGBA(color.red,    //
                                color.green,  //
                                color.blue,   //
                                color.alpha   //
  );
...
constexpr appcode::DlImageSampling ToDisplayListType(
    ImpellerTextureSampling sampling) {
  switch (sampling) {
    case kImpellerTextureSamplingNearestNeighbor:
      return appcode::DlImageSampling::kNearestNeighbor;
    case kImpellerTextureSamplingLinear:
      return appcode::DlImageSampling::kLinear;
  }
  return appcode::DlImageSampling::kLinear;
}

constexpr appcode::DlBlurStyle ToDisplayListType(ImpellerBlurStyle style) {
  switch (style) {
    case kImpellerBlurStyleNormal:
      return appcode::DlBlurStyle::kNormal;
    case kImpellerBlurStyleSolid:
      return appcode::DlBlurStyle::kSolid;
    case kImpellerBlurStyleOuter:
      return appcode::DlBlurStyle::kOuter;
    case kImpellerBlurStyleInner:
      return appcode::DlBlurStyle::kInner;
  }
  return appcode::DlBlurStyle::kNormal;
}

constexpr appcode::DlBlendMode ToDisplayListType(BlendMode mode) {
  using Mode = appcode::DlBlendMode;
  switch (mode) {
...
constexpr appcode::DlTileMode ToDisplayListType(ImpellerTileMode mode) {
  switch (mode) {
    case kImpellerTileModeClamp:
      return appcode::DlTileMode::kClamp;
    case kImpellerTileModeRepeat:
      return appcode::DlTileMode::kRepeat;
    case kImpellerTileModeMirror:
      return appcode::DlTileMode::kMirror;
    case kImpellerTileModeDecal:
      return appcode::DlTileMode::kDecal;
  }
  return appcode::DlTileMode::kClamp;
}
...
constexpr appcode::DlClipOp ToImpellerType(ImpellerClipOperation op) {
  switch (op) {
    case kImpellerClipOperationDifference:
      return appcode::DlClipOp::kDifference;
    case kImpellerClipOperationIntersect:
      return appcode::DlClipOp::kIntersect;
  }
  return appcode::DlClipOp::kDifference;
}
...
constexpr appcode::DlDrawStyle ToDisplayListType(ImpellerDrawStyle style) {
  switch (style) {
    case kImpellerDrawStyleFill:
      return appcode::DlDrawStyle::kFill;
    case kImpellerDrawStyleStroke:
      return appcode::DlDrawStyle::kStroke;
    case kImpellerDrawStyleStrokeAndFill:
      return appcode::DlDrawStyle::kStrokeAndFill;
  }
  return appcode::DlDrawStyle::kFill;
}

constexpr appcode::DlStrokeCap ToDisplayListType(ImpellerStrokeCap cap) {
  switch (cap) {
    case kImpellerStrokeCapButt:
      return appcode::DlStrokeCap::kButt;
    case kImpellerStrokeCapRound:
      return appcode::DlStrokeCap::kRound;
    case kImpellerStrokeCapSquare:
      return appcode::DlStrokeCap::kSquare;
  }
  return appcode::DlStrokeCap::kButt;
}

constexpr appcode::DlStrokeJoin ToDisplayListType(ImpellerStrokeJoin join) {
  switch (join) {
    case kImpellerStrokeJoinMiter:
      return appcode::DlStrokeJoin::kMiter;
    case kImpellerStrokeJoinRound:
      return appcode::DlStrokeJoin::kRound;
    case kImpellerStrokeJoinBevel:
      return appcode::DlStrokeJoin::kBevel;
  }
  return appcode::DlStrokeJoin::kMiter;
}
...
constexpr appcode::DlColorSpace ToDisplayListType(
    ImpellerColorSpace color_space) {
  switch (color_space) {
    case kImpellerColorSpaceSRGB:
      return appcode::DlColorSpace::kSRGB;
    case kImpellerColorSpaceExtendedSRGB:
      return appcode::DlColorSpace::kExtendedSRGB;
    case kImpellerColorSpaceDisplayP3:
      return appcode::DlColorSpace::kDisplayP3;
  }
  return appcode::DlColorSpace::kSRGB;
}

constexpr appcode::DlColor ToDisplayListType(ImpellerColor color) {
  return appcode::DlColor(color.alpha,                          //
                          color.red,                            //
                          color.green,                          //
                          color.blue,                           //
...
#endif  // APPCODE_IMPELLER_TOOLKIT_INTEROP_FORMATS_H_
