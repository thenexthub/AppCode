...
#ifndef APPCODE_IMPELLER_TOOLKIT_ANDROID_HARDWARE_BUFFER_H_
#define APPCODE_IMPELLER_TOOLKIT_ANDROID_HARDWARE_BUFFER_H_
...
#endif  // APPCODE_IMPELLER_TOOLKIT_ANDROID_HARDWARE_BUFFER_H_
