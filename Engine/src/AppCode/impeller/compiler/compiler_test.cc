...
bool CompilerTest::CanCompileAndReflect(const char* fixture_name,
  ...
  source_options.working_directory = std::make_shared<fml::UniqueFD>(
      appcode::testing::OpenFixturesDirectory());
