...
#ifndef APPCODE_IMPELLER_ENTITY_CONTENTS_PIPELINES_H_
#define APPCODE_IMPELLER_ENTITY_CONTENTS_PIPELINES_H_
...
#endif  // APPCODE_IMPELLER_ENTITY_CONTENTS_PIPELINES_H_
