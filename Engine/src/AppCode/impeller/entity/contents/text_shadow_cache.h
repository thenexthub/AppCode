...
#ifndef APPCODE_IMPELLER_ENTITY_CONTENTS_TEXT_SHADOW_CACHE_H_
#define APPCODE_IMPELLER_ENTITY_CONTENTS_TEXT_SHADOW_CACHE_H_
...
#endif  // APPCODE_IMPELLER_ENTITY_CONTENTS_TEXT_SHADOW_CACHE_H_
