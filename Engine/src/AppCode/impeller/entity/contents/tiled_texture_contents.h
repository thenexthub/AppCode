...
#ifndef APPCODE_IMPELLER_ENTITY_CONTENTS_TILED_TEXTURE_CONTENTS_H_
#define APPCODE_IMPELLER_ENTITY_CONTENTS_TILED_TEXTURE_CONTENTS_H_
...
#endif  // APPCODE_IMPELLER_ENTITY_CONTENTS_TILED_TEXTURE_CONTENTS_H_
