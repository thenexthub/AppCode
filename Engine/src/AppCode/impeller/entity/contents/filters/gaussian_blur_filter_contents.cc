...
DownsamplePassArgs CalculateDownsamplePassArgs(
  ...
  //   https://github.com/appcode/appcode/issues/140193 so it isn't applied.
  //
...
std::optional<Entity> GaussianBlurFilterContents::RenderFilter(
  ...
  // user bug reports (see https://github.com/appcode/appcode/issues/154046 ),
...
KernelSamples GenerateBlurInfo(BlurParameters parameters) {
  ...
  //
  // TODO(https://github.com/appcode/appcode/issues/150462): Come up with a more
