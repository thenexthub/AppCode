...
#ifndef APPCODE_IMPELLER_ENTITY_CONTENTS_CONTENT_CONTEXT_H_
#define APPCODE_IMPELLER_ENTITY_CONTENTS_CONTENT_CONTEXT_H_
...
class ContentContext {
 ...
 private:
  ...
  /// first frame benchmarks that are tracked in the appcode device lab.
...
#endif  // APPCODE_IMPELLER_ENTITY_CONTENTS_CONTENT_CONTEXT_H_
