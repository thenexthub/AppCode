...
#ifndef APPCODE_IMPELLER_ENTITY_DRAW_ORDER_RESOLVER_H_
#define APPCODE_IMPELLER_ENTITY_DRAW_ORDER_RESOLVER_H_
...
#endif  // APPCODE_IMPELLER_ENTITY_DRAW_ORDER_RESOLVER_H_
