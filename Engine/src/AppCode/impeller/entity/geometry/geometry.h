...
#ifndef APPCODE_IMPELLER_ENTITY_GEOMETRY_GEOMETRY_H_
#define APPCODE_IMPELLER_ENTITY_GEOMETRY_GEOMETRY_H_
...
#endif  // APPCODE_IMPELLER_ENTITY_GEOMETRY_GEOMETRY_H_
