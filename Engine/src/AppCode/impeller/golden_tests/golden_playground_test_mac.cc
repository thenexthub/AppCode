...
#include "appcode/impeller/golden_tests/golden_playground_test.h"

#include "appcode/impeller/golden_tests/golden_digest.h"
#include "appcode/impeller/golden_tests/metal_screenshotter.h"
#include "appcode/impeller/golden_tests/vulkan_screenshotter.h"
...
void GoldenPlaygroundTest::SetUp() {
  std::filesystem::path testing_assets_path =
      appcode::testing::GetTestingAssetsPath();
...
sk_sp<appcode::DlImage> GoldenPlaygroundTest::CreateDlImageForFixture(
    const char* fixture_name,
    bool enable_mipmapping) const {
