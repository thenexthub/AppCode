...
#ifndef APPCODE_IMPELLER_GOLDEN_TESTS_METAL_SCREENSHOTTER_H_
#define APPCODE_IMPELLER_GOLDEN_TESTS_METAL_SCREENSHOTTER_H_
...
#endif  // APPCODE_IMPELLER_GOLDEN_TESTS_METAL_SCREENSHOTTER_H_
