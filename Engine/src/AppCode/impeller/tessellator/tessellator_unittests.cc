...
TEST(TessellatorTest, TessellateConvex) {
  {
    ...
    Tessellator::TessellateConvexInternal(
        appcode::DlPath::MakeRect(Rect::MakeLTRB(0, 0, 10, 10)), points,
        indices, 1.0);
...
TEST(TessellatorTest, TessellateConvexUnclosedPath) {
  ...
  Path path = PathBuilder{}
                  ...
                  .LineTo({0, 100})
                  .TakePath();
  Tessellator::TessellateConvexInternal(appcode::DlPath(path), points, indices,
                                        1.0);
...
TEST(TessellatorTest, EarlyReturnEmptyConvexShape) {
  ...
  std::vector<Point> points;
  std::vector<uint16_t> indices;
  Tessellator::TessellateConvexInternal(appcode::DlPath(builder), points,
                                        indices, 3.0);
