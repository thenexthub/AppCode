...
#ifndef APPCODE_IMPELLER_RENDERER_COMPUTE_PIPELINE_BUILDER_H_
#define APPCODE_IMPELLER_RENDERER_COMPUTE_PIPELINE_BUILDER_H_
...
#endif  // APPCODE_IMPELLER_RENDERER_COMPUTE_PIPELINE_BUILDER_H_
