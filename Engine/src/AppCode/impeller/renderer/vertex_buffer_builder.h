...
#ifndef APPCODE_IMPELLER_RENDERER_VERTEX_BUFFER_BUILDER_H_
#define APPCODE_IMPELLER_RENDERER_VERTEX_BUFFER_BUILDER_H_
...
#endif  // APPCODE_IMPELLER_RENDERER_VERTEX_BUFFER_BUILDER_H_
