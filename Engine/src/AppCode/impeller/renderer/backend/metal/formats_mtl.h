...
#ifndef APPCODE_IMPELLER_RENDERER_BACKEND_METAL_FORMATS_MTL_H_
#define APPCODE_IMPELLER_RENDERER_BACKEND_METAL_FORMATS_MTL_H_
...
#endif  // APPCODE_IMPELLER_RENDERER_BACKEND_METAL_FORMATS_MTL_H_
