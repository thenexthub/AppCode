...
#ifndef APPCODE_IMPELLER_RENDERER_BACKEND_VULKAN_TEST_MOCK_VULKAN_H_
#define APPCODE_IMPELLER_RENDERER_BACKEND_VULKAN_TEST_MOCK_VULKAN_H_
...
#endif  // APPCODE_IMPELLER_RENDERER_BACKEND_VULKAN_TEST_MOCK_VULKAN_H_
