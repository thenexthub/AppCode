...
bool DriverInfoVK::IsKnownBadDriver() const {
  ...
  // https://github.com/appcode/appcode/issues/156623
  ...
  if (vendor_ == VendorVK::kSamsung) {
    ...
    // https://github.com/appcode/appcode/issues/161334
    return !api_version_.IsAtLeast(Version{1, 3, 0});
  }

  // https://github.com/appcode/appcode/issues/161122
  // https://github.com/appcode/appcode/issues/160960
  // https://github.com/appcode/appcode/issues/160866
  // https://github.com/appcode/appcode/issues/160804
  // https://github.com/appcode/appcode/issues/160406
