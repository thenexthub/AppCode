...
#ifndef APPCODE_IMPELLER_RENDERER_SHADER_STAGE_COMPATIBILITY_CHECKER_H_
#define APPCODE_IMPELLER_RENDERER_SHADER_STAGE_COMPATIBILITY_CHECKER_H_
...
#endif  // APPCODE_IMPELLER_RENDERER_SHADER_STAGE_COMPATIBILITY_CHECKER_H_
