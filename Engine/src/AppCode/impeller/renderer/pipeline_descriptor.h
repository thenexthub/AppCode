...
#ifndef APPCODE_IMPELLER_RENDERER_PIPELINE_DESCRIPTOR_H_
#define APPCODE_IMPELLER_RENDERER_PIPELINE_DESCRIPTOR_H_
...
#endif  // APPCODE_IMPELLER_RENDERER_PIPELINE_DESCRIPTOR_H_
