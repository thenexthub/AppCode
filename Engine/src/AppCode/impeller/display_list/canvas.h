...
#ifndef APPCODE_IMPELLER_DISPLAY_LIST_CANVAS_H_
#define APPCODE_IMPELLER_DISPLAY_LIST_CANVAS_H_
...
struct BackdropData {
  ...
  std::shared_ptr<appcode::DlImageFilter> last_backdrop;
};
...
class Canvas {
 public:
  ...
  void SaveLayer(
      ...
      const appcode::DlImageFilter* backdrop_filter = nullptr,
  ...
  void DrawPath(const appcode::DlPath& path, const Paint& paint);
...
#endif  // APPCODE_IMPELLER_DISPLAY_LIST_CANVAS_H_
