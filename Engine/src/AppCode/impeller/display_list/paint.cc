...
void Paint::ConvertStops(const appcode::DlGradientColorSourceBase* gradient,
...
std::shared_ptr<ColorSourceContents> Paint::CreateContents() const {
  ...
  switch (color_source->type()) {
    case appcode::DlColorSourceType::kLinearGradient: {
      const appcode::DlLinearGradientColorSource* linear =
    ...
    case appcode::DlColorSourceType::kRadialGradient: {
      const appcode::DlRadialGradientColorSource* radialGradient =
    ...
    case appcode::DlColorSourceType::kConicalGradient: {
      const appcode::DlConicalGradientColorSource* conical_gradient =
    ...
    case appcode::DlColorSourceType::kSweepGradient: {
      const appcode::DlSweepGradientColorSource* sweepGradient =
    ...
    case appcode::DlColorSourceType::kImage: {
      ...
      // See https://github.com/appcode/appcode/issues/165205
      appcode::DlMatrix effect_transform = image_color_source->matrix().To3x3();
    ...
    case appcode::DlColorSourceType::kRuntimeEffect: {
      const appcode::DlRuntimeEffectColorSource* runtime_effect_color_source =
...
std::shared_ptr<Contents> Paint::WithColorFilter(
  ...
  if (color_source &&
      color_source->type() == appcode::DlColorSourceType::kImage) {
    return input;
  }
...
std::shared_ptr<FilterContents> Paint::MaskBlurDescriptor::CreateMaskBlur(
    ...
    const appcode::DlColorFilter* color_filter,
    bool invert_colors,
    FillRectGeometry* rect_geom) const {
