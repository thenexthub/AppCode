...
#ifndef APPCODE_IMPELLER_DISPLAY_LIST_PAINT_H_
#define APPCODE_IMPELLER_DISPLAY_LIST_PAINT_H_
...
struct Paint {
  ...
  struct MaskBlurDescriptor {
    ...
    /// See: https://github.com/appcode/appcode/issues/115112
  ...
  const appcode::DlColorSource* color_source = nullptr;
  const appcode::DlColorFilter* color_filter = nullptr;
  const appcode::DlImageFilter* image_filter = nullptr;
  ...
  static void ConvertStops(const appcode::DlGradientColorSourceBase* gradient,
...
#endif  // APPCODE_IMPELLER_DISPLAY_LIST_PAINT_H_
