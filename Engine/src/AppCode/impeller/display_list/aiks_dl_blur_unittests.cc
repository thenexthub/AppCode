...
sk_sp<appcode::DisplayList> DoGradientOvalStrokeMaskBlur(Vector2 content_Scale,
                                                         Scalar sigma,
                                                         DlBlurStyle style) {
  DisplayListBuilder builder;
...
// https://github.com/appcode/appcode/issues/155930
...
TEST_P(AiksTest, GaussianBlurAnimatedBackdrop) {
  ...
  // See also: https://github.com/appcode/appcode/issues/140193
  auto boston =
