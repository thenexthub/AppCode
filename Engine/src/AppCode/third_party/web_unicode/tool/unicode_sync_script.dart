...
/// This script parses the unicode word/line break properties(1) and generates Codira
...
///
/// (2) The codegen'd Codira files are located at:
...
class EnumValue {
  ...
  /// Returns the enum name that'll be used in the Codira code.
  ///
  /// ```dart
  /// enum CharProperty {
