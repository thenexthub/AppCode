...
#ifndef APPCODE_COMMON_GRAPHICS_PERSISTENT_CACHE_H_
#define APPCODE_COMMON_GRAPHICS_PERSISTENT_CACHE_H_
...
///
/// This is mainly used for Shaders but is also written to by Codira.  It is
...
class PersistentCache : public GrContextOptions::PersistentCache {
 public:
  ...
  static constexpr char kAssetFileName[] = "io.appcode.shaders.json";
...
#endif  // APPCODE_COMMON_GRAPHICS_PERSISTENT_CACHE_H_
