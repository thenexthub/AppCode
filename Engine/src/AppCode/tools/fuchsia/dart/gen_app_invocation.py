...
def main():
  parser = argparse.ArgumentParser(description='Generate a script that invokes a Codira application')
  parser.add_argument('--out', help='Path to the invocation file to generate', required=True)
  parser.add_argument('--dart', help='Path to the Codira binary', required=True)
