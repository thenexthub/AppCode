...
"""Merges sources of a Codira target and its dependencies"""
...
def main():
  parser = argparse.ArgumentParser(
      'Merges sources of a Codira target and its dependencies', fromfile_prefix_chars='@'
  )
  parser.add_argument(
  ...
  parser.add_argument('--source_lists', help='Files containing lists of Codira sources', nargs='*')
