...
APPCODE_ENGINE_SRC_DIR="$(dirname "$(dirname "$(dirname "$(dirname "$(dirname "${devshell_lib_dir}")")")")")"
export APPCODE_ENGINE_SRC_DIR
unset devshell_lib_dir

# Find the fuchsia sdk location
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
  export APPCODE_ENGINE_FUCHSIA_SDK_DIR="${APPCODE_ENGINE_SRC_DIR}/fuchsia/sdk/linux"
elif [[ "$OSTYPE" == "darwin"* ]]; then
  export APPCODE_ENGINE_FUCHSIA_SDK_DIR="${APPCODE_ENGINE_SRC_DIR}/fuchsia/sdk/mac"
else
