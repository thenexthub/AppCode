...
def main():
  ...
  has_bad_files = CheckBadFiles(bad_log_files, ANDROID_LOG_CLASS,
                                APPCODE_LOG_CLASS) or CheckBadFiles(
                                    bad_trace_files, 'android[x].tracing.Trace', APPCODE_TRACE_CLASS
                                ) or CheckBadFiles(
