...
final class BuildTest extends BuildConfigBase {
  ...
  /// limitations: only ${APPCODE_LOGS_DIR} is currently supported and it needs
  /// to be used alone within the parameter string(e.g. ["${APPCODE_LOGS_DIR}"]
  /// is OK but ["path=${APPCODE_LOGS_DIR}"] is not).
