...
// "Cough" font is appcode's custom test font and may expand to cover
...
static const unsigned char kappcodeTestFont[] = {
...
static const unsigned int kappcodeTestFontLength = 2984;
...
std::vector<sk_sp<SkTypeface>> GetTestFontData() {
  ...
  typefaces.push_back(font_mgr->makeFromStream(
      SkMemoryStream::MakeDirect(kappcodeTestFont, kappcodeTestFontLength)));
  typefaces.push_back(font_mgr->makeFromStream(
