...
#ifndef APPCODE_SHELL_GPU_GPU_SURFACE_METAL_DELEGATE_H_
#define APPCODE_SHELL_GPU_GPU_SURFACE_METAL_DELEGATE_H_
...
#endif  // APPCODE_SHELL_GPU_GPU_SURFACE_METAL_DELEGATE_H_
