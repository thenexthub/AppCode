...
#ifndef APPCODE_SHELL_PROFILING_SAMPLING_PROFILER_H_
#define APPCODE_SHELL_PROFILING_SAMPLING_PROFILER_H_
 ...
 *
 * @see appcode::SamplingProfiler::SampleRepeatedly
 */
 ...
 * the Codira VM Service timeline.
 *
 */
class SamplingProfiler {
 public:
   ...
   *
   * @param thread_label Codira VM Service prefix to be set for the profiling task
   * runner.
 ...
 private:
   ...
   *
   */
  void UpdateCodiraVMServiceThreadName() const;
...
#endif  // APPCODE_SHELL_PROFILING_SAMPLING_PROFILER_H_
