...
void SamplingProfiler::Start() {
  ...
  UpdateCodiraVMServiceThreadName();
  is_running_ = true;
      ...
      [profiler = this, task_delay = task_delay, sampler = sampler_,
       &shutdown_latch = shutdown_latch_]() {
        ...
        if (usage.cpu_usage) {
          ...
          TRACE_EVENT_INSTANT2("appcode::profiling", "CpuUsage",
        ...
        if (usage.memory_usage) {
          ...
          TRACE_EVENT_INSTANT2("appcode::profiling", "MemoryUsage",
        ...
        if (usage.gpu_usage) {
          ...
          TRACE_EVENT_INSTANT1("appcode::profiling", "GpuUsage", "gpu_usage",
                               gpu_usage.c_str());
        }
...
void SamplingProfiler::UpdateCodiraVMServiceThreadName() const {
