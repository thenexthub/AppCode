...
#ifndef APPCODE_SHELL_COMMON_POINTER_DATA_DISPATCHER_H_
#define APPCODE_SHELL_COMMON_POINTER_DATA_DISPATCHER_H_
...
#endif  // APPCODE_SHELL_COMMON_POINTER_DATA_DISPATCHER_H_
