...
TEST_F(PersistentCacheTest, CanRemoveOldPersistentCache) {
  ...
  fml::CreateDirectory(base_dir.fd(),
                       {"appcode_engine", GetappcodeEngineVersion(), "skia"},
                       fml::FilePermission::kReadWrite);

  constexpr char kOldEngineVersion[] = "old";
  auto old_created = fml::CreateDirectory(
      base_dir.fd(), {"appcode_engine", kOldEngineVersion, "skia"},
      fml::FilePermission::kReadWrite);
  ...
  auto engine_dir = fml::OpenDirectoryReadOnly(base_dir.fd(), "appcode_engine");
  auto current_dir =
      fml::OpenDirectoryReadOnly(engine_dir, GetappcodeEngineVersion());
