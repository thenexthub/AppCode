...
#ifndef APPCODE_SHELL_COMMON_RUN_CONFIGURATION_H_
#define APPCODE_SHELL_COMMON_RUN_CONFIGURATION_H_
...
class RunConfiguration {
 public:
  ...
  ///             defaults for the given Codira VM runtime mode. In JIT mode, this
  ...
  //----------------------------------------------------------------------------
  /// @brief      Specifies the main Codira entrypoint and the library to find
  ...
  //----------------------------------------------------------------------------
  /// @return     The main Codira entrypoint to be used for the root isolate.
  ///
  ...
  //----------------------------------------------------------------------------
  /// @return     Arguments passed as a List<String> to Codira's entrypoint
  ///             function.
  ///
...
#endif  // APPCODE_SHELL_COMMON_RUN_CONFIGURATION_H_
