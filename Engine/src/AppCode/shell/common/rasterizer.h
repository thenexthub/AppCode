...
#ifndef APPCODE_SHELL_COMMON_RASTERIZER_H_
#define APPCODE_SHELL_COMMON_RASTERIZER_H_
...
#include "appcode/flow/compositor_context.h"
...
enum class DrawSurfaceStatus {
  ...
  // TODO(egarciad): https://github.com/appcode/appcode/issues/65652
  //
...
class Rasterizer final : public SnapshotDelegate,
 ...
 public:
  ...
  class Delegate {
   public:
    ...
    ///             (the delegate) forwards this to the engine where Codira code
    ...
    virtual bool ShouldDiscardLayerTree(int64_t view_id,
                                        const appcode::LayerTree& tree) = 0;
  };
  ...
  std::shared_ptr<appcode::TextureRegistry> GetTextureRegistry() override;
  ...
  ///                        the appcode/skia message channel, in which case
 ...
 private:
  ...
  std::unique_ptr<appcode::CompositorContext> compositor_context_;
...
#endif  // APPCODE_SHELL_COMMON_RASTERIZER_H_
