...
#include "appcode/shell/common/shell_test_platform_view_vulkan.h"
...
#include "appcode/vulkan/vulkan_utilities.h"
...
#else
#include "appcode/vulkan/swiftshader_path.h"
#endif
...
//              https://github.com/appcode/appcode/issues/51132
ShellTestPlatformViewVulkan::OffScreenSurface::OffScreenSurface(
  ...
  application_ = std::make_unique<vulkan::VulkanApplication>(
      *vk_, "appcodeTest", std::move(extensions), VK_MAKE_VERSION(1, 0, 0),
  ...
  memory_allocator_ = appcodeSkiaVulkanMemoryAllocator::Make(
