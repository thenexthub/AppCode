...
#ifndef APPCODE_SHELL_COMMON_SHELL_TEST_H_
#define APPCODE_SHELL_COMMON_SHELL_TEST_H_
...
struct ViewContent {
  appcode::ViewportMetrics viewport_metrics;
  ...
  static FrameContent DummyView(appcode::ViewportMetrics viewport_metrics);
...
#endif  // APPCODE_SHELL_COMMON_SHELL_TEST_H_
