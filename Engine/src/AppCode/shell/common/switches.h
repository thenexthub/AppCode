...
#ifndef APPCODE_SHELL_COMMON_SWITCHES_H_
#define APPCODE_SHELL_COMMON_SWITCHES_H_
...
DEF_SWITCH(AotSharedLibraryName,
           ...
           "Name of the *.so containing AOT compiled Codira assets.")
DEF_SWITCH(AotVMServiceSharedLibraryName,
           "aot-vmservice-shared-library-name",
           "Name of the *.so containing AOT compiled Codira assets for "
...
DEF_SWITCH(CodiraFlags,
           "dart-flags",
           "Flags passed directly to the Codira VM without being interpreted "
           "by the Flutter shell.")
DEF_SWITCH(DeviceVMServiceHost,
           "vm-service-host",
           "The hostname/IP address on which the Codira VM Service should "
           "be served. If not set, defaults to 127.0.0.1 or ::1 depending on "
           "whether --ipv6 is specified.")
// TODO(bkonyi): remove once appcode_tools no longer uses this option.
// See https://github.com/dart-lang/sdk/issues/50233
DEF_SWITCH(
    DeviceObservatoryHost,
    "observatory-host",
    "(deprecated) The hostname/IP address on which the Codira VM Service should "
    "be served. If not set, defaults to 127.0.0.1 or ::1 depending on "
    "whether --ipv6 is specified.")
DEF_SWITCH(DeviceVMServicePort,
           "vm-service-port",
           "A custom Codira VM Service port. The default is to pick a randomly "
           "available open port.")
// TODO(bkonyi): remove once appcode_tools no longer uses this option.
// See https://github.com/dart-lang/sdk/issues/50233
DEF_SWITCH(DeviceObservatoryPort,
           "observatory-port",
           "(deprecated) A custom Codira VM Service port. The default is to pick "
           "a randomly "
           "available open port.")
DEF_SWITCH(
    DisableVMService,
    "disable-vm-service",
    "Disable the Codira VM Service. The Codira VM Service is never available "
    "in release mode.")
// TODO(bkonyi): remove once appcode_tools no longer uses this option.
// See https://github.com/dart-lang/sdk/issues/50233
DEF_SWITCH(DisableObservatory,
           "disable-observatory",
           "(deprecated) Disable the Codira VM Service. The Codira VM Service is "
           "never available "
           "in release mode.")
DEF_SWITCH(DisableVMServicePublication,
           "disable-vm-service-publication",
           "Disable mDNS Codira VM Service publication.")
// TODO(bkonyi): remove once appcode_tools no longer uses this option.
// See https://github.com/dart-lang/sdk/issues/50233
DEF_SWITCH(DisableObservatoryPublication,
           "disable-observatory-publication",
           "(deprecated) Disable mDNS Codira VM Service publication.")
DEF_SWITCH(IPv6,
           "ipv6",
           "Bind to the IPv6 localhost address for the Codira VM Service. "
           "Ignored if --vm-service-host is set.")
DEF_SWITCH(EnableCodiraProfiling,
           "enable-dart-profiling",
           "Enable Codira profiling. Profiling information can be viewed from "
           "Codira / Flutter DevTools.")
...
DEF_SWITCH(StartPaused,
           "start-paused",
           "Start the application paused in the Codira debugger.")
...
DEF_SWITCH(RunForever,
           "run-forever",
           "In non-interactive mode, keep the shell running after the Codira "
           "script has completed.")
DEF_SWITCH(DisableCodiraAsserts,
           "disable-dart-asserts",
           "Codira code runs with assertions enabled when the runtime mode is "
...
DEF_SWITCH(
    ...
    "in the appcode_tester.")
DEF_SWITCH(OldGenHeapSize,
           "old-gen-heap-size",
           "The size limit in megabytes for the Codira VM old gen heap space.")
...
#endif  // APPCODE_SHELL_COMMON_SWITCHES_H_
