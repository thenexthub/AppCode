...
#ifndef APPCODE_SHELL_COMMON_PLATFORM_VIEW_H_
#define APPCODE_SHELL_COMMON_PLATFORM_VIEW_H_
 ...
 public:
  ...
  class Delegate {
   public:
    ...
    ///         Codira about the view, and on success, schedules a new frame.
    ///
    ...
    ///
    virtual void LoadCodiraDeferredLibrary(
  ...
  ///         Codira about the removal. Finally, it invokes |callback| with
  ...
  ///                      but composited by Flutter in its own hierarchy.
  ///
  void RegisterTexture(std::shared_ptr<appcode::Texture> texture);
  ...
  ///                              library to load.
  ///
  virtual void RequestCodiraDeferredLibrary(intptr_t loading_unit_id);
...
#endif  // APPCODE_SHELL_COMMON_PLATFORM_VIEW_H_
