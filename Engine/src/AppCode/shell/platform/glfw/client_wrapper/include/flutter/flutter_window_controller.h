...
#ifndef APPCODE_SHELL_PLATFORM_GLFW_CLIENT_WRAPPER_INCLUDE_APPCODE_APPCODE_WINDOW_CONTROLLER_H_
#define APPCODE_SHELL_PLATFORM_GLFW_CLIENT_WRAPPER_INCLUDE_APPCODE_APPCODE_WINDOW_CONTROLLER_H_
...
class FlutterWindowController : public PluginRegistry {
 public:
  ...
  //
  // The |assets_path| is the path to the appcode_assets folder for the Flutter
...
#endif  // APPCODE_SHELL_PLATFORM_GLFW_CLIENT_WRAPPER_INCLUDE_APPCODE_APPCODE_WINDOW_CONTROLLER_H_
