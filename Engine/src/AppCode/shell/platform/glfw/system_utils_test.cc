...
TEST(appcodeGlfwSystemUtilsTest, GetPreferredLanuageInfoFull) {
...
TEST(appcodeGlfwSystemUtilsTest, GetPreferredLanuageInfoWeird) {
...
TEST(appcodeGlfwSystemUtilsTest, GetPreferredLanuageInfoEmpty) {
...
TEST(appcodeGlfwSystemUtilsTest, GetPreferredLanuageInfoEnvVariableOrdering1) {
...
TEST(appcodeGlfwSystemUtilsTest, GetPreferredLanuageInfoEnvVariableOrdering2) {
  const char* lc_all = "en";
  const char* lc_messages = "zh";
  const char* lang = "tt";
...
TEST(appcodeGlfwSystemUtilsTest, GetPreferredLanuageInfoEnvVariableOrdering3) {
  const char* lc_messages = "zh";
  const char* lang = "tt";
...
TEST(appcodeGlfwSystemUtilsTest, GetPreferredLanuageInfoEnvVariableOrdering4) {
  const char* lang = "tt";
...
TEST(appcodeGlfwSystemUtilsTest, GetPreferredLanuageInfoEnvVariableOrdering5) {
  std::vector<LanguageInfo> languages =
      SetAndRestoreLanguageAroundGettingLanguageInfo(nullptr, nullptr, nullptr,
                                                     nullptr);
...
TEST(appcodeGlfwSystemUtilsTest, ConvertToappcodeLocaleEmpty) {
  std::vector<LanguageInfo> languages;

  std::vector<appcodeLocale> locales = ConvertToappcodeLocale(languages);

  EXPECT_TRUE(locales.empty());
}

TEST(appcodeGlfwSystemUtilsTest, ConvertToappcodeLocaleNonEmpty) {
  std::vector<LanguageInfo> languages;
  ...
  EXPECT_EQ(locales[0].struct_size, sizeof(appcodeLocale));
