...
#ifndef APPCODE_SHELL_PLATFORM_LINUX_TESTING_FL_TEST_GTK_LOGS_H_
#define APPCODE_SHELL_PLATFORM_LINUX_TESTING_FL_TEST_GTK_LOGS_H_
...
#endif  // APPCODE_SHELL_PLATFORM_LINUX_TESTING_FL_TEST_GTK_LOGS_H_
