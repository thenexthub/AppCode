...
#ifndef APPCODE_SHELL_PLATFORM_LINUX_TESTING_MOCK_SIGNAL_HANDLER_H_
#define APPCODE_SHELL_PLATFORM_LINUX_TESTING_MOCK_SIGNAL_HANDLER_H_
...
#endif  // APPCODE_SHELL_PLATFORM_LINUX_TESTING_MOCK_SIGNAL_HANDLER_H_
