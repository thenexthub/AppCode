...
static void set_client(FlMockBinaryMessenger* messenger, InputConfig config) {
  ...
  fl_mock_binary_messenger_invoke_json_method(
      messenger, "appcode/textinput", "TextInput.setClient", args,
...
static void set_editing_state(FlMockBinaryMessenger* messenger,
  ...
  fl_mock_binary_messenger_invoke_json_method(
      messenger, "appcode/textinput", "TextInput.setEditingState", args,
      [](FlMockBinaryMessenger* messenger, FlMethodResponse* response,
         gpointer user_data) {
        gboolean* called = static_cast<gboolean*>(user_data);
        *called = TRUE;
...
TEST(FlTextInputHandlerTest, MessageHandler) {
  ...
  EXPECT_TRUE(
      fl_mock_binary_messenger_has_handler(messenger, "appcode/textinput"));
...
TEST(FlTextInputHandlerTest, Show) {
  ...
  gboolean called = FALSE;
  fl_mock_binary_messenger_invoke_json_method(
      messenger, "appcode/textinput", "TextInput.show", nullptr,
      [](FlMockBinaryMessenger* messenger, FlMethodResponse* response,
         gpointer user_data) {
        gboolean* called = static_cast<gboolean*>(user_data);
        *called = TRUE;
...
TEST(FlTextInputHandlerTest, Hide) {
  ...
  gboolean called = FALSE;
  fl_mock_binary_messenger_invoke_json_method(
      messenger, "appcode/textinput", "TextInput.hide", nullptr,
      [](FlMockBinaryMessenger* messenger, FlMethodResponse* response,
         gpointer user_data) {
        gboolean* called = static_cast<gboolean*>(user_data);
        *called = TRUE;
...
TEST(FlTextInputHandlerTest, ClearClient) {
  ...
  gboolean called = FALSE;
  fl_mock_binary_messenger_invoke_json_method(
      messenger, "appcode/textinput", "TextInput.clearClient", nullptr,
      [](FlMockBinaryMessenger* messenger, FlMethodResponse* response,
         gpointer user_data) {
        gboolean* called = static_cast<gboolean*>(user_data);
        *called = TRUE;
...
// Regression test for https://github.com/appcode/appcode/issues/125879.
...
TEST(FlTextInputHandlerTest, Composing) {
  ...
  EXPECT_CALL(mock_gtk, gtk_im_context_get_preedit_string(
                            ...
                            ::testing::A<gint*>()))
      .WillOnce(
          ::testing::DoAll(::testing::SetArgPointee<1>(g_strdup("appcode")),
...
TEST(FlTextInputHandlerTest, SurroundingText) {
  ...
  EXPECT_CALL(mock_gtk, gtk_im_context_set_surrounding(
                            ::testing::_, ::testing::StrEq("appcode"), -1, 3));
...
TEST(FlTextInputHandlerTest, SetMarkedTextRect) {
  ...
  gboolean called = FALSE;
  fl_mock_binary_messenger_invoke_json_method(
      messenger, "appcode/textinput", "TextInput.setEditableSizeAndTransform",
      size_and_transform,
      [](FlMockBinaryMessenger* messenger, FlMethodResponse* response,
         gpointer user_data) {
        gboolean* called = static_cast<gboolean*>(user_data);
  ...
  called = FALSE;
  fl_mock_binary_messenger_invoke_json_method(
      messenger, "appcode/textinput", "TextInput.setMarkedTextRect", rect,
      [](FlMockBinaryMessenger* messenger, FlMethodResponse* response,
         gpointer user_data) {
        gboolean* called = static_cast<gboolean*>(user_data);
        *called = TRUE;
