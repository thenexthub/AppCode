...
TEST(FlViewAccessibleTest, BuildTree) {
  ...
  appcodeSemanticsNode2 child1_node = {.id = 111, .label = "child 1"};
  appcodeSemanticsNode2 child2_node = {.id = 222, .label = "child 2"};
  appcodeSemanticsNode2* nodes[3] = {&root_node, &child1_node, &child2_node};
  appcodeSemanticsUpdate2 update = {.node_count = 3, .nodes = nodes};
...
TEST(FlViewAccessibleTest, AddRemoveChildren) {
  ...
  appcodeSemanticsUpdate2 update = {.node_count = 1, .nodes = nodes};
  fl_view_accessible_handle_update_semantics(accessible, &update);
  ...
  appcodeSemanticsNode2 child1_node = {.id = 111, .label = "child 1"};
  {
    appcode::testing::MockSignalHandler2<gint, AtkObject*> child1_added(
    ...
    appcodeSemanticsNode2* nodes[2] = {&root_node, &child1_node};
    appcodeSemanticsUpdate2 update = {.node_count = 2, .nodes = nodes};
    fl_view_accessible_handle_update_semantics(accessible, &update);
  }
  ...
  appcodeSemanticsNode2 child2_node = {.id = 222, .label = "child 2"};
  {
    appcode::testing::MockSignalHandler2<gint, AtkObject*> child2_added(
        root_object, "children-changed::add");
  ...
  // remove child1
  {
    appcode::testing::MockSignalHandler2<gint, AtkObject*> child1_removed(
    ...
    root_node.child_count = 1;
    root_node.children_in_traversal_order = children;
    appcodeSemanticsNode2* nodes[3] = {&root_node, &child2_node};
    appcodeSemanticsUpdate2 update = {.node_count = 2, .nodes = nodes};
    fl_view_accessible_handle_update_semantics(accessible, &update);
  }
  ...
  // remove child2
  {
    appcode::testing::MockSignalHandler2<gint, AtkObject*> child2_removed(
        root_object, "children-changed::remove");
