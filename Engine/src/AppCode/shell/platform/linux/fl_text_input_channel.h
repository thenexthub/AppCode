...
#ifndef APPCODE_SHELL_PLATFORM_LINUX_FL_TEXT_INPUT_CHANNEL_H_
#define APPCODE_SHELL_PLATFORM_LINUX_FL_TEXT_INPUT_CHANNEL_H_
...
#endif  // APPCODE_SHELL_PLATFORM_LINUX_FL_TEXT_INPUT_CHANNEL_H_
