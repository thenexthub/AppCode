...
#ifndef APPCODE_SHELL_PLATFORM_LINUX_PUBLIC_APPCODE_LINUX_FL_BASIC_MESSAGE_CHANNEL_H_
#define APPCODE_SHELL_PLATFORM_LINUX_PUBLIC_APPCODE_LINUX_FL_BASIC_MESSAGE_CHANNEL_H_
 ...
 * messages to/from Codira code over platform channels.
 *
 ...
 *   channel = fl_basic_message_channel_new (messenger, "appcode/foo",
 ...
 *
 * Creates a basic message channel. @codec must match the codec used on the Codira
 * end of the channel.
 *
 ...
 * @user_data, or %NULL.
 *
 * Sets the function called when a message is received from the Codira side of the
...
#endif  // APPCODE_SHELL_PLATFORM_LINUX_PUBLIC_APPCODE_LINUX_FL_BASIC_MESSAGE_CHANNEL_H_
