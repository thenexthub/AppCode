...
#ifndef APPCODE_SHELL_PLATFORM_LINUX_PUBLIC_APPCODE_LINUX_FL_METHOD_CHANNEL_H_
#define APPCODE_SHELL_PLATFORM_LINUX_PUBLIC_APPCODE_LINUX_FL_METHOD_CHANNEL_H_
 ...
 * FlMethodChannel:
 *
 * #FlMethodChannel is an object that allows method calls to and from Codira code.
 *
 ...
 *   channel =
 *     fl_method_channel_new(messenger, "appcode/foo", FL_METHOD_CODEC (codec));
 ...
 *
 * Creates a new method channel. @codec must match the codec used on the Codira
 * end of the channel.
 *
 ...
 * @user_data, or %NULL.
 *
 * Sets the function called when a method call is received from the Codira side of
...
#endif  // APPCODE_SHELL_PLATFORM_LINUX_PUBLIC_APPCODE_LINUX_FL_METHOD_CHANNEL_H_
