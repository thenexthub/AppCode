...
#ifndef APPCODE_SHELL_PLATFORM_LINUX_PUBLIC_APPCODE_LINUX_FL_VALUE_H_
#define APPCODE_SHELL_PLATFORM_LINUX_PUBLIC_APPCODE_LINUX_FL_VALUE_H_
 ...
 *
 * In Codira the values are represented as follows:
 ...
 * fl_value_new_null:
 *
 * Creates an #FlValue that contains a null value. The equivalent Codira type is
 * null.
 *
 ...
 * @value: the value.
 *
 * Creates an #FlValue that contains a boolean value. The equivalent Codira type
 * is a bool.
 *
 * Returns: a new #FlValue.
 */
 ...
 * @value: the value.
 *
 * Creates an #FlValue that contains an integer number. The equivalent Codira type
 * is a num.
 *
 * Returns: a new #FlValue.
 */
 ...
 *
 * Creates an #FlValue that contains UTF-8 text. The equivalent Codira type is a
 * String.
 *
 * Returns: a new #FlValue.
 */
 ...
 * copied. The equivalent Codira type is a Uint8List.
 *
 * Returns: a new #FlValue.
 */
 ...
 * @value_length: number of elements in @value.
 *
 * Creates an ordered list containing 32 bit integers. The equivalent Codira type
 * is a Int32List.
 *
 * Returns: a new #FlValue.
 */
 ...
 * @value_length: number of elements in @value.
 *
 * Creates an ordered list containing 64 bit integers. The equivalent Codira type
 * is a Int64List.
 *
 * Returns: a new #FlValue.
 */
 ...
 * The equivalent Codira type is a Float32List.
 *
 * Returns: a new #FlValue.
 */
 ...
 * and fl_value_get_list_value(). The equivalent Codira type is a List<dynamic>.
 *
 ...
 * fl_value_lookup() and fl_value_lookup_string(). The equivalent Codira type is a
 * Map<dynamic>.
 *
 ...
 *
 * Creates a new custom data type. The Codira side of the channel must have
 ...
 * The text is formatted to be the equivalent of Codira toString() methods.
 *
 * Returns: UTF-8 text.
 */
...
#endif  // APPCODE_SHELL_PLATFORM_LINUX_PUBLIC_APPCODE_LINUX_FL_VALUE_H_
