...
#ifndef APPCODE_SHELL_PLATFORM_LINUX_FL_KEY_EMBEDDER_RESPONDER_H_
#define APPCODE_SHELL_PLATFORM_LINUX_FL_KEY_EMBEDDER_RESPONDER_H_
...
#endif  // APPCODE_SHELL_PLATFORM_LINUX_FL_KEY_EMBEDDER_RESPONDER_H_
