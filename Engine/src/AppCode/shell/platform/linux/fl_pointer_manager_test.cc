...
#include "appcode/shell/platform/linux/fl_pointer_manager.h"
...
TEST(FlPointerManagerTest, EnterLeave) {
  ...
  fl_pointer_manager_handle_enter(manager, 1234, kappcodePointerDeviceKindMouse,
                                  1.0, 2.0);
  fl_pointer_manager_handle_leave(manager, 1235, kappcodePointerDeviceKindMouse,
                                  3.0, 4.0);
  ...
  EXPECT_EQ(pointer_events[0].device_kind, kappcodePointerDeviceKindMouse);
  ...
  EXPECT_EQ(pointer_events[1].device_kind, kappcodePointerDeviceKindMouse);
...
TEST(FlPointerManagerTest, EnterEnter) {
  ...
  fl_pointer_manager_handle_enter(manager, 1235, kappcodePointerDeviceKindMouse,
                                  3.0, 4.0);
...
TEST(FlPointerManagerTest, EnterButtonPress) {
  ...
  fl_pointer_manager_handle_button_press(manager, 1235,
                                         kappcodePointerDeviceKindMouse, 4.0,
  ...
  EXPECT_EQ(pointer_events[1].device_kind, kappcodePointerDeviceKindMouse);
  EXPECT_EQ(pointer_events[1].buttons, kappcodePointerButtonMousePrimary);
  EXPECT_EQ(pointer_events[1].view_id, 42);
}
...
TEST(FlPointerManagerTest, ButtonPressButtonReleasePrimary) {
  ...
  fl_pointer_manager_handle_button_release(manager, 1235,
                                           kappcodePointerDeviceKindMouse, 5.0,
  ...
  EXPECT_EQ(pointer_events[2].device_kind, kappcodePointerDeviceKindMouse);
...
TEST(FlPointerManagerTest, ButtonPressButtonReleaseSecondary) {
  ...
  EXPECT_EQ(pointer_events[1].y, 8.0);
  EXPECT_EQ(pointer_events[1].device_kind, kappcodePointerDeviceKindMouse);
  EXPECT_EQ(pointer_events[1].buttons, kappcodePointerButtonMouseSecondary);
  EXPECT_EQ(pointer_events[1].view_id, 42);
  EXPECT_EQ(pointer_events[2].timestamp, 1235000u);
  EXPECT_EQ(pointer_events[2].x, 5.0);
  EXPECT_EQ(pointer_events[2].y, 9.0);
...
TEST(FlPointerManagerTest, ButtonPressButtonReleaseMiddle) {
  ...
  EXPECT_EQ(pointer_events[1].y, 8.0);
  EXPECT_EQ(pointer_events[1].device_kind, kappcodePointerDeviceKindMouse);
  EXPECT_EQ(pointer_events[1].buttons, kappcodePointerButtonMouseMiddle);
  EXPECT_EQ(pointer_events[1].view_id, 42);
  EXPECT_EQ(pointer_events[2].timestamp, 1235000u);
  EXPECT_EQ(pointer_events[2].x, 5.0);
  EXPECT_EQ(pointer_events[2].y, 9.0);
...
TEST(FlPointerManagerTest, ButtonPressButtonReleaseBack) {
  ...
  fl_pointer_manager_handle_button_press(
      manager, 1234, kappcodePointerDeviceKindMouse, 4.0, 8.0, 8);
  fl_pointer_manager_handle_button_release(
      manager, 1235, kappcodePointerDeviceKindMouse, 5.0, 9.0, 8);
  ...
  EXPECT_EQ(pointer_events[1].y, 8.0);
  EXPECT_EQ(pointer_events[1].device_kind, kappcodePointerDeviceKindMouse);
  EXPECT_EQ(pointer_events[1].buttons, kappcodePointerButtonMouseBack);
  EXPECT_EQ(pointer_events[1].view_id, 42);
  EXPECT_EQ(pointer_events[2].timestamp, 1235000u);
  EXPECT_EQ(pointer_events[2].x, 5.0);
  EXPECT_EQ(pointer_events[2].y, 9.0);
...
TEST(FlPointerManagerTest, ButtonPressButtonReleaseForward) {
  ...
  g_autoptr(FlPointerManager) manager = fl_pointer_manager_new(42, engine);
  fl_pointer_manager_handle_button_press(
      manager, 1234, kappcodePointerDeviceKindMouse, 4.0, 8.0, 9);
  fl_pointer_manager_handle_button_release(
      manager, 1235, kappcodePointerDeviceKindMouse, 5.0, 9.0, 9);
  ...
  EXPECT_EQ(pointer_events[1].y, 8.0);
  EXPECT_EQ(pointer_events[1].device_kind, kappcodePointerDeviceKindMouse);
  EXPECT_EQ(pointer_events[1].buttons, kappcodePointerButtonMouseForward);
  EXPECT_EQ(pointer_events[1].view_id, 42);
  EXPECT_EQ(pointer_events[2].timestamp, 1235000u);
  EXPECT_EQ(pointer_events[2].x, 5.0);
  EXPECT_EQ(pointer_events[2].y, 9.0);
...
TEST(FlPointerManagerTest, ButtonPressButtonReleaseThreeButtons) {
  ...
  fl_pointer_manager_handle_button_press(manager, 1234,
                                         kappcodePointerDeviceKindMouse, 1.0,
                                         2.0, GDK_BUTTON_PRIMARY);
  fl_pointer_manager_handle_button_press(manager, 1235,
                                         kappcodePointerDeviceKindMouse, 3.0,
  ...
  fl_pointer_manager_handle_button_release(manager, 1237,
                                           kappcodePointerDeviceKindMouse, 7.0,
                                           8.0, GDK_BUTTON_MIDDLE);
  fl_pointer_manager_handle_button_release(manager, 1238,
                                           kappcodePointerDeviceKindMouse, 9.0,
                                           10.0, GDK_BUTTON_SECONDARY);
  fl_pointer_manager_handle_button_release(
      manager, 1239, kappcodePointerDeviceKindMouse, 11.0, 12.0,
  ...
  EXPECT_EQ(pointer_events[2].buttons, kappcodePointerButtonMousePrimary |
                                           kappcodePointerButtonMouseSecondary);
  EXPECT_EQ(pointer_events[3].timestamp, 1236000u);
  EXPECT_EQ(pointer_events[3].x, 5.0);
  EXPECT_EQ(pointer_events[3].y, 6.0);
  EXPECT_EQ(pointer_events[3].buttons, kappcodePointerButtonMousePrimary |
                                           kappcodePointerButtonMouseSecondary |
                                           kappcodePointerButtonMouseMiddle);
  EXPECT_EQ(pointer_events[4].timestamp, 1237000u);
  EXPECT_EQ(pointer_events[4].x, 7.0);
  EXPECT_EQ(pointer_events[4].y, 8.0);
  EXPECT_EQ(pointer_events[4].buttons, kappcodePointerButtonMousePrimary |
                                           kappcodePointerButtonMouseSecondary);
  EXPECT_EQ(pointer_events[5].timestamp, 1238000u);
  EXPECT_EQ(pointer_events[5].x, 9.0);
  EXPECT_EQ(pointer_events[5].y, 10.0);
  EXPECT_EQ(pointer_events[5].buttons, kappcodePointerButtonMousePrimary);
...
TEST(FlPointerManagerTest, ButtonPressButtonPressButtonRelease) {
  ...
  fl_pointer_manager_handle_button_press(manager, 1234,
                                         kappcodePointerDeviceKindMouse, 6.0,
...
TEST(FlPointerManagerTest, Motion) {
  ...
  fl_pointer_manager_handle_motion(manager, 1234,
                                   kappcodePointerDeviceKindMouse, 1.0, 2.0);
  fl_pointer_manager_handle_motion(manager, 1235,
                                   kappcodePointerDeviceKindMouse, 3.0, 4.0);
  fl_pointer_manager_handle_motion(manager, 1236,
                                   kappcodePointerDeviceKindMouse, 5.0, 6.0);
  ...
  EXPECT_EQ(pointer_events[3].x, 5.0);
  EXPECT_EQ(pointer_events[3].y, 6.0);
  EXPECT_EQ(pointer_events[3].device_kind, kappcodePointerDeviceKindMouse);
...
TEST(FlPointerManagerTest, Drag) {
  ...
  fl_pointer_manager_handle_motion(manager, 1238,
                                   kappcodePointerDeviceKindMouse, 9.0, 10.0);
...
TEST(FlPointerManagerTest, DeviceKind) {
  ...
  fl_pointer_manager_handle_enter(manager, 1234,
                                  kappcodePointerDeviceKindTrackpad, 1.0, 2.0);
  fl_pointer_manager_handle_button_press(manager, 1235,
                                         kappcodePointerDeviceKindTrackpad, 1.0,
                                         2.0, GDK_BUTTON_PRIMARY);
  fl_pointer_manager_handle_motion(manager, 1238,
                                   kappcodePointerDeviceKindTrackpad, 3.0, 4.0);
  fl_pointer_manager_handle_button_release(manager, 1237,
                                           kappcodePointerDeviceKindTrackpad,
  ...
  EXPECT_EQ(pointer_events[0].device_kind, kappcodePointerDeviceKindTrackpad);
  EXPECT_EQ(pointer_events[1].device_kind, kappcodePointerDeviceKindTrackpad);
  EXPECT_EQ(pointer_events[2].device_kind, kappcodePointerDeviceKindTrackpad);
  EXPECT_EQ(pointer_events[3].device_kind, kappcodePointerDeviceKindTrackpad);
  EXPECT_EQ(pointer_events[4].device_kind, kappcodePointerDeviceKindTrackpad);
}
