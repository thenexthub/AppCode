...
#ifndef APPCODE_SHELL_PLATFORM_LINUX_FL_ACCESSIBLE_NODE_H_
#define APPCODE_SHELL_PLATFORM_LINUX_FL_ACCESSIBLE_NODE_H_
...
#endif  // APPCODE_SHELL_PLATFORM_LINUX_FL_ACCESSIBLE_NODE_H_
