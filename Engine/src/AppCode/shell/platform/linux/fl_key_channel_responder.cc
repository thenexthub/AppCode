...
#include "appcode/shell/platform/linux/fl_key_channel_responder.h"
...
void fl_key_channel_responder_handle_event(FlKeyChannelResponder* self,
  ...
  // modifier keys. appcode uses this information to keep modifier keys from
  ...
  //
  // Since appcode expects the "pressed" state of the modifier keys, the lock
  ...
  //
  // This is necessary to do here instead of in the framework because appcode
