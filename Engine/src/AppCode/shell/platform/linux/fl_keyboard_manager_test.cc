...
typedef struct {
  appcodeKeyEventType event_type;
...
static CallRecord* call_record_new(const appcodeKeyEvent* event,
                                   appcodeKeyEventCallback callback,
                                   void* callback_user_data) {
...
namespace {
using ::appcode::testing::keycodes::kLogicalAltLeft;
using ::appcode::testing::keycodes::kLogicalBracketLeft;
using ::appcode::testing::keycodes::kLogicalComma;
using ::appcode::testing::keycodes::kLogicalControlLeft;
using ::appcode::testing::keycodes::kLogicalDigit1;
using ::appcode::testing::keycodes::kLogicalKeyA;
using ::appcode::testing::keycodes::kLogicalKeyB;
using ::appcode::testing::keycodes::kLogicalKeyM;
using ::appcode::testing::keycodes::kLogicalKeyQ;
using ::appcode::testing::keycodes::kLogicalMetaLeft;
using ::appcode::testing::keycodes::kLogicalMinus;
using ::appcode::testing::keycodes::kLogicalParenthesisRight;
using ::appcode::testing::keycodes::kLogicalSemicolon;
using ::appcode::testing::keycodes::kLogicalShiftLeft;
using ::appcode::testing::keycodes::kLogicalUnderscore;

using ::appcode::testing::keycodes::kPhysicalAltLeft;
using ::appcode::testing::keycodes::kPhysicalControlLeft;
using ::appcode::testing::keycodes::kPhysicalKeyA;
using ::appcode::testing::keycodes::kPhysicalKeyB;
using ::appcode::testing::keycodes::kPhysicalMetaLeft;
using ::appcode::testing::keycodes::kPhysicalShiftLeft;
...
TEST(FlKeyboardManagerTest, EngineHandledChannelNotHandledAsync) {
  ...
  fl_engine_get_embedder_api(engine)->SendKeyEvent = MOCK_ENGINE_PROC(
      SendKeyEvent, ([&embedder_call_records](
                         auto engine, const appcodeKeyEvent* event,
                         appcodeKeyEventCallback callback, void* user_data) {
...
TEST(FlKeyboardManagerTest, CorrectLogicalKeyForLayouts) {
  ...
  fl_engine_get_embedder_api(engine)->SendKeyEvent = MOCK_ENGINE_PROC(
      SendKeyEvent,
      ([&call_records](auto engine, const appcodeKeyEvent* event,
                       appcodeKeyEventCallback callback, void* user_data) {
...
TEST(FlKeyboardManagerTest, SynthesizeModifiersIfNeeded) {
  ...
  auto verifyModifierIsSynthesized = [&](GdkModifierType mask,
    ...
    EXPECT_EQ(record->event_type, kappcodeKeyEventTypeDown);
    ...
    EXPECT_EQ(record->event_type, kappcodeKeyEventTypeUp);
    EXPECT_EQ(record->event_physical, physical);
    EXPECT_EQ(record->event_logical, logical);
    EXPECT_STREQ(record->event_character, NULL);
    EXPECT_EQ(record->event_synthesized, true);
