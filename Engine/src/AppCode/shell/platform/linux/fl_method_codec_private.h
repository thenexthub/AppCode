...
#ifndef APPCODE_SHELL_PLATFORM_LINUX_FL_METHOD_CODEC_PRIVATE_H_
#define APPCODE_SHELL_PLATFORM_LINUX_FL_METHOD_CODEC_PRIVATE_H_
...
#endif  // APPCODE_SHELL_PLATFORM_LINUX_FL_METHOD_CODEC_PRIVATE_H_
