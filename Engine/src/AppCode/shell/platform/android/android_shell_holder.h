...
#ifndef APPCODE_SHELL_PLATFORM_ANDROID_ANDROID_SHELL_HOLDER_H_
#define APPCODE_SHELL_PLATFORM_ANDROID_ANDROID_SHELL_HOLDER_H_
...
class AndroidShellHolder {
 public:
  AndroidShellHolder(const appcode::Settings& settings,
  ...
  ///             instance.
  ///
  ///             The new Shell's appcode::Settings cannot be changed from that
...
#endif  // APPCODE_SHELL_PLATFORM_ANDROID_ANDROID_SHELL_HOLDER_H_
