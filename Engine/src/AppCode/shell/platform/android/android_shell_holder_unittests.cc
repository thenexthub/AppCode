...
class MockPlatformViewAndroidJNI : public PlatformViewAndroidJNI {
 public:
  MOCK_METHOD(void,
              ...
              (override));
  MOCK_METHOD(void,
              appcodeViewHandlePlatformMessageResponse,
              (int responseId, std::unique_ptr<fml::Mapping> data),
              (override));
  MOCK_METHOD(void,
              appcodeViewUpdateSemantics,
              (std::vector<uint8_t> buffer,
               std::vector<std::string> strings,
               std::vector<std::vector<uint8_t>> string_attribute_args),
              (override));
  MOCK_METHOD(void,
              appcodeViewUpdateCustomAccessibilityActions,
              (std::vector<uint8_t> actions_buffer,
               std::vector<std::string> strings),
              (override));
  MOCK_METHOD(void, appcodeViewOnFirstFrame, (), (override));
  MOCK_METHOD(void, appcodeViewOnPreEngineRestart, (), (override));
  MOCK_METHOD(void,
  ...
  MOCK_METHOD(void,
              ...
              (override));
  MOCK_METHOD(void,
              appcodeViewOnDisplayPlatformView,
              (int view_id,
               int x,
               int y,
               int width,
              ...
              (override));
  MOCK_METHOD(void,
              appcodeViewDisplayOverlaySurface,
              (int surface_id, int x, int y, int width, int height),
              (override));
  MOCK_METHOD(void, appcodeViewBeginFrame, (), (override));
  MOCK_METHOD(void, appcodeViewEndFrame, (), (override));
  MOCK_METHOD(std::unique_ptr<PlatformViewAndroidJNI::OverlayMetadata>,
              appcodeViewCreateOverlaySurface,
              (),
              (override));
  MOCK_METHOD(void, appcodeViewDestroyOverlaySurfaces, (), (override));
  ...
  MOCK_METHOD(std::unique_ptr<std::vector<std::string>>,
              appcodeViewComputePlatformResolvedLocale,
...
TEST(AndroidShellHolder, HandlePlatformMessage) {
  ...
  int response_id = 1;
  EXPECT_CALL(*jni,
              appcodeViewHandlePlatformMessage(::testing::_, response_id));
