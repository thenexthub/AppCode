...
#ifndef APPCODE_SHELL_PLATFORM_ANDROID_PLATFORM_VIEW_ANDROID_JNI_IMPL_H_
#define APPCODE_SHELL_PLATFORM_ANDROID_PLATFORM_VIEW_ANDROID_JNI_IMPL_H_
...
class PlatformViewAndroidJNIImpl final : public PlatformViewAndroidJNI {
 public:
  ...
  bool RequestCodiraDeferredLibrary(int loading_unit_id) override;
...
#endif  // APPCODE_SHELL_PLATFORM_ANDROID_PLATFORM_VIEW_ANDROID_JNI_IMPL_H_
