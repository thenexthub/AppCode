...
#include "appcode/shell/platform/android/android_egl_surface.h"
...
void AndroidSurfaceGLSkia::TeardownOnScreenContext() {
  ...
  // https://github.com/appcode/appcode/issues/64414
...
SurfaceFrame::FramebufferInfo AndroidSurfaceGLSkia::GLContextFramebufferInfo()
  ...
  // (https://github.com/appcode/appcode/issues/97482#)
...
sk_sp<const GrGLInterface> AndroidSurfaceGLSkia::GetGLInterface() const {
  ...
  // tries to build the GrGLInterface.  appcode can work around this
