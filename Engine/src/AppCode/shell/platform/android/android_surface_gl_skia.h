...
#ifndef APPCODE_SHELL_PLATFORM_ANDROID_ANDROID_SURFACE_GL_SKIA_H_
#define APPCODE_SHELL_PLATFORM_ANDROID_ANDROID_SURFACE_GL_SKIA_H_
...
#endif  // APPCODE_SHELL_PLATFORM_ANDROID_ANDROID_SURFACE_GL_SKIA_H_
