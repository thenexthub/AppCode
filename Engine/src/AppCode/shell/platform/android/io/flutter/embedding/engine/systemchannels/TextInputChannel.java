...
public class TextInputChannel {
  ...
  /**
   * Constructs a {@code TextInputChannel} that connects Android to the Codira code running in {@code
   * dartExecutor}.
   *
   ...
   */
  public TextInputChannel(@NonNull CodiraExecutor dartExecutor) {
