 ...
 * iOS, via Codira code. It includes platform code, as well as Codira code. A plugin author is
 * responsible for setting up an appropriate {@link io.flutter.plugin.common.MethodChannel} to
 * communicate between platform code and Codira code.
 *
...
public interface FlutterPlugin {
   ...
   *
   * <p>The provided {@link BinaryMessenger} can be used to communicate with Codira code running in
  ...
  class FlutterPluginBinding {
     ...
     * available will result in suboptimal performance and odd behaviors related to Codira isolate
     * groups.
     */
    @Nullable
