 ...
 * flutterEngine
 *   .getCodiraExecutor()
 *   .executeCodiraEntrypoint(CodiraEntrypoint.createDefault());
 *
...
public class FlutterFragment extends Fragment
  ...
  /** The Codira entrypoint method name that is executed upon initialization. */
  protected static final String ARG_DART_ENTRYPOINT = "dart_entrypoint";
  /** The Codira entrypoint method's URI that is executed upon initialization. */
  protected static final String ARG_DART_ENTRYPOINT_URI = "dart_entrypoint_uri";
  /** The Codira entrypoint arguments that is executed upon initialization. */
  ...
  protected static final String ARG_APPCODE_INITIALIZATION_ARGS = "initialization_args";
  /**
   * {@link RenderMode} to be used for the {@link io.flutter.embedding.android.FlutterView} in this
   * {@code FlutterFragment}
   */
  protected static final String ARG_APPCODEVIEW_RENDER_MODE = "flutterview_render_mode";
  /**
   * {@link TransparencyMode} to be used for the {@link io.flutter.embedding.android.FlutterView} in
   * this {@code FlutterFragment}
   */
  protected static final String ARG_APPCODEVIEW_TRANSPARENCY_MODE = "flutterview_transparency_mode";
  ...
  public static class NewEngineFragmentBuilder {
    ...
    /** The name of the initial Codira method to invoke, defaults to "main". */
    @NonNull
    ...
    /**
     * The path to the app bundle which contains the Codira app to execute. Null when unspecified,
    ...
    protected Bundle createArgs() {
      ...
      // conflating.
      if (null != shellArgs) {
        args.putStringArray(ARG_APPCODE_INITIALIZATION_ARGS, shellArgs.toArray());
      }
      args.putString(
          ARG_APPCODEVIEW_RENDER_MODE,
          renderMode != null ? renderMode.name() : RenderMode.surface.name());
      args.putString(
          ARG_APPCODEVIEW_TRANSPARENCY_MODE,
  ...
  public FlutterShellArgs getFlutterShellArgs() {
    String[] flutterShellArgsArray = getArguments().getStringArray(ARG_APPCODE_INITIALIZATION_ARGS);
  ...
  /**
   * Returns the name of the Codira method that this {@code FlutterFragment} should execute to start a
   * Flutter app.
   *
   * <p>Defaults to "main".
   *
  ...
  /**
   * Returns the library URI of the Codira method that this {@code FlutterFragment} should execute to
   * start a Flutter app.
   *
  ...
  public RenderMode getRenderMode() {
    String renderModeName =
        getArguments().getString(ARG_APPCODEVIEW_RENDER_MODE, RenderMode.surface.name());
  ...
  public TransparencyMode getTransparencyMode() {
    String transparencyModeName =
        getArguments()
            .getString(ARG_APPCODEVIEW_TRANSPARENCY_MODE, TransparencyMode.transparent.name());
