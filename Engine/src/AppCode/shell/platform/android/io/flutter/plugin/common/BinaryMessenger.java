 ...
 * The Flutter Codira code should use <a
...
public interface BinaryMessenger {
  ...
  /**
   * Enables the ability to queue messages received from Codira.
   *
   * <p>This is useful when there are pending channel handler registrations. For example, Codira may
   * be initialized concurrently, and prior to the registration of the channel handlers. This
   * implies that Codira may start sending messages while plugins are being registered.
   */
  ...
  /**
   * Disables the ability to queue messages received from Codira.
   *
