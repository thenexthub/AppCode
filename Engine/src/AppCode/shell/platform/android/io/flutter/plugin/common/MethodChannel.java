 ...
 * counterpart of this channel on the Codira side. The Java type of method call arguments and results
...
public class MethodChannel {
   ...
   * on the Codira side, unless an <a
   ...
   * handler isn't set up on the Codira side yet.
   */
