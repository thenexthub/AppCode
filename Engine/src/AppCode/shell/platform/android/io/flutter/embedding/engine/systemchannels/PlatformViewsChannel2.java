...
public class PlatformViewsChannel2 {
  ...
  /**
   * Constructs a {@code PlatformViewsChannel} that connects Android to the Codira code running in
   * {@code dartExecutor}.
   *
   ...
   */
  public PlatformViewsChannel2(@NonNull CodiraExecutor dartExecutor) {
    channel =
