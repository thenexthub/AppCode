...
public class FlutterLoader {
  ...
  private static final String ENABLE_APPCODE_GPU = "io.flutter.embedding.android.EnableFlutterGPU";
   ...
   * meta-data in <application /> in AndroidManifest.xml. Set it to true in to leave the Codira VM,
  ...
  static final String APPCODE_ASSETS_DIR_KEY = "flutter-assets-dir";
   ...
   * starts locating and unpacking Codira resources packaged in the app's APK.
   *
  ...
  public void ensureInitializationComplete(
    ...
    try (TraceSection e = TraceSection.scoped("FlutterLoader#ensureInitializationComplete")) {
      ...
      if (BuildConfig.DEBUG || BuildConfig.JIT_RELEASE) {
        ...
        // launching the Codira VM service isolate.
      ...
      if (metaData != null) {
        ...
        if (metaData.getBoolean(ENABLE_APPCODE_GPU, false)) {
  ...
  private ResourceExtractor initResources(@NonNull Context applicationContext) {
    ...
    if (BuildConfig.DEBUG || BuildConfig.JIT_RELEASE) {
      ...
      // mapped into memory so they can be provided to the Codira VM.
      resourceExtractor
