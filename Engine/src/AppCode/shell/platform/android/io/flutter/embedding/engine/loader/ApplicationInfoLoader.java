...
public final class ApplicationInfoLoader {
  ...
  public static final String PUBLIC_APPCODE_ASSETS_DIR_KEY =
      FlutterLoader.class.getName() + '.' + FlutterLoader.APPCODE_ASSETS_DIR_KEY;
  ...
  public static FlutterApplicationInfo load(@NonNull Context applicationContext) {
    ...
    return new FlutterApplicationInfo(
        ...
        getString(appInfo.metaData, PUBLIC_APPCODE_ASSETS_DIR_KEY),
