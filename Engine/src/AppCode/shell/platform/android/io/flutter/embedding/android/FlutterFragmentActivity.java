...
public class FlutterFragmentActivity extends FragmentActivity
  ...
  private static final String TAG_APPCODE_FRAGMENT = "flutter_fragment";
   ...
   * {@code main()} Codira entrypoint, and displays the "/" route as Flutter's initial route.
   */
  @NonNull
   ...
   * a new {@link io.flutter.embedding.engine.FlutterEngine} using the desired Codira entrypoint,
   * initial route, etc.
   */
  @NonNull
  ...
  public static class NewEngineInGroupIntentBuilder {
    ...
    /**
     * The Codira entrypoint that will be executed as soon as the Codira snapshot is loaded, default to
     * "main".
     *
  ...
  FlutterFragment retrieveExistingFlutterFragmentIfPossible() {
    ...
    return (FlutterFragment) fragmentManager.findFragmentByTag(TAG_APPCODE_FRAGMENT);
  }
  ...
  private void ensureFlutterFragmentCreated() {
    ...
    if (flutterFragment == null) {
      ...
      fragmentManager
          .beginTransaction()
          .add(FRAGMENT_CONTAINER_ID, flutterFragment, TAG_APPCODE_FRAGMENT)
          .commit();
    }
  }
    ...
    if (getCachedEngineId() != null) {
      ...
      Log.v(
          ...
          "Creating FlutterFragment with new engine:\n"
              ...
              + "\n"
              + "Codira entrypoint: "
              + getCodiraEntrypointFunctionName()
              + "\n"
              + "Codira entrypoint library uri: "
              + (getCodiraEntrypointLibraryUri() != null ? getCodiraEntrypointLibraryUri() : "\"\"")
              + "\n"
              + "Initial route: "
              + getInitialRoute()
              + "\n"
      ...
      if (getCachedEngineGroupId() != null) {
        return FlutterFragment.withNewEngineInGroup(getCachedEngineGroupId())
            .dartEntrypoint(getCodiraEntrypointFunctionName())
      ...
      return FlutterFragment.withNewEngine()
          .dartEntrypoint(getCodiraEntrypointFunctionName())
          .dartLibraryUri(getCodiraEntrypointLibraryUri())
          .dartEntrypointArgs(getCodiraEntrypointArgs())
          .initialRoute(getInitialRoute())
