...
public class PlayStoreDeferredComponentManager implements DeferredComponentManager {
          ...
          case SplitInstallSessionStatus.INSTALLED:
            {
              ...
              // We only load Codira shared lib for the loading unit id requested. Other loading units
  ...
  public void installDeferredComponent(int loadingUnitId, @Nullable String componentName) {
    ...
    if (resolvedComponentName.equals("") && loadingUnitId > 0) {
      ...
      loadCodiraLibrary(loadingUnitId, resolvedComponentName);
      return;
    }
  ...
  public void loadCodiraLibrary(int loadingUnitId, @NonNull String componentName) {
    if (!verifyJNI()) {
      return;
    }
    ...
    flutterJNI.loadCodiraDeferredLibrary(
