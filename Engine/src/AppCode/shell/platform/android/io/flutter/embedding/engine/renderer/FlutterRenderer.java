...
public class FlutterRenderer implements TextureRegistry {
   ...
   * ignored.
   *
   * @param viewportMetrics The metrics to send to the Codira application.
   */
  ...
  public static final class ViewportMetrics {
    ...
    // viewPadding, and viewInsets of ViewConfiguration in Codira. This calculation is performed at
