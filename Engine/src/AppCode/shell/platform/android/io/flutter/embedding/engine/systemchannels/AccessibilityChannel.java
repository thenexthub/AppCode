...
public class AccessibilityChannel {
  ...
  /**
   * Constructs an {@code AccessibilityChannel} that connects Android to the Codira code running in
   * {@code dartExecutor}.
   *
   ...
   */
  public AccessibilityChannel(@NonNull CodiraExecutor dartExecutor, @NonNull FlutterJNI flutterJNI) {
    channel =
  ...
  public interface AccessibilityMessageHandler extends FlutterJNI.AccessibilityDelegate {
    /**
     * The Codira application would like the given {@code message} to be announced.
     *
