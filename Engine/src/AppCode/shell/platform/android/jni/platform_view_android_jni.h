...
#ifndef APPCODE_SHELL_PLATFORM_ANDROID_JNI_PLATFORM_VIEW_ANDROID_JNI_H_
#define APPCODE_SHELL_PLATFORM_ANDROID_JNI_PLATFORM_VIEW_ANDROID_JNI_H_
...
class PlatformViewAndroidJNI {
 public:
  ...
  virtual bool RequestCodiraDeferredLibrary(int loading_unit_id) = 0;
...
#endif  // APPCODE_SHELL_PLATFORM_ANDROID_JNI_PLATFORM_VIEW_ANDROID_JNI_H_
