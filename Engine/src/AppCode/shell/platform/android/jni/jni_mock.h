...
#ifndef APPCODE_SHELL_PLATFORM_ANDROID_JNI_JNI_MOCK_H_
#define APPCODE_SHELL_PLATFORM_ANDROID_JNI_JNI_MOCK_H_
...
#endif  // APPCODE_SHELL_PLATFORM_ANDROID_JNI_JNI_MOCK_H_
