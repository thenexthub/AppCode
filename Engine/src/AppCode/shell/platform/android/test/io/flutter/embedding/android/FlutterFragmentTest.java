...
public class FlutterFragmentTest {
  ...
  public void itCreatesDefaultFragmentWithExpectedDefaults() {
    ...
    assertEquals("main", fragment.getCodiraEntrypointFunctionName());
    assertNull(fragment.getCodiraEntrypointLibraryUri());
    assertNull(fragment.getCodiraEntrypointArgs());
  ...
  public void itCreatesNewEngineFragmentWithRequestedSettings() {
    ...
    assertEquals("custom_entrypoint", fragment.getCodiraEntrypointFunctionName());
    assertEquals("package:foo/bar.dart", fragment.getCodiraEntrypointLibraryUri());
    assertEquals("/custom/route", fragment.getInitialRoute());
    assertArrayEquals(new String[] {"foo", "bar"}, fragment.getCodiraEntrypointArgs().toArray());
    assertArrayEquals(new String[] {}, fragment.getFlutterShellArgs().toArray());
