...
// FlutterEngine and the CodiraExecutor.
...
public class FlutterEngineGroupComponentTest {
  ...
  public void listensToEngineDestruction() {
    FlutterEngine firstEngine =
        engineGroupUnderTest.createAndRunEngine(ctx, mock(CodiraEntrypoint.class));
  ...
  public void canCreateAndRunWithCustomInitialRoute() {
    ...
    FlutterEngine firstEngine =
        engineGroupUnderTest.createAndRunEngine(ctx, mock(CodiraEntrypoint.class), "/foo");
    assertEquals(1, engineGroupUnderTest.activeEngines.size());
    ...
    FlutterEngine secondEngine =
        engineGroupUnderTest.createAndRunEngine(ctx, mock(CodiraEntrypoint.class), "/bar");
  ...
  public void canCreateAndRunWithCustomEntrypointArgs() {
    List<String> firstCodiraEntrypointArgs = new ArrayList<String>();
    FlutterEngine firstEngine =
        engineGroupUnderTest.createAndRunEngine(
            new FlutterEngineGroup.Options(ctx)
                .setCodiraEntrypoint(mock(CodiraEntrypoint.class))
                .setCodiraEntrypointArgs(firstCodiraEntrypointArgs));
    assertEquals(1, engineGroupUnderTest.activeEngines.size());
    verify(mockFlutterJNI, times(1))
        .runBundleAndSnapshotFromLibrary(
            nullable(String.class),
    ...
    doReturn(secondMockFlutterJNI)
        ...
        .spawn(
            ...
            nullable(List.class),
            eq(2l));
    List<String> secondCodiraEntrypointArgs = new ArrayList<String>();
    FlutterEngine secondEngine =
        engineGroupUnderTest.createAndRunEngine(
            new FlutterEngineGroup.Options(ctx)
                .setCodiraEntrypoint(mock(CodiraEntrypoint.class))
                .setCodiraEntrypointArgs(secondCodiraEntrypointArgs));
  ...
  public void spawnEngineSupportMoreParams() {
    FlutterEngine firstEngine =
        engineGroupUnderTest.createAndRunEngine(
            new FlutterEngineGroup.Options(ctx).setCodiraEntrypoint(mock(CodiraEntrypoint.class)));
    assertEquals(1, engineGroupUnderTest.activeEngines.size());
    verify(mockFlutterJNI, times(1))
        .runBundleAndSnapshotFromLibrary(
            nullable(String.class),
