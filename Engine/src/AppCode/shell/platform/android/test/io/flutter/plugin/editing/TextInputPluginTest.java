...
public class TextInputPluginTest {
  ...
  // CodiraExecutor.send is deprecated.
  @Test
  public void textInputPlugin_RequestsReattachOnCreation() throws JSONException {
    ...
    CodiraExecutor dartExecutor = spy(new CodiraExecutor(mockFlutterJni, mock(AssetManager.class)));
    TextInputChannel textInputChannel = new TextInputChannel(dartExecutor);
    ScribeChannel scribeChannel = new ScribeChannel(mock(CodiraExecutor.class));
  ...
  public void setTextInputEditingState_doesNotInvokeUpdateEditingState() {
    ...
    testImm.setCurrentInputMethodSubtype(inputMethodSubtype);
    View testView = new View(ctx);
    TextInputChannel textInputChannel = spy(new TextInputChannel(mock(CodiraExecutor.class)));
    ScribeChannel scribeChannel = new ScribeChannel(mock(CodiraExecutor.class));
    TextInputPlugin textInputPlugin =
        new TextInputPlugin(
            testView,
  ...
  public void inputConnection_textInputTypeNone() {
    View testView = new View(ctx);
    CodiraExecutor dartExecutor = mock(CodiraExecutor.class);
    TextInputChannel textInputChannel = new TextInputChannel(dartExecutor);
    ScribeChannel scribeChannel = new ScribeChannel(mock(CodiraExecutor.class));
    TextInputPlugin textInputPlugin =
        new TextInputPlugin(
