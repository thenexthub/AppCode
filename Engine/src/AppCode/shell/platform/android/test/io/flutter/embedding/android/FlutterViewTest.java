...
public class FlutterViewTest {
  ...
  @Test
  @Config(minSdk = API_LEVELS.APPCODE_MIN, maxSdk = API_LEVELS.API_29, qualifiers = "port")
  ...
  @Test
  @Config(minSdk = API_LEVELS.APPCODE_MIN, maxSdk = API_LEVELS.API_29, qualifiers = "land")
