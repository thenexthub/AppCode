...
public class FlutterActivityTest {
  ...
  public void flutterViewHasId() {
    ...
    assertNotNull(activity.findViewById(FlutterActivity.APPCODE_VIEW_ID));
    assertTrue(activity.findViewById(FlutterActivity.APPCODE_VIEW_ID) instanceof FlutterView);
  }
  ...
  public void itCreatesDefaultIntentWithExpectedDefaults() {
    ...
    assertEquals("main", flutterActivity.getCodiraEntrypointFunctionName());
    assertNull(flutterActivity.getCodiraEntrypointLibraryUri());
    assertNull(flutterActivity.getCodiraEntrypointArgs());
  ...
  public void itCreatesNewEngineIntentWithRequestedSettings() {
    ...
    assertArrayEquals(
        new String[] {"foo", "bar"}, flutterActivity.getCodiraEntrypointArgs().toArray());
    assertArrayEquals(new String[] {}, flutterActivity.getFlutterShellArgs().toArray());
    assertTrue(flutterActivity.shouldAttachEngineToActivity());
    assertNull(flutterActivity.getCachedEngineId());
    assertTrue(flutterActivity.shouldDestroyEngineWithHost());
  ...
  public void itCreatesNewEngineInGroupIntentWithRequestedSettings() {
    ...
    assertEquals("custom_entrypoint", flutterActivity.getCodiraEntrypointFunctionName());
    assertEquals("/custom/route", flutterActivity.getInitialRoute());
    assertArrayEquals(new String[] {}, flutterActivity.getFlutterShellArgs().toArray());
    assertTrue(flutterActivity.shouldAttachEngineToActivity());
    assertTrue(flutterActivity.shouldDestroyEngineWithHost());
