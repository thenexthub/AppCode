...
public class PlayStoreDeferredComponentManagerTest {
  private class TestFlutterJNI extends FlutterJNI {
    public int loadCodiraDeferredLibraryCalled = 0;
    ...
    public void loadCodiraDeferredLibrary(int loadingUnitId, @NonNull String[] searchPaths) {
      loadCodiraDeferredLibraryCalled++;
  ...
  // Skips the download process to directly call the loadAssets and loadCodiraLibrary methods.
  private class TestPlayStoreDeferredComponentManager extends PlayStoreDeferredComponentManager {
    ...
    public void installDeferredComponent(int loadingUnitId, String componentName) {
      ...
      loadCodiraLibrary(loadingUnitId, componentName);
    }
  }
  ...
  public void downloadCallsJNIFunctions() throws NameNotFoundException {
    ...
    assertEquals(jni.loadCodiraDeferredLibraryCalled, 1);
  ...
  public void downloadCallsJNIFunctionsWithFilenameFromManifest() throws NameNotFoundException {
    ...
    bundle.putString(ApplicationInfoLoader.PUBLIC_APPCODE_ASSETS_DIR_KEY, "custom_assets");
