...
AndroidShellHolder::AndroidShellHolder(
  ...
  appcode::ThreadHost::ThreadHostConfig host_config(
  ...
  appcode::TaskRunners task_runners(thread_label,     // label
  ...
  if (shell_) {
    shell_->GetCodiraVM()->GetConcurrentMessageLoop()->PostTaskToAllWorkers([]() {
...
const appcode::Settings& AndroidShellHolder::GetSettings() const {
  return settings_;
}
...
std::unique_ptr<AndroidShellHolder> AndroidShellHolder::Spawn(
  ...
  std::shared_ptr<appcode::AndroidContext> android_context =
  ...
  std::unique_ptr<appcode::Shell> shell =
