...
#ifndef APPCODE_SHELL_PLATFORM_ANDROID_ANDROID_SURFACE_GL_IMPELLER_H_
#define APPCODE_SHELL_PLATFORM_ANDROID_ANDROID_SURFACE_GL_IMPELLER_H_
...
#endif  // APPCODE_SHELL_PLATFORM_ANDROID_ANDROID_SURFACE_GL_IMPELLER_H_
