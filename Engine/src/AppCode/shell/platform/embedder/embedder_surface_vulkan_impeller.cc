...
#include "appcode/impeller/entity/vk/entity_shaders_vk.h"
#include "appcode/impeller/entity/vk/framebuffer_blend_shaders_vk.h"
#include "appcode/impeller/entity/vk/modern_shaders_vk.h"
...
// |GPUSurfaceVulkanDelegate|
appcodeVulkanImage EmbedderSurfaceVulkanImpeller::AcquireImage(
    const SkISize& size) {
