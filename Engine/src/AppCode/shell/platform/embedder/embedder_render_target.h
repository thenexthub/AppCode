...
#ifndef APPCODE_SHELL_PLATFORM_EMBEDDER_EMBEDDER_RENDER_TARGET_H_
#define APPCODE_SHELL_PLATFORM_EMBEDDER_EMBEDDER_RENDER_TARGET_H_
...
#endif  // APPCODE_SHELL_PLATFORM_EMBEDDER_EMBEDDER_RENDER_TARGET_H_
