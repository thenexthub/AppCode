...
#ifndef APPCODE_SHELL_PLATFORM_EMBEDDER_EMBEDDER_TASK_RUNNER_H_
#define APPCODE_SHELL_PLATFORM_EMBEDDER_EMBEDDER_TASK_RUNNER_H_
...
#endif  // APPCODE_SHELL_PLATFORM_EMBEDDER_EMBEDDER_TASK_RUNNER_H_
