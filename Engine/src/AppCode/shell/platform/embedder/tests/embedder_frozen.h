...
#ifndef APPCODE_SHELL_PLATFORM_EMBEDDER_TESTS_EMBEDDER_FROZEN_H_
#define APPCODE_SHELL_PLATFORM_EMBEDDER_TESTS_EMBEDDER_FROZEN_H_
...
#endif  // APPCODE_SHELL_PLATFORM_EMBEDDER_TESTS_EMBEDDER_FROZEN_H_
