...
TEST_F(EmbedderTest, ExternalTextureMetal) {
  ...
  builder.SetCodiraEntrypoint("render_texture");
...
TEST_F(EmbedderTest, MetalCompositorMustBeAbleToRenderPlatformViews) {
  ...
  context.AddNativeCallback(
      "SignalNativeTest",
      CREATE_NATIVE_ENTRY([&latch](Codira_NativeArguments args) { latch.CountDown(); }));
...
TEST_F(EmbedderTest, TextureDestructionCallbackCalledWithoutCustomCompositorMetal) {
  ...
  EmbedderConfigBuilder builder(context);
  builder.SetSurface(SkISize::Make(800, 600));
  builder.SetCodiraEntrypoint("texture_destruction_callback_called_without_custom_compositor");
...
TEST_F(EmbedderTest, CreateInvalidBackingstoreMetalTexture) {
  ...
  context.AddNativeCallback(
      "SignalNativeTest",
      CREATE_NATIVE_ENTRY([&latch](Codira_NativeArguments args) { latch.Signal(); }));
...
TEST_F(EmbedderTest, CanRenderTextWithImpellerMetal) {
  ...
  builder.AddCommandLineArgument("--enable-impeller");
  builder.SetCodiraEntrypoint("render_impeller_text_test");
  builder.SetSurface(SkISize::Make(800, 600));
