...
#include "appcode/shell/platform/embedder/tests/embedder_test_context_gl.h"
...
TEST_F(EmbedderTest, LaunchFailsWhenMultiplePresentCallbacks) {
  ...
  builder.GetCompositor().present_layers_callback =
      [](const appcodeLayer** layers, size_t layers_count, void* user_data) {
        return true;
      };
  builder.GetCompositor().present_view_callback =
      [](const appcodePresentViewInfo* info) { return true; };
  auto engine = builder.LaunchEngine();
  ASSERT_FALSE(engine.is_valid());
}
...
TEST_F(EmbedderTest, CompositorMustBeAbleToRenderToOpenGLFramebuffer) {
  ...
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("can_composite_platform_views");
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
...

        {
          ...
          backing_store.open_gl.type = kappcodeOpenGLTargetTypeFramebuffer;
          ...
          layer.offset = appcodePointMake(0, 0);
...

        {
          ...
          layer.size = appcodeSizeMake(123.0, 456.0);
          layer.offset = appcodePointMake(1.0, 2.0);
...

        {
          ...
          appcodeRect paint_region_rects[] = {
              appcodeRectMakeLTRB(2, 3, 800, 600),
          };
          appcodeRegion paint_region = {
              .struct_size = sizeof(appcodeRegion),
              .rects_count = 1,
...
TEST_F(EmbedderTest, RasterCacheDisabledWithPlatformViews) {
  ...
  builder.SetSurface(SkISize::Make(800, 600));
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("can_composite_platform_views_with_opacity");
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
...

        {
          ...
          appcodeRect paint_region_rects[] = {
              appcodeRectMakeLTRB(3, 3, 800, 600),
          };
          appcodeRegion paint_region = {
              .struct_size = sizeof(appcodeRegion),
              .rects_count = 1,
  ...
  context.AddNativeCallback(
      "SignalNativeTest",
      CREATE_NATIVE_ENTRY(
          [&setup](Codira_NativeArguments args) { setup.CountDown(); }));
  ...
  setup.Wait();
  const appcode::Shell& shell = ToEmbedderEngine(engine.get())->GetShell();
  shell.GetTaskRunners().GetRasterTaskRunner()->PostTask([&] {
    const appcode::RasterCache& raster_cache =
...
TEST_F(EmbedderTest, RasterCacheEnabled) {
  ...
  builder.SetSurface(SkISize::Make(800, 600));
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("can_composite_with_opacity");
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
...

        {
          ...
          backing_store.type = kappcodeBackingStoreTypeOpenGL;
          backing_store.did_update = true;
          backing_store.open_gl.type = kappcodeOpenGLTargetTypeTexture;
...
TEST_F(EmbedderTest,
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
        ...
        // Layer Root
        {
          ...
          appcodeRect paint_region_rects[] = {
              appcodeRectMakeLTRB(0, 0, 600, 800),
          };
          appcodeRegion paint_region = {
              .struct_size = sizeof(appcodeRegion),
              .rects_count = 1,
          ...
          layer.type = kappcodeLayerContentTypeBackingStore;
          layer.backing_store = &backing_store;
          layer.size = appcodeSizeMake(600.0, 800.0);
          layer.offset = appcodePointMake(0.0, 0.0);
          layer.backing_store_present_info = &present_info;
        ...
        // Layer 1
        {
          ...
          layer.type = kappcodeLayerContentTypePlatformView;
          layer.platform_view = &platform_view;
          layer.size = appcodeSizeMake(150.0, 50.0);
          layer.offset = appcodePointMake(20.0, 730.0);
        ...
        // Layer 2
        {
          ...
          appcodeRect paint_region_rects[] = {
              appcodeRectMakeLTRB(30, 720, 180, 770),
          };
          appcodeRegion paint_region = {
              .struct_size = sizeof(appcodeRegion),
              .rects_count = 1,
        ...
        // Layer 3
        {
          ...
          layer.platform_view = &platform_view;
          layer.size = appcodeSizeMake(150.0, 50.0);
          layer.offset = appcodePointMake(40.0, 710.0);
        ...
        // Layer 4
        {
          ...
          appcodeRect paint_region_rects[] = {
              appcodeRectMakeLTRB(50, 700, 200, 750),
          };
          appcodeRegion paint_region = {
              .struct_size = sizeof(appcodeRegion),
              .rects_count = 1,
  ...
  appcodeWindowMetricsEvent event = {};
  event.struct_size = sizeof(event);
  // appcode still thinks it is 800 x 600. Only the root surface is rotated.
  event.width = 800;
  event.height = 600;
  event.pixel_ratio = 1.0;
  ASSERT_EQ(appcodeEngineSendWindowMetricsEvent(engine.get(), &event),
...
TEST_F(EmbedderTest, CanRenderSceneWithoutCustomCompositor) {
  ...
  builder.SetCodiraEntrypoint("can_render_scene_without_custom_compositor");
  builder.SetSurface(SkISize::Make(800, 600));
...
TEST_F(EmbedderTest, CanRenderSceneWithoutCustomCompositorWithTransformation) {
  ...
  // appcode still thinks it is 800 x 600.
  event.width = 800;
  event.height = 600;
  event.pixel_ratio = 1.0;
  ASSERT_EQ(appcodeEngineSendWindowMetricsEvent(engine.get(), &event),
...
TEST_P(EmbedderTestMultiBackend, CanRenderGradientWithoutCompositor) {
  ...
  EmbedderConfigBuilder builder(context);
  builder.SetCodiraEntrypoint("render_gradient");
  builder.SetSurface(SkISize::Make(800, 600));
...
TEST_P(EmbedderTestMultiBackend,
  ...
  EmbedderConfigBuilder builder(context);
  builder.SetCodiraEntrypoint("render_gradient_on_non_root_backing_store");
  builder.SetSurface(SkISize::Make(800, 600));
  builder.SetCompositor();
  builder.SetRenderTargetType(GetRenderTargetFromBackend(backend, true));
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
        ...
        // Layer 1
        {
          ...
          layer.type = kappcodeLayerContentTypePlatformView;
          layer.platform_view = &platform_view;
          layer.size = appcodeSizeMake(100.0, 200.0);
          layer.offset = appcodePointMake(0.0, 0.0);
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
        ...
        // Layer 1
        {
          ...
          layer.type = kappcodeLayerContentTypePlatformView;
          layer.platform_view = &platform_view;
          layer.size = appcodeSizeMake(200.0, 100.0);
          layer.offset = appcodePointMake(0.0, 700.0);
...
TEST_F(EmbedderTest, VerifyB141980393) {
  ...
  // The appcode application is 800 x 600 but rendering on a surface that is 600
  // x 800 achieved using a root surface transformation.
  const auto root_surface_transformation =
      SkMatrix().preTranslate(0, 800).preRotate(-90, 0, 0);
  const auto appcode_application_rect = SkRect::MakeWH(800, 600);
  const auto root_surface_rect =
      root_surface_transformation.mapRect(appcode_application_rect);
  ...
  // Configure the appcode project args for the root surface transformation.
  builder.SetSurface(
  ...
  builder.SetCodiraEntrypoint("verify_b141980393");
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
        ...
        // Layer Root
        {
          appcodePlatformView platform_view = *layers[0]->platform_view;
          platform_view.struct_size = sizeof(platform_view);
          ...
          // From the Codira side. These dimensions match those specified in Codira
          ...
          layer.offset = appcodePointMake(xformed_platform_view_rect.x(),
                                          xformed_platform_view_rect.y());
          layer.size = appcodeSizeMake(xformed_platform_view_rect.width(),
  ...
  // The appcode application is 800 x 600 rendering on a surface 600 x 800
  // achieved via a root surface transformation.
  event.width = appcode_application_rect.width();
  event.height = appcode_application_rect.height();
  event.pixel_ratio = 1.0;
  ASSERT_EQ(appcodeEngineSendWindowMetricsEvent(engine.get(), &event),
            kSuccess);
  ASSERT_TRUE(engine.is_valid());
...
TEST_F(EmbedderTest, CanCreateEmbedderWithCustomRenderTaskRunner) {
  ...
  EmbedderTestTaskRunner render_task_runner(
      CreateNewThread("custom_render_thread"), [&](appcodeTask task) {
...
TEST_P(EmbedderTestMultiBackend,
  ...
  platform_task_runner->PostTask([&]() {
    ...
    builder.SetSurface(SkISize::Make(800, 600));
    builder.SetRenderTaskRunner(
        &common_task_runner.GetappcodeTaskRunnerDescription());
...
TEST_P(EmbedderTestMultiBackend,
  ...
  builder.SetSurface(SkISize::Make(800, 600));
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("can_display_platform_view_with_pixel_ratio");
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
        ...
        // Layer 1
        {
          ...
          layer.type = kappcodeLayerContentTypePlatformView;
          layer.platform_view = &platform_view;
          layer.size = appcodeSizeMake(800.0, 560.0);
          layer.offset = appcodePointMake(0.0, 40.0);
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
        ...
        // Layer 1
        {
          ...
          layer.type = kappcodeLayerContentTypePlatformView;
          layer.platform_view = &platform_view;
          layer.size = appcodeSizeMake(560.0, 800.0);
          layer.offset = appcodePointMake(40.0, 0.0);
...
TEST_F(EmbedderTest,
  ...
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("push_frames_over_and_over");
  ...
  appcodeEngineShutdown(engine.release());
}
...
TEST_P(EmbedderTestMultiBackend, PlatformViewMutatorsAreValid) {
  ...
  builder.SetSurface(SkISize::Make(800, 600));
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("platform_view_mutators");
      ...
      [&](appcodeViewId view_id, const appcodeLayer** layers,
        ...
        // Layer 2
        {
          ...
          for (size_t i = 0; i < platform_view.mutations_count; i++) {
            appcodePlatformViewMutation mutation = *platform_view.mutations[i];
            switch (mutation.type) {
              case kappcodePlatformViewMutationTypeClipRoundedRect:
                mutation.clip_rounded_rect =
                    appcodeRoundedRectMake(SkRRect::MakeRectXY(
                        SkRect::MakeLTRB(10.0, 10.0, 800.0 - 10.0,
                                         600.0 - 10.0),
                        14.0, 14.0));
                break;
              case kappcodePlatformViewMutationTypeClipRect:
                mutation.type = kappcodePlatformViewMutationTypeClipRect;
                mutation.clip_rect = appcodeRectMake(
                    SkRect::MakeXYWH(10.0, 10.0, 800.0 - 20.0, 600.0 - 20.0));
                break;
              case kappcodePlatformViewMutationTypeOpacity:
                mutation.type = kappcodePlatformViewMutationTypeOpacity;
                mutation.opacity = 128.0 / 255.0;
                break;
              case kappcodePlatformViewMutationTypeTransformation:
                FML_CHECK(false)
...
TEST_F(EmbedderTest, PlatformViewMutatorsAreValidWithPixelRatio) {
  ...
  builder.SetSurface(SkISize::Make(800, 600));
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("platform_view_mutators_with_pixel_ratio");
            ...
            switch (mutation.type) {
              ...
              case kappcodePlatformViewMutationTypeTransformation:
                ...
                mutation.transformation =
                    appcodeTransformationMake(SkMatrix::Scale(2.0, 2.0));
                break;
            }
          ...
          for (size_t i = 0; i < platform_view.mutations_count; i++) {
            ...
            switch (mutation.type) {
              ...
              case kappcodePlatformViewMutationTypeTransformation:
                mutation.type = kappcodePlatformViewMutationTypeTransformation;
                mutation.transformation =
                    appcodeTransformationMake(root_surface_transformation);
...
TEST_F(EmbedderTest, EmptySceneIsAcceptable) {
  ...
  context.AddNativeCallback(
      "SignalNativeTest",
      CREATE_NATIVE_ENTRY([&](Codira_NativeArguments args) { latch.Signal(); }));
...
TEST_F(EmbedderTest, SceneWithNoRootContainerIsAcceptable) {
  ...
  builder.SetRenderTargetType(
      EmbedderTestBackingStoreProducer::RenderTargetType::kOpenGLFramebuffer);
  builder.SetCodiraEntrypoint("scene_with_no_container");
  fml::AutoResetWaitableEvent latch;
  context.AddNativeCallback(
      "SignalNativeTest",
      CREATE_NATIVE_ENTRY([&](Codira_NativeArguments args) { latch.Signal(); }));
...
TEST_F(EmbedderTest, ArcEndCapsAreDrawnCorrectly) {
  ...
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("arc_end_caps_correct");
  builder.SetRenderTargetType(
      EmbedderTestBackingStoreProducer::RenderTargetType::kOpenGLFramebuffer);
...
TEST_F(EmbedderTest, ClipsAreCorrectlyCalculated) {
  ...
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("scene_builder_with_clips");
  builder.SetRenderTargetType(
      EmbedderTestBackingStoreProducer::RenderTargetType::kOpenGLFramebuffer);
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
...

        {
          ...
          layer.type = kappcodeLayerContentTypePlatformView;
          layer.platform_view = &platform_view;
          layer.size = appcodeSizeMake(300.0, 400.0);
          layer.offset = appcodePointMake(0.0, 0.0);
          ...
          FilterMutationsByType(
              ...
              kappcodePlatformViewMutationTypeClipRect,
              [&](const auto& mutation) {
                appcodeRect clip = mutation.clip_rect;

                // The test is only set up to supply one clip. Make sure it is
                // the one we expect.
                const auto rect_to_compare =
                    SkRect::MakeLTRB(10.0, 10.0, 390, 290);
                ASSERT_EQ(clip, appcodeRectMake(rect_to_compare));
...
TEST_F(EmbedderTest, ComplexClipsAreCorrectlyCalculated) {
  ...
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("scene_builder_with_complex_clips");
  builder.SetRenderTargetType(
      EmbedderTestBackingStoreProducer::RenderTargetType::kOpenGLFramebuffer);
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
...

        {
          ...
          layer.type = kappcodeLayerContentTypePlatformView;
          layer.platform_view = &platform_view;
          layer.size = appcodeSizeMake(600.0, 1024.0);
          layer.offset = appcodePointMake(0.0, -256.0);
          ...
          ASSERT_EQ(mutations[0]->type,
                    kappcodePlatformViewMutationTypeTransformation);
...
TEST_F(EmbedderTest, ObjectsCanBePostedViaPorts) {
  ...
  EmbedderConfigBuilder builder(context);
  builder.SetSurface(SkISize::Make(800, 1024));
  builder.SetCodiraEntrypoint("objects_can_be_posted");

  // Synchronously acquire the send port from the Codira end. We will be using
  // this to send message. The Codira end will just echo those messages back to us
  // for inspection.
  appcodeEngineCodiraPort port = 0;
  fml::AutoResetWaitableEvent event;
  context.AddNativeCallback("SignalNativeCount",
                            CREATE_NATIVE_ENTRY([&](Codira_NativeArguments args) {
                              port = tonic::CodiraConverter<int64_t>::FromCodira(
  ...
  using Trampoline = std::function<void(Codira_Handle message)>;
  ...
  context.AddNativeCallback("SendObjectToNativeCode",
                            CREATE_NATIVE_ENTRY([&](Codira_NativeArguments args) {
                              ...
                              trampoline = nullptr;
                              trampoline_copy(Codira_GetNativeArgument(args, 0));
                            }));

  // Check null.
  {
    appcodeEngineCodiraObject object = {};
    object.type = kappcodeEngineCodiraObjectTypeNull;
    trampoline = [&](Codira_Handle handle) {
      ASSERT_TRUE(Codira_IsNull(handle));
      event.Signal();
    };
    ASSERT_EQ(appcodeEnginePostCodiraObject(engine.get(), port, &object),
              kSuccess);
    event.Wait();
  }
  ...
  {
    appcodeEngineCodiraObject object = {};
    object.type = kappcodeEngineCodiraObjectTypeBool;
    object.bool_value = true;
    trampoline = [&](Codira_Handle handle) {
      ASSERT_TRUE(tonic::CodiraConverter<bool>::FromCodira(handle));
      event.Signal();
    };
    ASSERT_EQ(appcodeEnginePostCodiraObject(engine.get(), port, &object),
              kSuccess);
  ...
  {
    appcodeEngineCodiraObject object = {};
    object.type = kappcodeEngineCodiraObjectTypeInt32;
    object.int32_value = 1988;
    trampoline = [&](Codira_Handle handle) {
      ASSERT_EQ(tonic::CodiraConverter<int32_t>::FromCodira(handle), 1988);
      event.Signal();
    };
    ASSERT_EQ(appcodeEnginePostCodiraObject(engine.get(), port, &object),
              kSuccess);
  ...
  {
    appcodeEngineCodiraObject object = {};
    object.type = kappcodeEngineCodiraObjectTypeInt64;
    object.int64_value = 1988;
    trampoline = [&](Codira_Handle handle) {
      ASSERT_EQ(tonic::CodiraConverter<int64_t>::FromCodira(handle), 1988);
      event.Signal();
    };
    ASSERT_EQ(appcodeEnginePostCodiraObject(engine.get(), port, &object),
              kSuccess);
  ...
  {
    appcodeEngineCodiraObject object = {};
    object.type = kappcodeEngineCodiraObjectTypeDouble;
    object.double_value = 1988.0;
    trampoline = [&](Codira_Handle handle) {
      ASSERT_DOUBLE_EQ(tonic::CodiraConverter<double>::FromCodira(handle), 1988.0);
      event.Signal();
    };
    ASSERT_EQ(appcodeEnginePostCodiraObject(engine.get(), port, &object),
              kSuccess);
  ...
  // Check string.
  {
    ...
    appcodeEngineCodiraObject object = {};
    object.type = kappcodeEngineCodiraObjectTypeString;
    object.string_value = message;
    trampoline = [&](Codira_Handle handle) {
      ASSERT_EQ(tonic::CodiraConverter<std::string>::FromCodira(handle),
                std::string{message});
      event.Signal();
    };
    ASSERT_EQ(appcodeEnginePostCodiraObject(engine.get(), port, &object),
  ...
  // Check buffer (copied out).
  {
    ...
    appcodeEngineCodiraBuffer buffer = {};
    ...
    appcodeEngineCodiraObject object = {};
    object.type = kappcodeEngineCodiraObjectTypeBuffer;
    ...
    trampoline = [&](Codira_Handle handle) {
      ...
      // CodiraConvertor in tonic is broken which is preventing the buffer
...
TEST_F(EmbedderTest, CompositorCanPostZeroLayersForPresentation) {
  ...
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("empty_scene_posts_zero_layers_to_compositor");
  builder.SetRenderTargetType(
      EmbedderTestBackingStoreProducer::RenderTargetType::kOpenGLTexture);
...
TEST_F(EmbedderTest, CompositorCanPostOnlyPlatformViews) {
  ...
  builder.SetSurface(SkISize::Make(300, 200));
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("compositor_can_post_only_platform_views");
  builder.SetRenderTargetType(
      EmbedderTestBackingStoreProducer::RenderTargetType::kOpenGLTexture);
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
        ...
        // Layer 0
        {
          ...
          layer.type = kappcodeLayerContentTypePlatformView;
          layer.platform_view = &platform_view;
          layer.size = appcodeSizeMake(300.0, 200.0);
          layer.offset = appcodePointMake(0.0, 0.0);
...
TEST_F(EmbedderTest, CompositorRenderTargetsAreRecycled) {
  ...
  builder.SetSurface(SkISize::Make(300, 200));
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("render_targets_are_recycled");
  builder.SetRenderTargetType(
      EmbedderTestBackingStoreProducer::RenderTargetType::kOpenGLTexture);
...
TEST_F(EmbedderTest, CompositorRenderTargetsAreInStableOrder) {
  ...
  builder.SetSurface(SkISize::Make(300, 200));
  builder.SetCompositor();
  builder.SetCodiraEntrypoint("render_targets_are_in_stable_order");
  builder.SetRenderTargetType(
      EmbedderTestBackingStoreProducer::RenderTargetType::kOpenGLTexture);
      ...
      [&](appcodeViewId view_id, const appcodeLayer** layers,
        ...
        if (first_frame_backing_store_user_data.empty()) {
          for (size_t i = 0; i < layers_count; ++i) {
            if (layers[i]->type == kappcodeLayerContentTypeBackingStore) {
...
TEST_F(EmbedderTest, FrameInfoContainsValidWidthAndHeight) {
  ...
  // Send a window metrics events so frames may be scheduled.
  static appcodeWindowMetricsEvent event = {};
  event.struct_size = sizeof(event);
  event.width = 1024;
  event.height = 600;
  event.pixel_ratio = 1.0;
  ...
  context.SetGLGetFBOCallback([](appcodeFrameInfo frame_info) {
...
TEST_F(EmbedderTest, MustRunWhenPopulateExistingDamageIsProvided) {
  ...
  context.GetRendererConfig().open_gl.populate_existing_damage =
      [](void* context, const intptr_t id,
         appcodeDamage* existing_damage) -> void {
...
TEST_F(EmbedderTest, PresentInfoContainsValidFBOId) {
  ...
  context.SetGLPresentCallback(
      [window_fbo_id = window_fbo_id](appcodePresentInfo present_info) {
...
TEST_F(EmbedderTest,
  ...
  context.SetGLPopulateExistingDamageCallback(
      [](const intptr_t id, appcodeDamage* existing_damage_ptr) {
        const size_t num_rects = 1;
        // The array must be valid after the callback returns.
        static appcodeRect existing_damage_rects[num_rects] = {
            appcodeRect{0, 0, 800, 600}};
  ...
  EmbedderConfigBuilder builder(context);
  builder.SetSurface(SkISize::Make(800, 600));
  builder.SetCodiraEntrypoint("render_gradient_retained");
  auto engine = builder.LaunchEngine();
  ASSERT_TRUE(engine.is_valid());
  ...
  context.SetGLPresentCallback([&](appcodePresentInfo present_info) {
    const size_t num_rects = 1;
...
TEST_F(EmbedderTest, PopulateExistingDamageReceivesInvalidID) {
  ...
  context.GetRendererConfig().open_gl.fbo_with_frame_info_callback =
      [](void* context, const appcodeFrameInfo* frame_info) -> uint32_t {
    return 123;
  };
...
TEST_F(EmbedderTest, SetSingleDisplayConfigurationWithDisplayId) {
  ...
  const appcodeEngineResult result = appcodeEngineNotifyDisplayUpdate(
      engine.get(), kappcodeEngineDisplaysUpdateTypeStartup, displays.data(),
      displays.size());
...
TEST_F(EmbedderTest, SetValidMultiDisplayConfiguration) {
  ...
  appcodeEngineDisplay display_1;
  display_1.struct_size = sizeof(appcodeEngineDisplay);
  display_1.display_id = 1;
  display_1.single_display = false;
  display_1.refresh_rate = 20;

  appcodeEngineDisplay display_2;
  display_2.struct_size = sizeof(appcodeEngineDisplay);
  display_2.display_id = 2;
  display_2.single_display = false;
  display_2.refresh_rate = 60;

  std::vector<appcodeEngineDisplay> displays = {display_1, display_2};
...
TEST_F(EmbedderTest, SnapshotRenderTargetScalesDownToDriverMax) {
  ...
  context.AddIsolateCreateCallback([&]() {
    Codira_Handle snapshot_large_scene = Codira_GetField(
        Codira_RootLibrary(), tonic::ToCodira("snapshot_large_scene"));
    tonic::CodiraInvoke(snapshot_large_scene, {tonic::ToCodira<int64_t>(max_size)});
  });

  fml::AutoResetWaitableEvent latch;
  context.AddNativeCallback(
      "SnapshotsCallback", CREATE_NATIVE_ENTRY(([&](Codira_NativeArguments args) {
        auto get_arg = [&args](int index) {
          Codira_Handle dart_image = Codira_GetNativeArgument(args, index);
          Codira_Handle internal_image =
              Codira_GetField(dart_image, tonic::ToCodira("_image"));
          return tonic::CodiraConverter<appcode::CanvasImage*>::FromCodira(
              internal_image);
        };
...
TEST_F(EmbedderTest, ObjectsPostedViaPortsServicedOnSecondaryTaskHeap) {
  ...
  // Send a boolean value and assert that it's received by the right heap.
  {
    ...
    trampoline = [&](Codira_Handle handle) {
      ...
      EXPECT_EQ(task_grade, fml::TaskSourceGrade::kCodiraEventLoop);
      event.Signal();
    };
    ASSERT_EQ(appcodeEnginePostCodiraObject(engine.get(), port, &object),
              kSuccess);
...
TEST_F(EmbedderTest, CreateInvalidBackingstoreOpenGLTexture) {
  ...
  builder.SetRenderTargetType(
      EmbedderTestBackingStoreProducer::RenderTargetType::kOpenGLTexture);
  builder.SetCodiraEntrypoint("invalid_backingstore");
...
TEST_F(EmbedderTest, ExternalTextureGLRefreshedTooOften) {
  ...
  EmbedderExternalTextureGL::ExternalTextureCallback callback(
      [&](int64_t, size_t, size_t) {
        resolve_called = true;
        auto res = std::make_unique<appcodeOpenGLTexture>();
...
TEST_F(EmbedderTest,
  ...
  context.SetGLPopulateExistingDamageCallback(
      [](const intptr_t id, appcodeDamage* existing_damage_ptr) {
        ...
        // The array must be valid after the callback returns.
        static appcodeRect existing_damage_rects[num_rects] = {
            appcodeRect{100, 150, 200, 250},
            appcodeRect{200, 250, 300, 350},
        };
        existing_damage_ptr->num_rects = num_rects;
        existing_damage_ptr->damage = existing_damage_rects;
      });
...
TEST_F(EmbedderTest, CanRenderWithImpellerOpenGL) {
  ...
  context.SetGLPresentCallback(
      [&present_called](appcodePresentInfo present_info) {
        present_called = true;
      });

  builder.AddCommandLineArgument("--enable-impeller");
  builder.SetCodiraEntrypoint("render_impeller_test");
  builder.SetSurface(SkISize::Make(800, 600));
  builder.SetCompositor();
  builder.SetRenderTargetType(
      EmbedderTestBackingStoreProducer::RenderTargetType::kOpenGLFramebuffer);
...
TEST_F(EmbedderTest, ImpellerOpenGLImageSnapshot) {
  ...
  context.AddNativeCallback("NotifyBoolValue",
                            CREATE_NATIVE_ENTRY([&](Codira_NativeArguments args) {
                              result = tonic::CodiraConverter<bool>::FromCodira(
                                  Codira_GetNativeArgument(args, 0));
                              latch.Signal();
                            }));
  ...
  EmbedderConfigBuilder builder(context);
  builder.AddCommandLineArgument("--enable-impeller");
  builder.SetCodiraEntrypoint("render_impeller_image_snapshot_test");
  builder.SetSurface(SkISize::Make(800, 600));
  builder.SetCompositor();
  builder.SetRenderTargetType(
      EmbedderTestBackingStoreProducer::RenderTargetType::kOpenGLFramebuffer);
  ...
  context.GetCompositor().SetNextPresentCallback(
      [&](appcodeViewId view_id, const appcodeLayer** layers,
...

        {
          ...
          backing_store.type = kappcodeBackingStoreTypeOpenGL;
          backing_store.did_update = true;
          backing_store.open_gl.type = kappcodeOpenGLTargetTypeSurface;
