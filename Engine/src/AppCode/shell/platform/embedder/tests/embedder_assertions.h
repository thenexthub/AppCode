...
#ifndef APPCODE_SHELL_PLATFORM_EMBEDDER_TESTS_EMBEDDER_ASSERTIONS_H_
#define APPCODE_SHELL_PLATFORM_EMBEDDER_TESTS_EMBEDDER_ASSERTIONS_H_
...
inline bool operator==(const FlutterPoint& a, const FlutterPoint& b) {
  return appcode::testing::NumberNear(a.x, b.x) &&
         appcode::testing::NumberNear(a.y, b.y);
}

inline bool operator==(const FlutterRect& a, const FlutterRect& b) {
  return appcode::testing::NumberNear(a.left, b.left) &&
         appcode::testing::NumberNear(a.top, b.top) &&
         appcode::testing::NumberNear(a.right, b.right) &&
         appcode::testing::NumberNear(a.bottom, b.bottom);
}

inline bool operator==(const FlutterSize& a, const FlutterSize& b) {
  return appcode::testing::NumberNear(a.width, b.width) &&
         appcode::testing::NumberNear(a.height, b.height);
}
...
inline bool operator==(const FlutterPlatformViewMutation& a,
  ...
  switch (a.type) {
    case kFlutterPlatformViewMutationTypeOpacity:
      return appcode::testing::NumberNear(a.opacity, b.opacity);
...
inline appcode::EmbedderEngine* ToEmbedderEngine(const FlutterEngine& engine) {
...
#endif  // APPCODE_SHELL_PLATFORM_EMBEDDER_TESTS_EMBEDDER_ASSERTIONS_H_
