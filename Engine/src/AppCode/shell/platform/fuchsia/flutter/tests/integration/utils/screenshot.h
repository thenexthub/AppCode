...
#ifndef APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_TESTS_INTEGRATION_UTILS_SCREENSHOT_H_
#define APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_TESTS_INTEGRATION_UTILS_SCREENSHOT_H_
...
#endif  // APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_TESTS_INTEGRATION_UTILS_SCREENSHOT_H_
