...
#include "appcode/shell/platform/fuchsia/appcode/flatland_connection.h"
...
TEST_F(FlatlandConnectionTest, Initialization) {
  ...
  appcode_runner::FlatlandConnection flatland_connection(
...
TEST_F(FlatlandConnectionTest, PresentCreditExhaustion) {
  ...
  // appcode fire callback and let us drive presents with ONFBs
