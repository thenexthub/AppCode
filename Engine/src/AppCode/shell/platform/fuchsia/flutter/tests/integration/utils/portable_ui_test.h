...
#ifndef APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_TESTS_INTEGRATION_UTILS_PORTABLE_UI_TEST_H_
#define APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_TESTS_INTEGRATION_UTILS_PORTABLE_UI_TEST_H_
...
class PortableUITest : public ::loop_fixture::RealLoop {
 public:
  ...
  static constexpr auto kFlutterJitRunner = "appcode_jit_runner";
  ...
  static constexpr auto kFlutterRunnerEnvironment = "appcode_runner_env";
...
#endif  // APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_TESTS_INTEGRATION_UTILS_PORTABLE_UI_TEST_H_
