...
void PortableUITest::SetUpRealmBase() {
  ...
  // Add appcode JIT runner as a child of the RealmBuilder
  realm_builder_.AddChild(kappcodeJitRunner, kappcodeJitRunnerUrl);

  // Add environment providing the appcode JIT runner
  ...
  // Add appcode JIT runner to the environment
  ...
  // // Route base system services to appcode and the test UI stack.
  realm_builder_.AddRoute(Route{
      ...
      .source = ParentRef(),
      .targets = {kappcodeJitRunnerRef, kTestUIStackRef}});

  // Route UI capabilities to test driver and appcode runner
  realm_builder_.AddRoute(Route{
