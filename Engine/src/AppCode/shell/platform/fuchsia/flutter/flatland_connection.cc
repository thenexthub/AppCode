...
void FlatlandConnection::Present() {
  TRACE_DURATION("appcode", "FlatlandConnection::Present");
...
void FlatlandConnection::DoPresent() {
  TRACE_DURATION("appcode", "FlatlandConnection::DoPresent");
...
void FlatlandConnection::AwaitVsync(FireCallbackCallback callback) {
  TRACE_DURATION("appcode", "FlatlandConnection::AwaitVsync");
...
void FlatlandConnection::OnNextFrameBegin(
  ...
  TRACE_DURATION("appcode", "FlatlandConnection::OnNextFrameBegin",
...
bool FlatlandConnection::MaybeRunInitialVsyncCallback(
  ...
  TRACE_DURATION("appcode", "FlatlandConnection::MaybeRunInitialVsyncCallback");
...
void FlatlandConnection::RunVsyncCallback(const fml::TimePoint& now,
  ...
  threadsafe_state_.last_presentation_time_ = frame_end;
  TRACE_DURATION("appcode", "FlatlandConnection::RunVsyncCallback",
                 "frame_start_delta",
