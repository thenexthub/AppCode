...
#ifndef APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_POINTER_INJECTOR_DELEGATE_H_
#define APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_POINTER_INJECTOR_DELEGATE_H_
 ...
 private:
  ...
  class PointerInjectorEndpoint {
   ...
   private:
    ...
    // ViewRef for the main appcode app launching the embedded child views.
...
#endif  // APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_POINTER_INJECTOR_DELEGATE_H_
