...
#ifndef APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_FLATLAND_CONNECTION_H_
#define APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_FLATLAND_CONNECTION_H_
...
#endif  // APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_FLATLAND_CONNECTION_H_
