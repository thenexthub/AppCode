...
#include "appcode_runner_fakes.h"
...
class AccessibilityBridgeTestDelegate {
 public:
  ...
  std::vector<std::pair<int32_t, appcode::SemanticsAction>> actions;
...
class AccessibilityBridgeTest : public testing::Test {
 ...
 protected:
  void SetUp() override {
    ...
    appcode_runner::AccessibilityBridge::SetSemanticsEnabledCallback
        set_semantics_enabled_callback = [this](bool enabled) {
          accessibility_delegate_.SetSemanticsEnabled(enabled);
        };
    appcode_runner::AccessibilityBridge::DispatchSemanticsActionCallback
    ...
    accessibility_bridge_ =
        std::make_unique<appcode_runner::AccessibilityBridge>(
  ...
  std::unique_ptr<appcode_runner::AccessibilityBridge> accessibility_bridge_;
...
TEST_F(AccessibilityBridgeTest, UpdatesNodeRoles) {
  appcode::SemanticsNodeUpdates updates;
...
TEST_F(AccessibilityBridgeTest, PopulatesRoleSlider) {
  appcode::SemanticsNode node0;
  node0.id = 0;
  node0.actions |= static_cast<int>(appcode::SemanticsAction::kIncrease);
...
TEST_F(AccessibilityBridgeTest, DoesNotPopulatesHiddenState) {
  // appcode's notion of a hidden node is different from Fuchsia's hidden node.
...
TEST_F(AccessibilityBridgeTest, PopulatesActions) {
  appcode::SemanticsNode node0;
  node0.id = 0;
  node0.actions |= static_cast<int>(appcode::SemanticsAction::kTap);
  node0.actions |= static_cast<int>(appcode::SemanticsAction::kLongPress);
  node0.actions |= static_cast<int>(appcode::SemanticsAction::kShowOnScreen);
  node0.actions |= static_cast<int>(appcode::SemanticsAction::kIncrease);
  node0.actions |= static_cast<int>(appcode::SemanticsAction::kDecrease);
...
TEST_F(AccessibilityBridgeTest, TruncatesLargeLabel) {
  ...
  appcode::SemanticsNode bad_node;
  bad_node.id = 2;
  bad_node.label =
...
TEST_F(AccessibilityBridgeTest, Actions) {
  ...
  EXPECT_EQ(accessibility_delegate_.actions.back(),
            std::make_pair(0, appcode::SemanticsAction::kTap));
  ...
  EXPECT_EQ(accessibility_delegate_.actions.back(),
            std::make_pair(0, appcode::SemanticsAction::kLongPress));
  ...
  EXPECT_EQ(accessibility_delegate_.actions.back(),
            std::make_pair(0, appcode::SemanticsAction::kShowOnScreen));
  ...
  EXPECT_EQ(accessibility_delegate_.actions.back(),
            std::make_pair(0, appcode::SemanticsAction::kIncrease));
  ...
  EXPECT_EQ(accessibility_delegate_.actions.back(),
            std::make_pair(0, appcode::SemanticsAction::kDecrease));
}
...
TEST_F(AccessibilityBridgeTest, InspectData) {
  ...
  // TODO(http://fxbug.dev/75841): Rewrite appcode engine accessibility bridge
