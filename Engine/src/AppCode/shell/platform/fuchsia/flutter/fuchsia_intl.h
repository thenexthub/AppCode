...
#ifndef APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_FUCHSIA_INTL_H_
#define APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_FUCHSIA_INTL_H_
...
//
// This method does not return a `std::unique_ptr<appcode::PlatformMessage>` for
...
#endif  // APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_FUCHSIA_INTL_H_
