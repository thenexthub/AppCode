...
#ifndef APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_APPCODE_RUNNER_FAKES_H_
#define APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_APPCODE_RUNNER_FAKES_H_
 ...
 public:
  ...
  void DeleteSemanticNodes(std::vector<uint32_t> node_ids) override {
    ...
    if (!delete_overflowed_) {
      size_t size =
          sizeof(node_ids) +
          (node_ids.size() * appcode_runner::AccessibilityBridge::kNodeIdSize);
...
#endif  // APPCODE_SHELL_PLATFORM_FUCHSIA_APPCODE_APPCODE_RUNNER_FAKES_H_
