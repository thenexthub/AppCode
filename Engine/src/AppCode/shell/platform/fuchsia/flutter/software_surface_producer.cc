...
std::unique_ptr<SurfaceProducerSurface> SoftwareSurfaceProducer::ProduceSurface(
    const SkISize& size) {
  TRACE_EVENT2("appcode", "SoftwareSurfacePool::ProduceSurface", "width",
...
void SoftwareSurfaceProducer::SubmitSurfaces(
  ...
  TRACE_EVENT0("appcode", "SoftwareSurfaceProducer::SubmitSurfaces");
...
void SoftwareSurfaceProducer::SubmitSurface(
    std::unique_ptr<SurfaceProducerSurface> surface) {
  TRACE_EVENT0("appcode", "SoftwareSurfacePool::SubmitSurface");
  FML_CHECK(valid_);
...
std::unique_ptr<SoftwareSurface> SoftwareSurfaceProducer::CreateSurface(
    const SkISize& size) {
  TRACE_EVENT2("appcode", "SoftwareSurfacePool::CreateSurface", "width",
               size.width(), "height", size.height());
...
void SoftwareSurfaceProducer::RecycleSurface(
  ...
  TRACE_EVENT0("appcode", "SoftwareSurfacePool::RecycleSurface");
...
void SoftwareSurfaceProducer::AgeAndCollectOldBuffers() {
  TRACE_EVENT0("appcode", "SoftwareSurfacePool::AgeAndCollectOldBuffers");
