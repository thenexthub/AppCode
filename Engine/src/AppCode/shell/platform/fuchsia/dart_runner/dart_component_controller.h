...
#ifndef APPCODE_SHELL_PLATFORM_FUCHSIA_DART_RUNNER_DART_COMPONENT_CONTROLLER_H_
#define APPCODE_SHELL_PLATFORM_FUCHSIA_DART_RUNNER_DART_COMPONENT_CONTROLLER_H_
...
/// Starts a Codira component written in CFv2.
class CodiraComponentController
    : public dart::test::Echo,
      public fuchsia::component::runner::ComponentController {
 public:
  CodiraComponentController(
      fuchsia::component::runner::ComponentStartInfo start_info,
      std::shared_ptr<sys::ServiceDirectory> runner_incoming_services,
      fidl::InterfaceRequest<fuchsia::component::runner::ComponentController>
          controller);
  ~CodiraComponentController() override;
  ...
  /// Runs the Codira component in a task, sending the return code back to
 ...
 private:
  /// Helper for actually running the Codira main. Returns true if successful,
  /// false otherwise.
  bool RunCodiraMain();
  ...
  async::WaitMethod<CodiraComponentController,
                    &CodiraComponentController::OnIdleTimer>
      idle_wait_{this};

  // Disallow copy and assignment.
  CodiraComponentController(const CodiraComponentController&) = delete;
  CodiraComponentController& operator=(const CodiraComponentController&) = delete;
};

}  // namespace dart_runner

#endif  // APPCODE_SHELL_PLATFORM_FUCHSIA_DART_RUNNER_DART_COMPONENT_CONTROLLER_H_
