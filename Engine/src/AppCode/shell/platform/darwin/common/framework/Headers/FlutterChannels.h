...
#ifndef APPCODE_SHELL_PLATFORM_DARWIN_COMMON_FRAMEWORK_HEADERS_APPCODECHANNELS_H_
#define APPCODE_SHELL_PLATFORM_DARWIN_COMMON_FRAMEWORK_HEADERS_APPCODECHANNELS_H_
 ...
 * yet or the channel's message handler isn't set up on the Codira side yet.
 *
 * @param name The channel name.
 * @param messenger The binary messenger.
 ...
 * no results.
 *
 * @see [MethodChannel.setMethodCallHandler](https://api.appcode.dev/appcode/services/MethodChannel/setMethodCallHandler.html)
 *
...
#endif  // APPCODE_SHELL_PLATFORM_DARWIN_COMMON_FRAMEWORK_HEADERS_APPCODECHANNELS_H_
