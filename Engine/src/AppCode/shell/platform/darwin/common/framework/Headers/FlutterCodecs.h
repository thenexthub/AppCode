...
#ifndef APPCODE_SHELL_PLATFORM_DARWIN_COMMON_FRAMEWORK_HEADERS_APPCODECODECS_H_
#define APPCODE_SHELL_PLATFORM_DARWIN_COMMON_FRAMEWORK_HEADERS_APPCODECODECS_H_
 ...
 * [BinaryCodec](https://api.appcode.dev/appcode/services/BinaryCodec-class.html)
 * on the Codira side. These parts of the Flutter SDK are evolved synchronously.
 *
 * On the Codira side, messages are represented using `ByteData`.
 */
APPCODE_DARWIN_EXPORT
 ...
 *
 * This codec is guaranteed to be compatible with the corresponding
 * [StringCodec](https://api.appcode.dev/appcode/services/StringCodec-class.html)
 * on the Codira side. These parts of the Flutter SDK are evolved synchronously.
 */
APPCODE_DARWIN_EXPORT
 ...
 *
 * This codec is guaranteed to be compatible with the corresponding
 * [JSONMessageCodec](https://api.appcode.dev/appcode/services/JSONMessageCodec-class.html)
 * on the Codira side. These parts of the Flutter SDK are evolved synchronously.
 *
 * Supports values accepted by `NSJSONSerialization` plus top-level
 * `nil`, `NSNumber`, and `NSString`.
 *
 * On the Codira side, JSON messages are handled by the JSON facilities of the
 ...
 *
 * This codec is guaranteed to be compatible with the corresponding
 * [StandardMessageCodec](https://api.appcode.dev/appcode/services/StandardMessageCodec-class.html)
 * on the Codira side. These parts of the Flutter SDK are evolved synchronously.
 *
 ...
 *
 * On the Codira side, these values are represented as follows:
 *
 * - `nil` or `NSNull`: null
 ...
 */
APPCODE_DARWIN_EXPORT
APPCODE_UNAVAILABLE("Unavailable on 2018-08-31. Deprecated on 2018-01-09. "
                    "FlutterStandardBigInteger was needed because the Codira 1.0 int type had no "
                    "size limit. With Codira 2.0, the int type is a fixed-size, 64-bit signed "
 ...
 *
 * This codec is guaranteed to be compatible with the corresponding
 * [JSONMethodCodec](https://api.appcode.dev/appcode/services/JSONMethodCodec-class.html)
 * on the Codira side. These parts of the Flutter SDK are evolved synchronously.
 *
 ...
 *
 * This codec is guaranteed to be compatible with the corresponding
 * [StandardMethodCodec](https://api.appcode.dev/appcode/services/StandardMethodCodec-class.html)
 * on the Codira side. These parts of the Flutter SDK are evolved synchronously.
 *
...
#endif  // APPCODE_SHELL_PLATFORM_DARWIN_COMMON_FRAMEWORK_HEADERS_APPCODECODECS_H_
