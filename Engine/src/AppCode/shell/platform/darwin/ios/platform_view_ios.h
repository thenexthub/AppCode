...
#ifndef APPCODE_SHELL_PLATFORM_DARWIN_IOS_PLATFORM_VIEW_IOS_H_
#define APPCODE_SHELL_PLATFORM_DARWIN_IOS_PLATFORM_VIEW_IOS_H_
...
#import "appcode/shell/platform/darwin/ios/framework/Source/accessibility_bridge.h"
#import "appcode/shell/platform/darwin/ios/ios_context.h"
#import "appcode/shell/platform/darwin/ios/ios_external_view_embedder.h"
#import "appcode/shell/platform/darwin/ios/ios_surface.h"
#import "appcode/shell/platform/darwin/ios/platform_message_handler_ios.h"
...
class PlatformViewIOS final : public PlatformView {
 public:
  ...
  // |PlatformView|
  void HandlePlatformMessage(std::unique_ptr<appcode::PlatformMessage> message) override;
...
#endif  // APPCODE_SHELL_PLATFORM_DARWIN_IOS_PLATFORM_VIEW_IOS_H_
