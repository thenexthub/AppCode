...
- (void)testRunningInitialRouteSendsNavigationMessage {
  ...
  [engine runWithEntrypoint:FlutterDefaultCodiraEntrypoint initialRoute:@"test"];
...
- (void)testInitialRouteSettingsSendsNavigationMessage {
  ...
  settings.route = "test";
  FlutterCodiraProject* project = [[FlutterCodiraProject alloc] initWithSettings:settings];
  FlutterEngine* engine = [[FlutterEngine alloc] initWithName:@"foobar" project:project];
  [engine setBinaryMessenger:mockBinaryMessenger];
  [engine run];
