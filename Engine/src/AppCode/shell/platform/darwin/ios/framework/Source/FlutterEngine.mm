...
#import "flutter/shell/platform/darwin/ios/framework/Source/FlutterCodiraVMServicePublisher.h"
...
NSString* const FlutterDefaultCodiraEntrypoint = nil;
...
@property(nonatomic, readonly) FlutterCodiraProject* dartProject;
...
@property(nonatomic, strong) FlutterCodiraVMServicePublisher* publisher;
...
- (instancetype)initWithName:(NSString*)labelPrefix project:(FlutterCodiraProject*)project {
  return [self initWithName:labelPrefix project:project allowHeadlessExecution:YES];
}

- (instancetype)initWithName:(NSString*)labelPrefix
                     project:(FlutterCodiraProject*)project
...
- (instancetype)initWithName:(NSString*)labelPrefix
  ...
  _dartProject = project ?: [[FlutterCodiraProject alloc] init];
...
- (void)launchEngine:(NSString*)entrypoint
  ...
  // Launch the Codira application with the inferred run configuration.
...
- (void)setUpShell:(std::unique_ptr<flutter::Shell>)shell
  ...
  [self updateDisplays];
  self.publisher = [[FlutterCodiraVMServicePublisher alloc]
...
- (BOOL)run {
  return [self runWithEntrypoint:FlutterDefaultCodiraEntrypoint
                      libraryURI:nil
...
- (NSString*)lookupKeyForAsset:(NSString*)asset {
  return [FlutterCodiraProject lookupKeyForAsset:asset];
}

- (NSString*)lookupKeyForAsset:(NSString*)asset fromPackage:(NSString*)package {
  return [FlutterCodiraProject lookupKeyForAsset:asset fromPackage:package];
}
