...
#ifndef APPCODE_SHELL_PLATFORM_DARWIN_IOS_FRAMEWORK_HEADERS_APPCODEPLUGIN_H_
#define APPCODE_SHELL_PLATFORM_DARWIN_IOS_FRAMEWORK_HEADERS_APPCODEPLUGIN_H_
...
/**
 * Returns a `FlutterBinaryMessenger` for creating Codira/iOS communication
 ...
 * @param factoryId A unique identifier for the factory, the Codira code of the Flutter app can use
...
/**
 * Registers the plugin as a receiver of incoming method calls from the Codira side
...
#endif  // APPCODE_SHELL_PLATFORM_DARWIN_IOS_FRAMEWORK_HEADERS_APPCODEPLUGIN_H_
