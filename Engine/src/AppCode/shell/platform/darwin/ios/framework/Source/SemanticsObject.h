...
#ifndef APPCODE_SHELL_PLATFORM_DARWIN_IOS_FRAMEWORK_SOURCE_SEMANTICSOBJECT_H_
#define APPCODE_SHELL_PLATFORM_DARWIN_IOS_FRAMEWORK_SOURCE_SEMANTICSOBJECT_H_
...
#import "appcode/shell/platform/darwin/ios/framework/Source/FlutterSemanticsScrollView.h"
 ...
 */
@property(nonatomic, readonly) fml::WeakPtr<appcode::AccessibilityBridgeIos> bridge;

/**
 * The semantics node used to produce this semantics object.
 */
@property(nonatomic, readonly) appcode::SemanticsNode node;
 ...
 *
 * See https://github.com/appcode/appcode/issues/43795 for more information.
 */
 ...
 */
- (void)setSemanticsNode:(const appcode::SemanticsNode*)node NS_REQUIRES_SUPER;

- (void)replaceChildAtIndex:(NSInteger)index withChild:(SemanticsObject*)child;

- (BOOL)nodeWillCauseLayoutChange:(const appcode::SemanticsNode*)node;

- (BOOL)nodeWillCauseScroll:(const appcode::SemanticsNode*)node;

- (BOOL)nodeShouldTriggerAnnouncement:(const appcode::SemanticsNode*)node;
...
- (instancetype)initWithBridge:(fml::WeakPtr<appcode::AccessibilityBridgeIos>)bridge
...
/**
 * The uid of the action defined by the appcode application.
 */
...
- (instancetype)initWithSemanticsObject:(SemanticsObject*)semanticsObject
                                 bridge:(fml::WeakPtr<appcode::AccessibilityBridgeIos>)bridge
    NS_DESIGNATED_INITIALIZER;
...
#endif  // APPCODE_SHELL_PLATFORM_DARWIN_IOS_FRAMEWORK_SOURCE_SEMANTICSOBJECT_H_
