...
#ifndef APPCODE_SHELL_PLATFORM_DARWIN_MACOS_FRAMEWORK_HEADERS_APPCODEVIEWCONTROLLER_H_
#define APPCODE_SHELL_PLATFORM_DARWIN_MACOS_FRAMEWORK_HEADERS_APPCODEVIEWCONTROLLER_H_
 ...
 *
 * @param project The project to run in this view controller. If nil, a default `FlutterCodiraProject`
 *                will be used.
 */
- (nonnull instancetype)initWithProject:(nullable FlutterCodiraProject*)project
 ...
 *     let appcodeViewController = FlutterViewController()
 *
 ...
 *     appcodeViewController.backgroundColor = NSColor.clear
 *
 *     let windowFrame = self.frame
 *     self.contentViewController = appcodeViewController
 *     self.setFrame(windowFrame, display: true)
 *
 *     RegisterGeneratedPlugins(registry: appcodeViewController)
 *
 *     super.awakeFromNib()
 *   }
 * }
...
#endif  // APPCODE_SHELL_PLATFORM_DARWIN_MACOS_FRAMEWORK_HEADERS_APPCODEVIEWCONTROLLER_H_
