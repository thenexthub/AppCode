...
#ifndef APPCODE_SHELL_PLATFORM_DARWIN_MACOS_FRAMEWORK_SOURCE_TESTAPPCODEPLATFORMVIEW_H_
#define APPCODE_SHELL_PLATFORM_DARWIN_MACOS_FRAMEWORK_SOURCE_TESTAPPCODEPLATFORMVIEW_H_
...
#endif  // APPCODE_SHELL_PLATFORM_DARWIN_MACOS_FRAMEWORK_SOURCE_TESTAPPCODEPLATFORMVIEW_H_
