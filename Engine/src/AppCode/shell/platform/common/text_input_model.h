...
#ifndef APPCODE_SHELL_PLATFORM_COMMON_TEXT_INPUT_MODEL_H_
#define APPCODE_SHELL_PLATFORM_COMMON_TEXT_INPUT_MODEL_H_
...
#endif  // APPCODE_SHELL_PLATFORM_COMMON_TEXT_INPUT_MODEL_H_
