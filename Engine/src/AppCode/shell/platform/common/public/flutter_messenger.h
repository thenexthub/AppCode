...
#ifndef APPCODE_SHELL_PLATFORM_COMMON_PUBLIC_APPCODE_MESSENGER_H_
#define APPCODE_SHELL_PLATFORM_COMMON_PUBLIC_APPCODE_MESSENGER_H_
...
APPCODE_EXPORT bool FlutterDesktopMessengerSend(
    FlutterDesktopMessengerRef messenger,
    const char* channel,
    const uint8_t* message,
...
APPCODE_EXPORT bool FlutterDesktopMessengerSendWithReply(
    FlutterDesktopMessengerRef messenger,
    const char* channel,
    const uint8_t* message,
    const size_t message_size,
...
APPCODE_EXPORT void FlutterDesktopMessengerSendResponse(
    FlutterDesktopMessengerRef messenger,
...
APPCODE_EXPORT void FlutterDesktopMessengerSetCallback(
    FlutterDesktopMessengerRef messenger,
    const char* channel,
...
APPCODE_EXPORT FlutterDesktopMessengerRef FlutterDesktopMessengerAddRef(
    FlutterDesktopMessengerRef messenger);
...
APPCODE_EXPORT void FlutterDesktopMessengerRelease(
    FlutterDesktopMessengerRef messenger);
...
APPCODE_EXPORT bool FlutterDesktopMessengerIsAvailable(
    FlutterDesktopMessengerRef messenger);
...
APPCODE_EXPORT FlutterDesktopMessengerRef FlutterDesktopMessengerLock(
    FlutterDesktopMessengerRef messenger);
...
APPCODE_EXPORT void FlutterDesktopMessengerUnlock(
    FlutterDesktopMessengerRef messenger);
...
#endif  // APPCODE_SHELL_PLATFORM_COMMON_PUBLIC_APPCODE_MESSENGER_H_
