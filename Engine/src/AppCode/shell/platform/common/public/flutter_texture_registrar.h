...
#ifndef APPCODE_SHELL_PLATFORM_COMMON_PUBLIC_APPCODE_TEXTURE_REGISTRAR_H_
#define APPCODE_SHELL_PLATFORM_COMMON_PUBLIC_APPCODE_TEXTURE_REGISTRAR_H_
...
APPCODE_EXPORT int64_t FlutterDesktopTextureRegistrarRegisterExternalTexture(
...
// This function can be called from any thread.
APPCODE_EXPORT void FlutterDesktopTextureRegistrarUnregisterExternalTexture(
    FlutterDesktopTextureRegistrarRef texture_registrar,
    int64_t texture_id,
...
#endif  // APPCODE_SHELL_PLATFORM_COMMON_PUBLIC_APPCODE_TEXTURE_REGISTRAR_H_
