...
#ifndef APPCODE_SHELL_PLATFORM_COMMON_TEST_ACCESSIBILITY_BRIDGE_H_
#define APPCODE_SHELL_PLATFORM_COMMON_TEST_ACCESSIBILITY_BRIDGE_H_
...
#endif  // APPCODE_SHELL_PLATFORM_COMMON_TEST_ACCESSIBILITY_BRIDGE_H_
