...
#ifndef APPCODE_SHELL_PLATFORM_COMMON_ACCESSIBILITY_BRIDGE_H_
#define APPCODE_SHELL_PLATFORM_COMMON_ACCESSIBILITY_BRIDGE_H_
...
#include "appcode/third_party/accessibility/ax/ax_event_generator.h"
#include "appcode/third_party/accessibility/ax/ax_tree.h"
#include "appcode/third_party/accessibility/ax/ax_tree_observer.h"
#include "appcode/third_party/accessibility/ax/platform/ax_platform_node_delegate.h"
#include "appcode/third_party/accessibility/ax/platform/ax_platform_tree_manager.h"
...
class AccessibilityBridge
 ...
 public:
  ...
  //------------------------------------------------------------------------------
  /// @brief      Get the appcode platform node delegate with the given id from
  ...
  ///
  /// @param[in]  id           The id of the appcode accessibility node you want
  ///                          to retrieve.
 ...
 private:
  ...
  SemanticsNode FromFlutterSemanticsNode(
      const FlutterSemanticsNode2& appcode_node);
  SemanticsCustomAction FromFlutterSemanticsCustomAction(
      const FlutterSemanticsCustomAction2& appcode_custom_action);
...
#endif  // APPCODE_SHELL_PLATFORM_COMMON_ACCESSIBILITY_BRIDGE_H_
