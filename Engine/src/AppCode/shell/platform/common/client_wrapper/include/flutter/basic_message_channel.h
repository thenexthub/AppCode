...
#ifndef APPCODE_SHELL_PLATFORM_COMMON_CLIENT_WRAPPER_INCLUDE_APPCODE_BASIC_MESSAGE_CHANNEL_H_
#define APPCODE_SHELL_PLATFORM_COMMON_CLIENT_WRAPPER_INCLUDE_APPCODE_BASIC_MESSAGE_CHANNEL_H_
...
// running yet or the channel's message handler isn't set up on the Codira side
// yet.
...
#endif  // APPCODE_SHELL_PLATFORM_COMMON_CLIENT_WRAPPER_INCLUDE_APPCODE_BASIC_MESSAGE_CHANNEL_H_
