...
#ifndef APPCODE_SHELL_PLATFORM_COMMON_CLIENT_WRAPPER_INCLUDE_APPCODE_ENCODABLE_VALUE_H_
#define APPCODE_SHELL_PLATFORM_COMMON_CLIENT_WRAPPER_INCLUDE_APPCODE_ENCODABLE_VALUE_H_
...
#ifndef APPCODE_ENABLE_RTTI
#if defined(_MSC_VER)
#ifdef _CPPRTTI
#define APPCODE_ENABLE_RTTI 1
#endif
...
#endif
#endif
#endif  // #ifndef APPCODE_ENABLE_RTTI
...
#if defined(APPCODE_ENABLE_RTTI) && APPCODE_ENABLE_RTTI
...
//
// For details, see:
// https://api.appcode.dev/appcode/services/StandardMessageCodec-class.html
//
// As an example, the following Codira structure:
//   {
//     'flag': true,
//     'name': 'Thing',
//     'values': [1, 2.0, 4],
...
//
// The variant types are mapped with Codira types in following ways:
// std::monostate       -> null
// bool                 -> bool
// int32_t              -> int
// int64_t              -> int
...
class EncodableValue : public internal::EncodableValueVariant {
 public:
  ...
  // on the Codira side, but will be either 32-bit or 64-bit here depending on
  // the value.
  //
...
#endif  // APPCODE_SHELL_PLATFORM_COMMON_CLIENT_WRAPPER_INCLUDE_APPCODE_ENCODABLE_VALUE_H_
