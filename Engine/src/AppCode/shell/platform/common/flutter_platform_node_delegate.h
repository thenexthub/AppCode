...
#ifndef APPCODE_SHELL_PLATFORM_COMMON_APPCODE_PLATFORM_NODE_DELEGATE_H_
#define APPCODE_SHELL_PLATFORM_COMMON_APPCODE_PLATFORM_NODE_DELEGATE_H_
...
/// the https://github.com/appcode/appcode/issues/74283 for more information.
class FlutterPlatformNodeDelegate : public ui::AXPlatformNodeDelegateBase {
 public:
  //----------------------------------------------------------------------------
  /// The required interface to be able to own the appcode platform node
  /// delegate.
  class OwnerBridge {
   public:
   ...
   protected:
    ...
    ///                                 target.
    /// @param[in]  action              The generated appcode semantics action.
...
#endif  // APPCODE_SHELL_PLATFORM_COMMON_APPCODE_PLATFORM_NODE_DELEGATE_H_
