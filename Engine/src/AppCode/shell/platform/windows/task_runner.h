...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_TASK_RUNNER_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_TASK_RUNNER_H_
...
#include "appcode/shell/platform/windows/task_runner_window.h"
...
// that host app can own its own message loop and appcode still gets to process
...
class TaskRunner : public TaskRunnerWindow::Delegate {
 public:
  ...
  void PostFlutterTask(FlutterTask appcode_task,
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_TASK_RUNNER_H_
