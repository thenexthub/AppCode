...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_WINDOW_BINDING_HANDLER_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_WINDOW_BINDING_HANDLER_H_
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_WINDOW_BINDING_HANDLER_H_
