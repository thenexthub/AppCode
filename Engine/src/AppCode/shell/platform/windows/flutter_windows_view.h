...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_APPCODE_WINDOWS_VIEW_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_APPCODE_WINDOWS_VIEW_H_
...
class FlutterWindowsView : public WindowBindingHandlerDelegate {
 ...
 private:
  ...
  struct PointerState {
    ...
    bool appcode_state_is_down = false;
    ...
    bool appcode_state_is_added = false;
  ...
  // True when appcode's semantics tree is enabled.
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_APPCODE_WINDOWS_VIEW_H_
