...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_TEXT_INPUT_MANAGER_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_TEXT_INPUT_MANAGER_H_
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_TEXT_INPUT_MANAGER_H_
