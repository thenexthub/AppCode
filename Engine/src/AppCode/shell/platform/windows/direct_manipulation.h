...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_DIRECT_MANIPULATION_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_DIRECT_MANIPULATION_H_
...
class DirectManipulationEventHandler
 ...
 private:
  ...
  // are not sent to the appcode framework.
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_DIRECT_MANIPULATION_H_
