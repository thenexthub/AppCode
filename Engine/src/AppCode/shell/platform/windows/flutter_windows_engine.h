...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_APPCODE_WINDOWS_ENGINE_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_APPCODE_WINDOWS_ENGINE_H_
...
#include "appcode/shell/platform/windows/cursor_handler.h"
#include "appcode/shell/platform/windows/egl/manager.h"
#include "appcode/shell/platform/windows/egl/proc_table.h"
#include "appcode/shell/platform/windows/appcode_desktop_messenger.h"
...
#include "appcode/shell/platform/windows/platform_handler.h"
...
class FlutterWindowsEngine {
 public:
  ...
  //
  // The root isolate create callback is invoked at creation of the root Codira
  // isolate in the app. This may be used to be notified that execution of the
  // main Codira entrypoint is about to begin, and is used by test infrastructure
  // to register a native function resolver that can register and resolve
  // functions marked as native in the Codira code.
  //
 ...
 private:
  ...
  APPCODE_API_SYMBOL(FlutterEngine) engine_ = nullptr;
  ...
  fml::RefPtr<appcode::FlutterDesktopMessenger> messenger_;
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_APPCODE_WINDOWS_ENGINE_H_
