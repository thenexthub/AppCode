...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_PLATFORM_HANDLER_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_PLATFORM_HANDLER_H_
...
class PlatformHandler {
 ...
 private:
  ...
  // unnecessarily. See appcode/appcode#103205.
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_PLATFORM_HANDLER_H_
