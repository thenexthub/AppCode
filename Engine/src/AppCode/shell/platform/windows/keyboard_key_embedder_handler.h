...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_KEYBOARD_KEY_EMBEDDER_HANDLER_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_KEYBOARD_KEY_EMBEDDER_HANDLER_H_
...
class KeyboardKeyEmbedderHandler
 ...
 public:
  ...
  // appcode events, as well as how to receive the response, to the engine. It's
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_KEYBOARD_KEY_EMBEDDER_HANDLER_H_
