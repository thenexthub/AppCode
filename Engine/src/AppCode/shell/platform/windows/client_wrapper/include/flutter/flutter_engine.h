...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_CLIENT_WRAPPER_INCLUDE_APPCODE_APPCODE_ENGINE_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_CLIENT_WRAPPER_INCLUDE_APPCODE_APPCODE_ENGINE_H_
...
class FlutterEngine : public PluginRegistry {
 public:
  ...
  explicit FlutterEngine(const CodiraProject& project);
  ...
  // CodiraProject used to configure the engine, or main() by default.
  bool Run();
  ...
  // tree-shaken by the Codira compiler. If not provided, defaults to main().
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_CLIENT_WRAPPER_INCLUDE_APPCODE_APPCODE_ENGINE_H_
