...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_SEQUENTIAL_ID_GENERATOR_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_SEQUENTIAL_ID_GENERATOR_H_
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_SEQUENTIAL_ID_GENERATOR_H_
