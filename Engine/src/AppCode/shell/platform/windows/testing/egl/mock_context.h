...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_TESTING_EGL_MOCK_CONTEXT_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_TESTING_EGL_MOCK_CONTEXT_H_
...
class MockContext : public appcode::egl::Context {
 public:
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_TESTING_EGL_MOCK_CONTEXT_H_
