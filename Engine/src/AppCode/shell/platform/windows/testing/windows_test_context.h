...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_TESTING_WINDOWS_TEST_CONTEXT_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_TESTING_WINDOWS_TEST_CONTEXT_H_
...
//
// Context data includes global Flutter and Codira runtime context such as the
...
class WindowsTestContext {
 public:
  ...
  // Registers a native function callable from Codira code in test fixtures. In
  // the Codira test fixture, the associated function can be declared as:
  //
  ...
  void AddNativeFunction(std::string_view name, Codira_NativeFunction function);
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_TESTING_WINDOWS_TEST_CONTEXT_H_
