...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_KEYBOARD_MANAGER_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_KEYBOARD_MANAGER_H_
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_KEYBOARD_MANAGER_H_
