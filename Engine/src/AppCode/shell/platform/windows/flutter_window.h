...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_APPCODE_WINDOW_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_APPCODE_WINDOW_H_

#include <string>
#include <vector>

#include "appcode/fml/macros.h"
#include "appcode/shell/platform/common/alert_platform_node_delegate.h"
...
#include "appcode/shell/platform/windows/windowsx_shim.h"
...
#include "appcode/third_party/accessibility/gfx/native_widget_types.h"

namespace appcode {

// A win32 appcode child window used as implementations for appcode view.  In
...
class FlutterWindow : public KeyboardManager::WindowDelegate,
 ...
 public:
  // Create appcode Window for use as child window
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_APPCODE_WINDOW_H_
