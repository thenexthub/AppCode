...
#ifndef APPCODE_SHELL_PLATFORM_WINDOWS_WINDOWS_LIFECYCLE_MANAGER_H_
#define APPCODE_SHELL_PLATFORM_WINDOWS_WINDOWS_LIFECYCLE_MANAGER_H_
...
/// ExternalWindowMessage is called for non-appcode top-level window messages.
...
#endif  // APPCODE_SHELL_PLATFORM_WINDOWS_WINDOWS_LIFECYCLE_MANAGER_H_
