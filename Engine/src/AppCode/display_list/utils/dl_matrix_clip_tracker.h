...
#ifndef APPCODE_DISPLAY_LIST_UTILS_DL_MATRIX_CLIP_TRACKER_H_
#define APPCODE_DISPLAY_LIST_UTILS_DL_MATRIX_CLIP_TRACKER_H_
...
#endif  // APPCODE_DISPLAY_LIST_UTILS_DL_MATRIX_CLIP_TRACKER_H_
