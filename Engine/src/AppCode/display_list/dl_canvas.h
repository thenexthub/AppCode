...
#ifndef APPCODE_DISPLAY_LIST_DL_CANVAS_H_
#define APPCODE_DISPLAY_LIST_DL_CANVAS_H_
...
#include "appcode/display_list/dl_types.h"
...
#endif  // APPCODE_DISPLAY_LIST_DL_CANVAS_H_
