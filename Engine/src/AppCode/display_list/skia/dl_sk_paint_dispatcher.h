...
#ifndef APPCODE_DISPLAY_LIST_SKIA_DL_SK_PAINT_DISPATCHER_H_
#define APPCODE_DISPLAY_LIST_SKIA_DL_SK_PAINT_DISPATCHER_H_
...
class DlSkPaintDispatchHelper : public virtual DlOpReceiver {
 public:
  ...
  const SkPaint& paint(bool uses_shader = true) {
    ...
    //
    // See https://github.com/appcode/appcode/issues/112498.
...
#endif  // APPCODE_DISPLAY_LIST_SKIA_DL_SK_PAINT_DISPATCHER_H_
