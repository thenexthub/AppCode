...
// See https://github.com/appcode/appcode/issues/108433
    ...
    for (unsigned j = 0; j < dl_matrices.size(); j++) {
      for (unsigned k = 0; k < dl_bounds_matrices.size(); k++) {
        ...
        if (!sk_local_filter || !dl_local_filter) {
          ...
          // See https://github.com/appcode/appcode/issues/114723
        ...
        }
        {
          ...
          // appcode issue: https://github.com/appcode/appcode/issues/108693
          if (i == 2 || i == 3) {
            continue;
          }
