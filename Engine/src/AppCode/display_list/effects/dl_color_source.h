...
#ifndef APPCODE_DISPLAY_LIST_EFFECTS_DL_COLOR_SOURCE_H_
#define APPCODE_DISPLAY_LIST_EFFECTS_DL_COLOR_SOURCE_H_
...
class DlColorSource : public DlAttribute<DlColorSource, DlColorSourceType> {
 public:
  ...
  ///             removed, https://github.com/appcode/appcode/issues/112498.
  ///
...
#endif  // APPCODE_DISPLAY_LIST_EFFECTS_DL_COLOR_SOURCE_H_
