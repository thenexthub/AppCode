...
#ifndef APPCODE_DISPLAY_LIST_EFFECTS_DL_IMAGE_FILTER_H_
#define APPCODE_DISPLAY_LIST_EFFECTS_DL_IMAGE_FILTER_H_
...
#endif  // APPCODE_DISPLAY_LIST_EFFECTS_DL_IMAGE_FILTER_H_
