...
#ifndef APPCODE_DISPLAY_LIST_DL_OP_RECEIVER_H_
#define APPCODE_DISPLAY_LIST_DL_OP_RECEIVER_H_
...
class DlOpReceiver {
 public:
  ...
  // as tracked in:
  // https://github.com/appcode/appcode/issues/144070
...
#endif  // APPCODE_DISPLAY_LIST_DL_OP_RECEIVER_H_
