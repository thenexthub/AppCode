...
namespace {
inline constexpr appcode::DlPathFillType ToDlFillType(SkPathFillType sk_type) {
  switch (sk_type) {
...
inline constexpr SkPathFillType ToSkFillType(appcode::DlPathFillType dl_type) {
  switch (dl_type) {
